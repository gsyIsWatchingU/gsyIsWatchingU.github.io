...
`)}var X_={[Hl]:"Linear",[kl]:"Reinhard",[Vl]:"Cineon",[xa]:"ACESFilmic",[Wl]:"AgX",[Xl]:"Neutral",[Gl]:"Custom"};function q_(s,e){let t=X_[e];return t===void 0?(Ue("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+s+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+s+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}var Fc=new C;function Y_(){it.getLuminanceCoefficients(Fc);let s=Fc.x.toFixed(4),e=Fc.y.toFixed(4),t=Fc.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${s}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
#define LOW_PRECISION`),e}var nx={[xs]:"SHADOWMAP_TYPE_PCF",[fr]:"SHADOWMAP_TYPE_VSM"};function ix(s){return nx[s.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}var sx={[Yi]:"ENVMAP_TYPE_CUBE",[vs]:"ENVMAP_TYPE_CUBE",[ya]:"ENVMAP_TYPE_CUBE_UV"};function rx(s){return s.envMap===!1?"ENVMAP_TYPE_CUBE":sx[s.envMapMode]||"ENVMAP_TYPE_CUBE"}var ax={[vs]:"ENVMAP_MODE_REFRACTION"};function ox(s){return s.envMap===!1?"ENVMAP_MODE_REFLECTION":ax[s.envMapMode]||"ENVMAP_MODE_REFLECTION"}var cx={[zl]:"ENVMAP_BLENDING_MULTIPLY",[dd]:"ENVMAP_BLENDING_MIX",[fd]:"ENVMAP_BLENDING_ADD"};function lx(s){return s.envMap===!1?"ENVMAP_BLENDING_NONE":cx[s.combine]||"ENVMAP_BLENDING_NONE"}function hx(s){let e=s.envMapCubeUVHeight;if(e===null)return null;let t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function ux(s,e,t,n){let i=s.getContext(),r=t.defines,a=t.vertexShader,o=t.fragmentShader,c=ix(t),l=rx(t),h=ox(t),u=lx(t),d=hx(t),f=Z_(t),g=K_(r),v=i.createProgram(),m,p,S=t.glslVersion?"#version "+t.glslVersion+`
...
}`,wx=[new C(1,0,0),new C(-1,0,0),new C(0,1,0),new C(0,-1,0),new C(0,0,1),new C(0,0,-1)],Ax=[new C(0,-1,0),new C(0,-1,0),new C(0,0,1),new C(0,0,-1),new C(0,-1,0),new C(0,-1,0)],sf=new Ze,Ra=new C,xh=new C;function Rx(s,e,t){let n=new rr,i=new ve,r=new ve,a=new St,o=new Lo,c=new No,l={},h=t.maxTextureSize,u={[ni]:un,[un]:ni,[tn]:tn},d=new Tn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new ve},radius:{value:4}},vertexShader:Tx,fragmentShader:Ex}),f=d.clone();f.defines.HORIZONTAL_PASS=1;let g=new Et;g.setAttribute("position",new Bt(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));let v=new Ge(g,d),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=xs;let p=this.type;this.render=function(T,A,x){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||T.length===0)return;this.type===Yu&&(Ue("WebGLShadowMap: PCFSoftShadowMap has been removed. Using PCFShadowMap instead."),this.type=xs);let E=s.getRenderTarget(),I=s.getActiveCubeFace(),U=s.getActiveMipmapLevel(),B=s.state;B.setBlending(ii),B.buffers.depth.getReversed()===!0?B.buffers.color.setClear(0,0,0,0):B.buffers.color.setClear(1,1,1,1),B.buffers.depth.setTest(!0),B.setScissorTest(!1);let G=p!==this.type;G&&A.traverse(function(D){D.material&&(Array.isArray(D.material)?D.material.forEach(X=>X.needsUpdate=!0):D.material.needsUpdate=!0)});for(let D=0,X=T.length;D<X;D++){let $=T[D],K=$.shadow;if(K===void 0){Ue("WebGLShadowMap:",$,"has no shadow.");continue}if(K.autoUpdate===!1&&K.needsUpdate===!1)continue;i.copy(K.mapSize);let se=K.getFrameExtents();i.multiply(se),r.copy(K.mapSize),(i.x>h||i.y>h)&&(i.x>h&&(r.x=Math.floor(h/se.x),i.x=r.x*se.x,K.mapSize.x=r.x),i.y>h&&(r.y=Math.floor(h/se.y),i.y=r.y*se.y,K.mapSize.y=r.y));let W=s.state.buffers.depth.getReversed();if(K.camera._reversedDepth=W,K.map===null||G===!0){if(K.map!==null&&(K.map.depthTexture!==null&&(K.map.depthTexture.dispose(),K.map.depthTexture=null),K.map.dispose()),this.type===fr){if($.isPointLight){Ue("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}K.map=new gn(i.x,i.y,{format:Ki,type:Yn,minFilter:Ht,magFilter:Ht,generateMipmaps:!1}),K.map.texture.name=$.name+".shadowMap",K.map.depthTexture=new Vi(i.x,i.y,En),K.map.depthTexture.name=$.name+".shadowMapDepth",K.map.depthTexture.format=jn,K.map.depthTexture.compareFunction=null,K.map.depthTexture.minFilter=zt,K.map.depthTexture.magFilter=zt}else $.isPointLight?(K.map=new Bc(i.x),K.map.depthTexture=new So(i.x,qn)):(K.map=new gn(i.x,i.y),K.map.depthTexture=new Vi(i.x,i.y,qn)),K.map.depthTexture.name=$.name+".shadowMap",K.map.depthTexture.format=jn,this.type===xs?(K.map.depthTexture.compareFunction=W?Dc:Nc,K.map.depthTexture.minFilter=Ht,K.map.depthTexture.magFilter=Ht):(K.map.depthTexture.compareFunction=null,K.map.depthTexture.minFilter=zt,K.map.depthTexture.magFilter=zt);K.camera.updateProjectionMatrix()}K.map.isWebGLCubeRenderTarget!==!0&&(K.map.width!==i.x||K.map.height!==i.y)&&K.map.setSize(i.x,i.y);let ne=K.map.isWebGLCubeRenderTarget?6:K.getViewportCount();$.isPointLight!==!0&&K.updateMatrices($,x);for(let ie=0;ie<ne;ie++){let Oe=K.getCamera(ie);if($.isPointLight){let Le=K.camera,vt=K.matrix,rt=$.distance||Le.far;rt!==Le.far&&(Le.far=rt,Le.updateProjectionMatrix()),Ra.setFromMatrixPosition($.matrixWorld),Le.position.copy(Ra),xh.copy(Le.position),xh.add(wx[ie]),Le.up.copy(Ax[ie]),Le.lookAt(xh),Le.updateMatrixWorld(),vt.makeTranslation(-Ra.x,-Ra.y,-Ra.z),sf.multiplyMatrices(Le.projectionMatrix,Le.matrixWorldInverse),K._frustum.setFromProjectionMatrix(sf,Le.coordinateSystem,Le.reversedDepth)}if(K.map.isWebGLCubeRenderTarget)s.setRenderTarget(K.map,ie),s.clear();else{ie===0&&(s.setRenderTarget(K.map),s.clear());let Le=K.getViewport(ie);a.set(r.x*Le.x,r.y*Le.y,r.x*Le.z,r.y*Le.w),B.viewport(a)}n=K.getFrustum(ie),y(A,x,Oe,$,this.type)}K.isPointLightShadow!==!0&&this.type===fr&&S(K,x),K.needsUpdate=!1}p=this.type,m.needsUpdate=!1,s.setRenderTarget(E,I,U)};function S(T,A){let x=e.update(v);d.defines.VSM_SAMPLES!==T.blurSamples&&(d.defines.VSM_SAMPLES=T.blurSamples,f.defines.VSM_SAMPLES=T.blurSamples,d.needsUpdate=!0,f.needsUpdate=!0),T.mapPass===null?T.mapPass=new gn(i.x,i.y,{format:Ki,type:Yn}):(T.mapPass.width!==T.map.width||T.mapPass.height!==T.map.height)&&T.mapPass.setSize(T.map.width,T.map.height),d.uniforms.shadow_pass.value=T.map.depthTexture,d.uniforms.resolution.value.set(T.map.width,T.map.height),d.uniforms.radius.value=T.radius,s.setRenderTarget(T.mapPass),s.clear(),s.renderBufferDirect(A,null,x,d,v,null),f.uniforms.shadow_pass.value=T.mapPass.texture,f.uniforms.resolution.value.set(T.map.width,T.map.height),f.uniforms.radius.value=T.radius,s.setRenderTarget(T.map),s.clear(),s.renderBufferDirect(A,null,x,f,v,null)}function w(T,A,x,E){let I=null,U=x.isPointLight===!0?T.customDistanceMaterial:T.customDepthMaterial;if(U!==void 0)I=U;else if(I=x.isPointLight===!0?c:o,s.localClippingEnabled&&A.clipShadows===!0&&Array.isArray(A.clippingPlanes)&&A.clippingPlanes.length!==0||A.displacementMap&&A.displacementScale!==0||A.alphaMap&&A.alphaTest>0||A.map&&A.alphaTest>0||A.alphaToCoverage===!0){let B=I.uuid,G=A.uuid,D=l[B];D===void 0&&(D={},l[B]=D);let X=D[G];X===void 0&&(X=I.clone(),D[G]=X,A.addEventListener("dispose",b)),I=X}if(I.visible=A.visible,I.wireframe=A.wireframe,E===fr?I.side=A.shadowSide!==null?A.shadowSide:A.side:I.side=A.shadowSide!==null?A.shadowSide:u[A.side],I.alphaMap=A.alphaMap,I.alphaTest=A.alphaToCoverage===!0?.5:A.alphaTest,I.map=A.map,I.clipShadows=A.clipShadows,I.clippingPlanes=A.clippingPlanes,I.clipIntersection=A.clipIntersection,I.displacementMap=A.displacementMap,I.displacementScale=A.displacementScale,I.displacementBias=A.displacementBias,I.wireframeLinewidth=A.wireframeLinewidth,I.linewidth=A.linewidth,x.isPointLight===!0&&I.isMeshDistanceMaterial===!0){let B=s.properties.get(I);B.light=x}return I}function y(T,A,x,E,I){if(T.visible===!1)return;if(T.layers.test(A.layers)&&(T.isMesh||T.isLine||T.isPoints)&&(T.castShadow||T.receiveShadow&&I===fr)&&(!T.frustumCulled||T.intersectsFrustum(n))){T.modelViewMatrix.multiplyMatrices(x.matrixWorldInverse,T.matrixWorld);let G=e.update(T),D=T.material;if(Array.isArray(D)){let X=G.groups;for(let $=0,K=X.length;$<K;$++){let se=X[$],W=D[se.materialIndex];if(W&&W.visible){let ne=w(T,W,E,I);T.onBeforeShadow(s,T,A,x,G,ne,se),s.renderBufferDirect(x,null,G,ne,T,se),T.onAfterShadow(s,T,A,x,G,ne,se)}}}else if(D.visible){let X=w(T,D,E,I);T.onBeforeShadow(s,T,A,x,G,X,null),s.renderBufferDirect(x,null,G,X,T,null),T.onAfterShadow(s,T,A,x,G,X,null)}}let B=T.children;for(let G=0,D=B.length;G<D;G++)y(B[G],A,x,E,I)}function b(T){T.target.removeEventListener("dispose",b);for(let x in l){let E=l[x],I=T.target.uuid;I in E&&(E[I].dispose(),delete E[I])}}}function Cx(s,e){function t(){let P=!1,pe=new St,Q=null,de=new St(0,0,0,0);return{setMask:function(ye){Q!==ye&&!P&&(s.colorMask(ye,ye,ye,ye),Q=ye)},setLocked:function(ye){P=ye},setClear:function(ye,re,Pe,Se,gt){gt===!0&&(ye*=Se,re*=Se,Pe*=Se),pe.set(ye,re,Pe,Se),de.equals(pe)===!1&&(s.clearColor(ye,re,Pe,Se),de.copy(pe))},reset:function(){P=!1,Q=null,de.set(-1,0,0,0)}}}function n(){let P=!1,pe=!1,Q=null,de=null,ye=null;return{setReversed:function(re){if(pe!==re){let Pe=e.get("EXT_clip_control");re?Pe.clipControlEXT(Pe.LOWER_LEFT_EXT,Pe.ZERO_TO_ONE_EXT):Pe.clipControlEXT(Pe.LOWER_LEFT_EXT,Pe.NEGATIVE_ONE_TO_ONE_EXT),pe=re;let Se=ye;ye=null,this.setClear(Se)}},getReversed:function(){return pe},setTest:function(re){re?te(s.DEPTH_TEST):Te(s.DEPTH_TEST)},setMask:function(re){Q!==re&&!P&&(s.depthMask(re),Q=re)},setFunc:function(re){if(pe&&(re=Pd[re]),de!==re){switch(re){case lo:s.depthFunc(s.NEVER);break;case ho:s.depthFunc(s.ALWAYS);break;case uo:s.depthFunc(s.LESS);break;case Ks:s.depthFunc(s.LEQUAL);break;case fo:s.depthFunc(s.EQUAL);break;case po:s.depthFunc(s.GEQUAL);break;case mo:s.depthFunc(s.GREATER);break;case go:s.depthFunc(s.NOTEQUAL);break;default:s.depthFunc(s.LEQUAL)}de=re}},setLocked:function(re){P=re},setClear:function(re){ye!==re&&(ye=re,pe&&(re=1-re),s.clearDepth(re))},reset:function(){P=!1,Q=null,de=null,ye=null,pe=!1}}}function i(){let P=!1,pe=null,Q=null,de=null,ye=null,re=null,Pe=null,Se=null,gt=null;return{setTest:function(ct){P||(ct?te(s.STENCIL_TEST):Te(s.STENCIL_TEST))},setMask:function(ct){pe!==ct&&!P&&(s.stencilMask(ct),pe=ct)},setFunc:function(ct,fn,Ee){(Q!==ct||de!==fn||ye!==Ee)&&(s.stencilFunc(ct,fn,Ee),Q=ct,de=fn,ye=Ee)},setOp:function(ct,fn,Ee){(re!==ct||Pe!==fn||Se!==Ee)&&(s.stencilOp(ct,fn,Ee),re=ct,Pe=fn,Se=Ee)},setLocked:function(ct){P=ct},setClear:function(ct){gt!==ct&&(s.clearStencil(ct),gt=ct)},reset:function(){P=!1,pe=null,Q=null,de=null,ye=null,re=null,Pe=null,Se=null,gt=null}}}let r=new t,a=new n,o=new i,c=new WeakMap,l=new WeakMap,h={},u={},d={},f=new WeakMap,g=[],v=null,m=!1,p=null,S=null,w=null,y=null,b=null,T=null,A=null,x=new ze(0,0,0),E=0,I=!1,U=null,B=null,G=null,D=null,X=null,$=s.getParameter(s.MAX_COMBINED_TEXTURE_IMAGE_UNITS),K=!1,se=0,W=s.getParameter(s.VERSION);W.indexOf("WebGL")!==-1?(se=parseFloat(/^WebGL (\d)/.exec(W)[1]),K=se>=1):W.indexOf("OpenGL ES")!==-1&&(se=parseFloat(/^OpenGL ES (\d)/.exec(W)[1]),K=se>=2);let ne=null,ie={},Oe=s.getParameter(s.SCISSOR_BOX),Le=s.getParameter(s.VIEWPORT),vt=new St().fromArray(Oe),rt=new St().fromArray(Le);function ot(P,pe,Q,de){let ye=new Uint8Array(4),re=s.createTexture();s.bindTexture(P,re),s.texParameteri(P,s.TEXTURE_MIN_FILTER,s.NEAREST),s.texParameteri(P,s.TEXTURE_MAG_FILTER,s.NEAREST);for(let Pe=0;Pe<Q;Pe++)P===s.TEXTURE_3D||P===s.TEXTURE_2D_ARRAY?s.texImage3D(pe,0,s.RGBA,1,1,de,0,s.RGBA,s.UNSIGNED_BYTE,ye):s.texImage2D(pe+Pe,0,s.RGBA,1,1,0,s.RGBA,s.UNSIGNED_BYTE,ye);return re}let J={};J[s.TEXTURE_2D]=ot(s.TEXTURE_2D,s.TEXTURE_2D,1),J[s.TEXTURE_CUBE_MAP]=ot(s.TEXTURE_CUBE_MAP,s.TEXTURE_CUBE_MAP_POSITIVE_X,6),J[s.TEXTURE_2D_ARRAY]=ot(s.TEXTURE_2D_ARRAY,s.TEXTURE_2D_ARRAY,1,1),J[s.TEXTURE_3D]=ot(s.TEXTURE_3D,s.TEXTURE_3D,1,1),r.setClear(0,0,0,1),a.setClear(1),o.setClear(0),te(s.DEPTH_TEST),a.setFunc(Ks),et(!1),Rt(Dl),te(s.CULL_FACE),ut(ii);function te(P){h[P]!==!0&&(s.enable(P),h[P]=!0)}function Te(P){h[P]!==!1&&(s.disable(P),h[P]=!1)}function Be(P,pe){return d[P]!==pe?(s.bindFramebuffer(P,pe),d[P]=pe,P===s.DRAW_FRAMEBUFFER&&(d[s.FRAMEBUFFER]=pe),P===s.FRAMEBUFFER&&(d[s.DRAW_FRAMEBUFFER]=pe),!0):!1}function Me(P,pe){let Q=g,de=!1;if(P){Q=f.get(pe),Q===void 0&&(Q=[],f.set(pe,Q));let ye=P.textures;if(Q.length!==ye.length||Q[0]!==s.COLOR_ATTACHMENT0){for(let re=0,Pe=ye.length;re<Pe;re++)Q[re]=s.COLOR_ATTACHMENT0+re;Q.length=ye.length,de=!0}}else Q[0]!==s.BACK&&(Q[0]=s.BACK,de=!0);de&&s.drawBuffers(Q)}function $e(P){return v!==P?(s.useProgram(P),v=P,!0):!1}let At={[ys]:s.FUNC_ADD,[Ku]:s.FUNC_SUBTRACT,[Ju]:s.FUNC_REVERSE_SUBTRACT};At[$u]=s.MIN,At[ju]=s.MAX;let Ke={[Qu]:s.ZERO,[ed]:s.ONE,[td]:s.SRC_COLOR,[Ol]:s.SRC_ALPHA,[od]:s.SRC_ALPHA_SATURATE,[rd]:s.DST_COLOR,[id]:s.DST_ALPHA,[nd]:s.ONE_MINUS_SRC_COLOR,[Bl]:s.ONE_MINUS_SRC_ALPHA,[ad]:s.ONE_MINUS_DST_COLOR,[sd]:s.ONE_MINUS_DST_ALPHA,[cd]:s.CONSTANT_COLOR,[ld]:s.ONE_MINUS_CONSTANT_COLOR,[hd]:s.CONSTANT_ALPHA,[ud]:s.ONE_MINUS_CONSTANT_ALPHA};function ut(P,pe,Q,de,ye,re,Pe,Se,gt,ct){if(P===ii){m===!0&&(Te(s.BLEND),m=!1);return}if(m===!1&&(te(s.BLEND),m=!0),P!==Zu){if(P!==p||ct!==I){if((S!==ys||b!==ys)&&(s.blendEquation(s.FUNC_ADD),S=ys,b=ys),ct)switch(P){case pr:s.blendFuncSeparate(s.ONE,s.ONE_MINUS_SRC_ALPHA,s.ONE,s.ONE_MINUS_SRC_ALPHA);break;case Gn:s.blendFunc(s.ONE,s.ONE);break;case Ul:s.blendFuncSeparate(s.ZERO,s.ONE_MINUS_SRC_COLOR,s.ZERO,s.ONE);break;case Fl:s.blendFuncSeparate(s.DST_COLOR,s.ONE_MINUS_SRC_ALPHA,s.ZERO,s.ONE);break;default:We("WebGLState: Invalid blending: ",P);break}else switch(P){case pr:s.blendFuncSeparate(s.SRC_ALPHA,s.ONE_MINUS_SRC_ALPHA,s.ONE,s.ONE_MINUS_SRC_ALPHA);break;case Gn:s.blendFuncSeparate(s.SRC_ALPHA,s.ONE,s.ONE,s.ONE);break;case Ul:We("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Fl:We("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:We("WebGLState: Invalid blending: ",P);break}w=null,y=null,T=null,A=null,x.set(0,0,0),E=0,p=P,I=ct}return}ye=ye||pe,re=re||Q,Pe=Pe||de,(pe!==S||ye!==b)&&(s.blendEquationSeparate(At[pe],At[ye]),S=pe,b=ye),(Q!==w||de!==y||re!==T||Pe!==A)&&(s.blendFuncSeparate(Ke[Q],Ke[de],Ke[re],Ke[Pe]),w=Q,y=de,T=re,A=Pe),(Se.equals(x)===!1||gt!==E)&&(s.blendColor(Se.r,Se.g,Se.b,gt),x.copy(Se),E=gt),p=P,I=!1}function xt(P,pe){P.side===tn?Te(s.CULL_FACE):te(s.CULL_FACE);let Q=P.side===un;pe&&(Q=!Q),et(Q),P.blending===pr&&P.transparent===!1?ut(ii):ut(P.blending,P.blendEquation,P.blendSrc,P.blendDst,P.blendEquationAlpha,P.blendSrcAlpha,P.blendDstAlpha,P.blendColor,P.blendAlpha,P.premultipliedAlpha),a.setFunc(P.depthFunc),a.setTest(P.depthTest),a.setMask(P.depthWrite),r.setMask(P.colorWrite);let de=P.stencilWrite;o.setTest(de),de&&(o.setMask(P.stencilWriteMask),o.setFunc(P.stencilFunc,P.stencilRef,P.stencilFuncMask),o.setOp(P.stencilFail,P.stencilZFail,P.stencilZPass)),qt(P.polygonOffset,P.polygonOffsetFactor,P.polygonOffsetUnits),P.alphaToCoverage===!0?te(s.SAMPLE_ALPHA_TO_COVERAGE):Te(s.SAMPLE_ALPHA_TO_COVERAGE)}function et(P){U!==P&&(P?s.frontFace(s.CW):s.frontFace(s.CCW),U=P)}function Rt(P){P!==Xu?(te(s.CULL_FACE),P!==B&&(P===Dl?s.cullFace(s.BACK):P===qu?s.cullFace(s.FRONT):s.cullFace(s.FRONT_AND_BACK))):Te(s.CULL_FACE),B=P}function Ut(P){P!==G&&(K&&s.lineWidth(P),G=P)}function qt(P,pe,Q){P?(te(s.POLYGON_OFFSET_FILL),(D!==pe||X!==Q)&&(D=pe,X=Q,a.getReversed()&&(pe=-pe),s.polygonOffset(pe,Q))):Te(s.POLYGON_OFFSET_FILL)}function Pt(P){P?te(s.SCISSOR_TEST):Te(s.SCISSOR_TEST)}function Ft(P){P===void 0&&(P=s.TEXTURE0+$-1),ne!==P&&(s.activeTexture(P),ne=P)}function F(P,pe,Q){Q===void 0&&(ne===null?Q=s.TEXTURE0+$-1:Q=ne);let de=ie[Q];de===void 0&&(de={type:void 0,texture:void 0},ie[Q]=de),(de.type!==P||de.texture!==pe)&&(ne!==Q&&(s.activeTexture(Q),ne=Q),s.bindTexture(P,pe||J[P]),de.type=P,de.texture=pe)}function Jt(){let P=ie[ne];P!==void 0&&P.type!==void 0&&(s.bindTexture(P.type,null),P.type=void 0,P.texture=void 0)}function mt(){try{s.compressedTexImage2D(...arguments)}catch(P){We("WebGLState:",P)}}function R(){try{s.compressedTexImage3D(...arguments)}catch(P){We("WebGLState:",P)}}function _(){try{s.texSubImage2D(...arguments)}catch(P){We("WebGLState:",P)}}function L(){try{s.texSubImage3D(...arguments)}catch(P){We("WebGLState:",P)}}function k(){try{s.compressedTexSubImage2D(...arguments)}catch(P){We("WebGLState:",P)}}function Z(){try{s.compressedTexSubImage3D(...arguments)}catch(P){We("WebGLState:",P)}}function ae(){try{s.texStorage2D(...arguments)}catch(P){We("WebGLState:",P)}}function ue(){try{s.texStorage3D(...arguments)}catch(P){We("WebGLState:",P)}}function j(){try{s.texImage2D(...arguments)}catch(P){We("WebGLState:",P)}}function ee(){try{s.texImage3D(...arguments)}catch(P){We("WebGLState:",P)}}function fe(P){return u[P]!==void 0?u[P]:s.getParameter(P)}function Ie(P,pe){u[P]!==pe&&(s.pixelStorei(P,pe),u[P]=pe)}function me(P){vt.equals(P)===!1&&(s.scissor(P.x,P.y,P.z,P.w),vt.copy(P))}function he(P){rt.equals(P)===!1&&(s.viewport(P.x,P.y,P.z,P.w),rt.copy(P))}function Ne(P,pe){let Q=l.get(pe);Q===void 0&&(Q=new WeakMap,l.set(pe,Q));let de=Q.get(P);de===void 0&&(de=s.getUniformBlockIndex(pe,P.name),Q.set(P,de))}function Fe(P,pe){let de=l.get(pe).get(P);c.get(pe)!==de&&(s.uniformBlockBinding(pe,de,P.__bindingPointIndex),c.set(pe,de))}function Xe(){s.disable(s.BLEND),s.disable(s.CULL_FACE),s.disable(s.DEPTH_TEST),s.disable(s.POLYGON_OFFSET_FILL),s.disable(s.SCISSOR_TEST),s.disable(s.STENCIL_TEST),s.disable(s.SAMPLE_ALPHA_TO_COVERAGE),s.blendEquation(s.FUNC_ADD),s.blendFunc(s.ONE,s.ZERO),s.blendFuncSeparate(s.ONE,s.ZERO,s.ONE,s.ZERO),s.blendColor(0,0,0,0),s.colorMask(!0,!0,!0,!0),s.clearColor(0,0,0,0),s.depthMask(!0),s.depthFunc(s.LESS),a.setReversed(!1),s.clearDepth(1),s.stencilMask(4294967295),s.stencilFunc(s.ALWAYS,0,4294967295),s.stencilOp(s.KEEP,s.KEEP,s.KEEP),s.clearStencil(0),s.cullFace(s.BACK),s.frontFace(s.CCW),s.polygonOffset(0,0),s.activeTexture(s.TEXTURE0),s.bindFramebuffer(s.FRAMEBUFFER,null),s.bindFramebuffer(s.DRAW_FRAMEBUFFER,null),s.bindFramebuffer(s.READ_FRAMEBUFFER,null),s.useProgram(null),s.lineWidth(1),s.scissor(0,0,s.canvas.width,s.canvas.height),s.viewport(0,0,s.canvas.width,s.canvas.height),s.pixelStorei(s.PACK_ALIGNMENT,4),s.pixelStorei(s.UNPACK_ALIGNMENT,4),s.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,!1),s.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),s.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,s.BROWSER_DEFAULT_WEBGL),s.pixelStorei(s.PACK_ROW_LENGTH,0),s.pixelStorei(s.PACK_SKIP_PIXELS,0),s.pixelStorei(s.PACK_SKIP_ROWS,0),s.pixelStorei(s.UNPACK_ROW_LENGTH,0),s.pixelStorei(s.UNPACK_IMAGE_HEIGHT,0),s.pixelStorei(s.UNPACK_SKIP_PIXELS,0),s.pixelStorei(s.UNPACK_SKIP_ROWS,0),s.pixelStorei(s.UNPACK_SKIP_IMAGES,0),h={},u={},ne=null,ie={},d={},f=new WeakMap,g=[],v=null,m=!1,p=null,S=null,w=null,y=null,b=null,T=null,A=null,x=new ze(0,0,0),E=0,I=!1,U=null,B=null,G=null,D=null,X=null,vt.set(0,0,s.canvas.width,s.canvas.height),rt.set(0,0,s.canvas.width,s.canvas.height),r.reset(),a.reset(),o.reset()}return{buffers:{color:r,depth:a,stencil:o},enable:te,disable:Te,bindFramebuffer:Be,drawBuffers:Me,useProgram:$e,setBlending:ut,setMaterial:xt,setFlipSided:et,setCullFace:Rt,setLineWidth:Ut,setPolygonOffset:qt,setScissorTest:Pt,activeTexture:Ft,bindTexture:F,unbindTexture:Jt,compressedTexImage2D:mt,compressedTexImage3D:R,texImage2D:j,texImage3D:ee,pixelStorei:Ie,getParameter:fe,updateUBOMapping:Ne,uniformBlockBinding:Fe,texStorage2D:ae,texStorage3D:ue,texSubImage2D:_,texSubImage3D:L,compressedTexSubImage2D:k,compressedTexSubImage3D:Z,scissor:me,viewport:he,reset:Xe}}function Ix(s,e,t,n,i,r,a){let o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),l=new ve,h=new WeakMap,u=new Set,d,f=new WeakMap,g=!1;try{g=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function v(R,_){return g?new OffscreenCanvas(R,_):js("canvas")}function m(R,_,L){let k=1,Z=mt(R);if((Z.width>L||Z.height>L)&&(k=L/Math.max(Z.width,Z.height)),k<1)if(typeof HTMLImageElement<"u"&&R instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&R instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&R instanceof ImageBitmap||typeof VideoFrame<"u"&&R instanceof VideoFrame){let ae=Math.floor(k*Z.width),ue=Math.floor(k*Z.height);d===void 0&&(d=v(ae,ue));let j=_?v(ae,ue):d;return j.width=ae,j.height=ue,j.getContext("2d").drawImage(R,0,0,ae,ue),Ue("WebGLRenderer: Texture has been resized from ("+Z.width+"x"+Z.height+") to ("+ae+"x"+ue+")."),j}else return"data"in R&&Ue("WebGLRenderer: Image in DataTexture is too big ("+Z.width+"x"+Z.height+")."),R;return R}function p(R){return R.generateMipmaps}function S(R){s.generateMipmap(R)}function w(R){return R.isWebGLCubeRenderTarget?s.TEXTURE_CUBE_MAP:R.isWebGL3DRenderTarget?s.TEXTURE_3D:R.isWebGLArrayRenderTarget||R.isCompressedArrayTexture?s.TEXTURE_2D_ARRAY:s.TEXTURE_2D}function y(R,_,L,k,Z,ae=!1){if(R!==null){if(s[R]!==void 0)return s[R];Ue("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+R+"'")}let ue;k&&(ue=e.get("EXT_texture_norm16"),ue||Ue("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let j=_;if(_===s.RED&&(L===s.FLOAT&&(j=s.R32F),L===s.HALF_FLOAT&&(j=s.R16F),L===s.UNSIGNED_BYTE&&(j=s.R8),L===s.UNSIGNED_SHORT&&ue&&(j=ue.R16_EXT),L===s.SHORT&&ue&&(j=ue.R16_SNORM_EXT)),_===s.RED_INTEGER&&(L===s.UNSIGNED_BYTE&&(j=s.R8UI),L===s.UNSIGNED_SHORT&&(j=s.R16UI),L===s.UNSIGNED_INT&&(j=s.R32UI),L===s.BYTE&&(j=s.R8I),L===s.SHORT&&(j=s.R16I),L===s.INT&&(j=s.R32I)),_===s.RG&&(L===s.FLOAT&&(j=s.RG32F),L===s.HALF_FLOAT&&(j=s.RG16F),L===s.UNSIGNED_BYTE&&(j=s.RG8),L===s.UNSIGNED_SHORT&&ue&&(j=ue.RG16_EXT),L===s.SHORT&&ue&&(j=ue.RG16_SNORM_EXT)),_===s.RG_INTEGER&&(L===s.UNSIGNED_BYTE&&(j=s.RG8UI),L===s.UNSIGNED_SHORT&&(j=s.RG16UI),L===s.UNSIGNED_INT&&(j=s.RG32UI),L===s.BYTE&&(j=s.RG8I),L===s.SHORT&&(j=s.RG16I),L===s.INT&&(j=s.RG32I)),_===s.RGB_INTEGER&&(L===s.UNSIGNED_BYTE&&(j=s.RGB8UI),L===s.UNSIGNED_SHORT&&(j=s.RGB16UI),L===s.UNSIGNED_INT&&(j=s.RGB32UI),L===s.BYTE&&(j=s.RGB8I),L===s.SHORT&&(j=s.RGB16I),L===s.INT&&(j=s.RGB32I)),_===s.RGBA_INTEGER&&(L===s.UNSIGNED_BYTE&&(j=s.RGBA8UI),L===s.UNSIGNED_SHORT&&(j=s.RGBA16UI),L===s.UNSIGNED_INT&&(j=s.RGBA32UI),L===s.BYTE&&(j=s.RGBA8I),L===s.SHORT&&(j=s.RGBA16I),L===s.INT&&(j=s.RGBA32I)),_===s.RGB&&(L===s.UNSIGNED_SHORT&&ue&&(j=ue.RGB16_EXT),L===s.SHORT&&ue&&(j=ue.RGB16_SNORM_EXT),L===s.UNSIGNED_INT_5_9_9_9_REV&&(j=s.RGB9_E5),L===s.UNSIGNED_INT_10F_11F_11F_REV&&(j=s.R11F_G11F_B10F)),_===s.RGBA){let ee=ae?Gr:it.getTransfer(Z);L===s.FLOAT&&(j=s.RGBA32F),L===s.HALF_FLOAT&&(j=s.RGBA16F),L===s.UNSIGNED_BYTE&&(j=ee===yt?s.SRGB8_ALPHA8:s.RGBA8),L===s.UNSIGNED_SHORT&&ue&&(j=ue.RGBA16_EXT),L===s.SHORT&&ue&&(j=ue.RGBA16_SNORM_EXT),L===s.UNSIGNED_SHORT_4_4_4_4&&(j=s.RGBA4),L===s.UNSIGNED_SHORT_5_5_5_1&&(j=s.RGB5_A1)}return(j===s.R16F||j===s.R32F||j===s.RG16F||j===s.RG32F||j===s.RGBA16F||j===s.RGBA32F)&&e.get("EXT_color_buffer_float"),j}function b(R,_){let L;return R?_===null||_===qn||_===_r?L=s.DEPTH24_STENCIL8:_===En?L=s.DEPTH32F_STENCIL8:_===gr&&(L=s.DEPTH24_STENCIL8,Ue("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):_===null||_===qn||_===_r?L=s.DEPTH_COMPONENT24:_===En?L=s.DEPTH_COMPONENT32F:_===gr&&(L=s.DEPTH_COMPONENT16),L}function T(R,_){return p(R)===!0||R.isFramebufferTexture&&R.minFilter!==zt&&R.minFilter!==Ht?Math.log2(Math.max(_.width,_.height))+1:R.mipmaps!==void 0&&R.mipmaps.length>0?R.mipmaps.length:R.isCompressedTexture&&Array.isArray(R.image)?_.mipmaps.length:1}function A(R){let _=R.target;_.removeEventListener("dispose",A),E(_),_.isVideoTexture&&h.delete(_),_.isHTMLTexture&&u.delete(_)}function x(R){let _=R.target;_.removeEventListener("dispose",x),U(_)}function E(R){let _=n.get(R);if(_.__webglInit===void 0)return;let L=R.source,k=f.get(L);if(k){let Z=k[_.__cacheKey];Z.usedTimes--,Z.usedTimes===0&&I(R),Object.keys(k).length===0&&f.delete(L)}n.remove(R)}function I(R){let _=n.get(R);s.deleteTexture(_.__webglTexture);let L=R.source,k=f.get(L);delete k[_.__cacheKey],a.memory.textures--}function U(R){let _=n.get(R);if(R.depthTexture&&(R.depthTexture.dispose(),n.remove(R.depthTexture)),R.isWebGLCubeRenderTarget)for(let k=0;k<6;k++){if(Array.isArray(_.__webglFramebuffer[k]))for(let Z=0;Z<_.__webglFramebuffer[k].length;Z++)s.deleteFramebuffer(_.__webglFramebuffer[k][Z]);else s.deleteFramebuffer(_.__webglFramebuffer[k]);_.__webglDepthbuffer&&s.deleteRenderbuffer(_.__webglDepthbuffer[k])}else{if(Array.isArray(_.__webglFramebuffer))for(let k=0;k<_.__webglFramebuffer.length;k++)s.deleteFramebuffer(_.__webglFramebuffer[k]);else s.deleteFramebuffer(_.__webglFramebuffer);if(_.__webglDepthbuffer&&s.deleteRenderbuffer(_.__webglDepthbuffer),_.__webglMultisampledFramebuffer&&s.deleteFramebuffer(_.__webglMultisampledFramebuffer),_.__webglColorRenderbuffer)for(let k=0;k<_.__webglColorRenderbuffer.length;k++)_.__webglColorRenderbuffer[k]&&s.deleteRenderbuffer(_.__webglColorRenderbuffer[k]);_.__webglDepthRenderbuffer&&s.deleteRenderbuffer(_.__webglDepthRenderbuffer)}let L=R.textures;for(let k=0,Z=L.length;k<Z;k++){let ae=n.get(L[k]);ae.__webglTexture&&(s.deleteTexture(ae.__webglTexture),a.memory.textures--),n.remove(L[k])}n.remove(R)}let B=0;function G(){B=0}function D(){return B}function X(R){B=R}function $(){let R=B;return R>=i.maxTextures&&Ue("WebGLTextures: Trying to use "+(R+1)+" texture units while this GPU supports only "+i.maxTextures),B+=1,R}function K(R){let _=[];return _.push(R.wrapS),_.push(R.wrapT),_.push(R.wrapR||0),_.push(R.magFilter),_.push(R.minFilter),_.push(R.anisotropy),_.push(R.internalFormat),_.push(R.format),_.push(R.type),_.push(R.generateMipmaps),_.push(R.premultiplyAlpha),_.push(R.flipY),_.push(R.unpackAlignment),_.push(R.colorSpace),_.join()}function se(R,_){let L=n.get(R);if(R.isVideoTexture&&F(R),R.isRenderTargetTexture===!1&&R.isExternalTexture!==!0&&R.version>0&&L.__version!==R.version){let k=R.image;if(k===null)Ue("WebGLRenderer: Texture marked for update but no image data found.");else if(k.complete===!1)Ue("WebGLRenderer: Texture marked for update but image is incomplete");else{Te(L,R,_);return}}else R.isExternalTexture&&(L.__webglTexture=R.sourceTexture?R.sourceTexture:null);t.bindTexture(s.TEXTURE_2D,L.__webglTexture,s.TEXTURE0+_)}function W(R,_){let L=n.get(R);if(R.isRenderTargetTexture===!1&&R.version>0&&L.__version!==R.version){Te(L,R,_);return}else R.isExternalTexture&&(L.__webglTexture=R.sourceTexture?R.sourceTexture:null);t.bindTexture(s.TEXTURE_2D_ARRAY,L.__webglTexture,s.TEXTURE0+_)}function ne(R,_){let L=n.get(R);if(R.isRenderTargetTexture===!1&&R.version>0&&L.__version!==R.version){Te(L,R,_);return}t.bindTexture(s.TEXTURE_3D,L.__webglTexture,s.TEXTURE0+_)}function ie(R,_){let L=n.get(R);if(R.isCubeDepthTexture!==!0&&R.version>0&&L.__version!==R.version){Be(L,R,_);return}t.bindTexture(s.TEXTURE_CUBE_MAP,L.__webglTexture,s.TEXTURE0+_)}let Oe={[zi]:s.REPEAT,[Cn]:s.CLAMP_TO_EDGE,[Js]:s.MIRRORED_REPEAT},Le={[zt]:s.NEAREST,[Yo]:s.NEAREST_MIPMAP_NEAREST,[Ms]:s.NEAREST_MIPMAP_LINEAR,[Ht]:s.LINEAR,[mr]:s.LINEAR_MIPMAP_NEAREST,[Xn]:s.LINEAR_MIPMAP_LINEAR},vt={[Sd]:s.NEVER,[Ad]:s.ALWAYS,[bd]:s.LESS,[Nc]:s.LEQUAL,[Td]:s.EQUAL,[Dc]:s.GEQUAL,[Ed]:s.GREATER,[wd]:s.NOTEQUAL};function rt(R,_){if(_.type===En&&e.has("OES_texture_float_linear")===!1&&(_.magFilter===Ht||_.magFilter===mr||_.magFilter===Ms||_.magFilter===Xn||_.minFilter===Ht||_.minFilter===mr||_.minFilter===Ms||_.minFilter===Xn)&&Ue("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),s.texParameteri(R,s.TEXTURE_WRAP_S,Oe[_.wrapS]),s.texParameteri(R,s.TEXTURE_WRAP_T,Oe[_.wrapT]),(R===s.TEXTURE_3D||R===s.TEXTURE_2D_ARRAY)&&s.texParameteri(R,s.TEXTURE_WRAP_R,Oe[_.wrapR]),s.texParameteri(R,s.TEXTURE_MAG_FILTER,Le[_.magFilter]),s.texParameteri(R,s.TEXTURE_MIN_FILTER,Le[_.minFilter]),_.compareFunction&&(s.texParameteri(R,s.TEXTURE_COMPARE_MODE,s.COMPARE_REF_TO_TEXTURE),s.texParameteri(R,s.TEXTURE_COMPARE_FUNC,vt[_.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(_.magFilter===zt||_.minFilter!==Ms&&_.minFilter!==Xn||_.type===En&&e.has("OES_texture_float_linear")===!1)return;if(_.anisotropy>1||n.get(_).__currentAnisotropy){let L=e.get("EXT_texture_filter_anisotropic");s.texParameterf(R,L.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(_.anisotropy,i.getMaxAnisotropy())),n.get(_).__currentAnisotropy=_.anisotropy}}}function ot(R,_){let L=!1;R.__webglInit===void 0&&(R.__webglInit=!0,_.addEventListener("dispose",A));let k=_.source,Z=f.get(k);Z===void 0&&(Z={},f.set(k,Z));let ae=K(_);if(ae!==R.__cacheKey){Z[ae]===void 0&&(Z[ae]={texture:s.createTexture(),usedTimes:0},a.memory.textures++,L=!0),Z[ae].usedTimes++;let ue=Z[R.__cacheKey];ue!==void 0&&(Z[R.__cacheKey].usedTimes--,ue.usedTimes===0&&I(_)),R.__cacheKey=ae,R.__webglTexture=Z[ae].texture}return L}function J(R,_,L){return Math.floor(Math.floor(R/L)/_)}function te(R,_,L,k){let ae=R.updateRanges;if(ae.length===0)t.texSubImage2D(s.TEXTURE_2D,0,0,0,_.width,_.height,L,k,_.data);else{ae.sort((Ie,me)=>Ie.start-me.start);let ue=0;for(let Ie=1;Ie<ae.length;Ie++){let me=ae[ue],he=ae[Ie],Ne=me.start+me.count,Fe=J(he.start,_.width,4),Xe=J(me.start,_.width,4);he.start<=Ne+1&&Fe===Xe&&J(he.start+he.count-1,_.width,4)===Fe?me.count=Math.max(me.count,he.start+he.count-me.start):(++ue,ae[ue]=he)}ae.length=ue+1;let j=t.getParameter(s.UNPACK_ROW_LENGTH),ee=t.getParameter(s.UNPACK_SKIP_PIXELS),fe=t.getParameter(s.UNPACK_SKIP_ROWS);t.pixelStorei(s.UNPACK_ROW_LENGTH,_.width);for(let Ie=0,me=ae.length;Ie<me;Ie++){let he=ae[Ie],Ne=Math.floor(he.start/4),Fe=Math.ceil(he.count/4),Xe=Ne%_.width,P=Math.floor(Ne/_.width),pe=Fe,Q=1;t.pixelStorei(s.UNPACK_SKIP_PIXELS,Xe),t.pixelStorei(s.UNPACK_SKIP_ROWS,P),t.texSubImage2D(s.TEXTURE_2D,0,Xe,P,pe,Q,L,k,_.data)}R.clearUpdateRanges(),t.pixelStorei(s.UNPACK_ROW_LENGTH,j),t.pixelStorei(s.UNPACK_SKIP_PIXELS,ee),t.pixelStorei(s.UNPACK_SKIP_ROWS,fe)}}function Te(R,_,L){let k=s.TEXTURE_2D;(_.isDataArrayTexture||_.isCompressedArrayTexture)&&(k=s.TEXTURE_2D_ARRAY),_.isData3DTexture&&(k=s.TEXTURE_3D);let Z=ot(R,_),ae=_.source;t.bindTexture(k,R.__webglTexture,s.TEXTURE0+L);let ue=n.get(ae);if(ae.version!==ue.__version||Z===!0){if(t.activeTexture(s.TEXTURE0+L),(typeof ImageBitmap<"u"&&_.image instanceof ImageBitmap)===!1){let Q=it.getPrimaries(it.workingColorSpace),de=_.colorSpace===Ai?null:it.getPrimaries(_.colorSpace),ye=_.colorSpace===Ai||Q===de?s.NONE:s.BROWSER_DEFAULT_WEBGL;t.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,_.flipY),t.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),t.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,ye)}t.pixelStorei(s.UNPACK_ALIGNMENT,_.unpackAlignment);let ee=m(_.image,!1,i.maxTextureSize);ee=Jt(_,ee);let fe=r.convert(_.format,_.colorSpace),Ie=r.convert(_.type),me=y(_.internalFormat,fe,Ie,_.normalized,_.colorSpace,_.isVideoTexture);rt(k,_);let he,Ne=_.mipmaps,Fe=_.isVideoTexture!==!0,Xe=ue.__version===void 0||Z===!0,P=ae.dataReady,pe=T(_,ee);if(_.isDepthTexture)me=b(_.format===Zi,_.type),Xe&&(Fe?t.texStorage2D(s.TEXTURE_2D,1,me,ee.width,ee.height):t.texImage2D(s.TEXTURE_2D,0,me,ee.width,ee.height,0,fe,Ie,null));else if(_.isDataTexture)if(Ne.length>0){Fe&&Xe&&t.texStorage2D(s.TEXTURE_2D,pe,me,Ne[0].width,Ne[0].height);for(let Q=0,de=Ne.length;Q<de;Q++)he=Ne[Q],Fe?P&&t.texSubImage2D(s.TEXTURE_2D,Q,0,0,he.width,he.height,fe,Ie,he.data):t.texImage2D(s.TEXTURE_2D,Q,me,he.width,he.height,0,fe,Ie,he.data);_.generateMipmaps=!1}else Fe?(Xe&&t.texStorage2D(s.TEXTURE_2D,pe,me,ee.width,ee.height),P&&te(_,ee,fe,Ie)):t.texImage2D(s.TEXTURE_2D,0,me,ee.width,ee.height,0,fe,Ie,ee.data);else if(_.isCompressedTexture)if(_.isCompressedArrayTexture){Fe&&Xe&&t.texStorage3D(s.TEXTURE_2D_ARRAY,pe,me,Ne[0].width,Ne[0].height,ee.depth);for(let Q=0,de=Ne.length;Q<de;Q++)if(he=Ne[Q],_.format!==wn)if(fe!==null)if(Fe){if(P)if(_.layerUpdates.size>0){let ye=oh(he.width,he.height,_.format,_.type);for(let re of _.layerUpdates){let Pe=he.data.subarray(re*ye/he.data.BYTES_PER_ELEMENT,(re+1)*ye/he.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(s.TEXTURE_2D_ARRAY,Q,0,0,re,he.width,he.height,1,fe,Pe)}}else t.compressedTexSubImage3D(s.TEXTURE_2D_ARRAY,Q,0,0,0,he.width,he.height,ee.depth,fe,he.data)}else t.compressedTexImage3D(s.TEXTURE_2D_ARRAY,Q,me,he.width,he.height,ee.depth,0,he.data,0,0);else Ue("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Fe?P&&t.texSubImage3D(s.TEXTURE_2D_ARRAY,Q,0,0,0,he.width,he.height,ee.depth,fe,Ie,he.data):t.texImage3D(s.TEXTURE_2D_ARRAY,Q,me,he.width,he.height,ee.depth,0,fe,Ie,he.data);_.layerUpdates.size>0&&_.clearLayerUpdates()}else{Fe&&Xe&&t.texStorage2D(s.TEXTURE_2D,pe,me,Ne[0].width,Ne[0].height);for(let Q=0,de=Ne.length;Q<de;Q++)he=Ne[Q],_.format!==wn?fe!==null?Fe?P&&t.compressedTexSubImage2D(s.TEXTURE_2D,Q,0,0,he.width,he.height,fe,he.data):t.compressedTexImage2D(s.TEXTURE_2D,Q,me,he.width,he.height,0,he.data):Ue("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Fe?P&&t.texSubImage2D(s.TEXTURE_2D,Q,0,0,he.width,he.height,fe,Ie,he.data):t.texImage2D(s.TEXTURE_2D,Q,me,he.width,he.height,0,fe,Ie,he.data)}else if(_.isDataArrayTexture)if(Fe){if(Xe&&t.texStorage3D(s.TEXTURE_2D_ARRAY,pe,me,ee.width,ee.height,ee.depth),P)if(_.layerUpdates.size>0){let Q=oh(ee.width,ee.height,_.format,_.type);for(let de of _.layerUpdates){let ye=ee.data.subarray(de*Q/ee.data.BYTES_PER_ELEMENT,(de+1)*Q/ee.data.BYTES_PER_ELEMENT);t.texSubImage3D(s.TEXTURE_2D_ARRAY,0,0,0,de,ee.width,ee.height,1,fe,Ie,ye)}_.clearLayerUpdates()}else t.texSubImage3D(s.TEXTURE_2D_ARRAY,0,0,0,0,ee.width,ee.height,ee.depth,fe,Ie,ee.data)}else t.texImage3D(s.TEXTURE_2D_ARRAY,0,me,ee.width,ee.height,ee.depth,0,fe,Ie,ee.data);else if(_.isData3DTexture)Fe?(Xe&&t.texStorage3D(s.TEXTURE_3D,pe,me,ee.width,ee.height,ee.depth),P&&t.texSubImage3D(s.TEXTURE_3D,0,0,0,0,ee.width,ee.height,ee.depth,fe,Ie,ee.data)):t.texImage3D(s.TEXTURE_3D,0,me,ee.width,ee.height,ee.depth,0,fe,Ie,ee.data);else if(_.isFramebufferTexture){if(Xe)if(Fe)t.texStorage2D(s.TEXTURE_2D,pe,me,ee.width,ee.height);else{let Q=ee.width,de=ee.height;for(let ye=0;ye<pe;ye++)t.texImage2D(s.TEXTURE_2D,ye,me,Q,de,0,fe,Ie,null),Q>>=1,de>>=1}}else if(_.isHTMLTexture){if("texElementImage2D"in s){let Q=s.canvas;if(Q.hasAttribute("layoutsubtree")||Q.setAttribute("layoutsubtree","true"),ee.parentNode!==Q){Q.appendChild(ee),u.add(_),Q.onpaint=de=>{let ye=de.changedElements;for(let re of u)ye.includes(re.image)&&(re.needsUpdate=!0)},Q.requestPaint();return}if(s.texElementImage2D.length===3)s.texElementImage2D(s.TEXTURE_2D,s.RGBA8,ee);else{let ye=s.RGBA,re=s.RGBA,Pe=s.UNSIGNED_BYTE;s.texElementImage2D(s.TEXTURE_2D,0,ye,re,Pe,ee)}s.texParameteri(s.TEXTURE_2D,s.TEXTURE_MIN_FILTER,s.LINEAR),s.texParameteri(s.TEXTURE_2D,s.TEXTURE_WRAP_S,s.CLAMP_TO_EDGE),s.texParameteri(s.TEXTURE_2D,s.TEXTURE_WRAP_T,s.CLAMP_TO_EDGE)}}else if(Ne.length>0){if(Fe&&Xe){let Q=mt(Ne[0]);t.texStorage2D(s.TEXTURE_2D,pe,me,Q.width,Q.height)}for(let Q=0,de=Ne.length;Q<de;Q++)he=Ne[Q],Fe?P&&t.texSubImage2D(s.TEXTURE_2D,Q,0,0,fe,Ie,he):t.texImage2D(s.TEXTURE_2D,Q,me,fe,Ie,he);_.generateMipmaps=!1}else if(Fe){if(Xe){let Q=mt(ee);t.texStorage2D(s.TEXTURE_2D,pe,me,Q.width,Q.height)}P&&t.texSubImage2D(s.TEXTURE_2D,0,0,0,fe,Ie,ee)}else t.texImage2D(s.TEXTURE_2D,0,me,fe,Ie,ee);p(_)&&S(k),ue.__version=ae.version,_.onUpdate&&_.onUpdate(_)}R.__version=_.version}function Be(R,_,L){if(_.image.length!==6)return;let k=ot(R,_),Z=_.source;t.bindTexture(s.TEXTURE_CUBE_MAP,R.__webglTexture,s.TEXTURE0+L);let ae=n.get(Z);if(Z.version!==ae.__version||k===!0){t.activeTexture(s.TEXTURE0+L);let ue=it.getPrimaries(it.workingColorSpace),j=_.colorSpace===Ai?null:it.getPrimaries(_.colorSpace),ee=_.colorSpace===Ai||ue===j?s.NONE:s.BROWSER_DEFAULT_WEBGL;t.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,_.flipY),t.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),t.pixelStorei(s.UNPACK_ALIGNMENT,_.unpackAlignment),t.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,ee);let fe=_.isCompressedTexture||_.image[0].isCompressedTexture,Ie=_.image[0]&&_.image[0].isDataTexture,me=[];for(let re=0;re<6;re++)!fe&&!Ie?me[re]=m(_.image[re],!0,i.maxCubemapSize):me[re]=Ie?_.image[re].image:_.image[re],me[re]=Jt(_,me[re]);let he=me[0],Ne=r.convert(_.format,_.colorSpace),Fe=r.convert(_.type),Xe=y(_.internalFormat,Ne,Fe,_.normalized,_.colorSpace),P=_.isVideoTexture!==!0,pe=ae.__version===void 0||k===!0,Q=Z.dataReady,de=T(_,he);rt(s.TEXTURE_CUBE_MAP,_);let ye;if(fe){P&&pe&&t.texStorage2D(s.TEXTURE_CUBE_MAP,de,Xe,he.width,he.height);for(let re=0;re<6;re++){ye=me[re].mipmaps;for(let Pe=0;Pe<ye.length;Pe++){let Se=ye[Pe];_.format!==wn?Ne!==null?P?Q&&t.compressedTexSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+re,Pe,0,0,Se.width,Se.height,Ne,Se.data):t.compressedTexImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+re,Pe,Xe,Se.width,Se.height,0,Se.data):Ue("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):P?Q&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+re,Pe,0,0,Se.width,Se.height,Ne,Fe,Se.data):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+re,Pe,Xe,Se.width,Se.height,0,Ne,Fe,Se.data)}}}else{if(ye=_.mipmaps,P&&pe){ye.length>0&&de++;let re=mt(me[0]);t.texStorage2D(s.TEXTURE_CUBE_MAP,de,Xe,re.width,re.height)}for(let re=0;re<6;re++)if(Ie){P?Q&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+re,0,0,0,me[re].width,me[re].height,Ne,Fe,me[re].data):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+re,0,Xe,me[re].width,me[re].height,0,Ne,Fe,me[re].data);for(let Pe=0;Pe<ye.length;Pe++){let gt=ye[Pe].image[re].image;P?Q&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+re,Pe+1,0,0,gt.width,gt.height,Ne,Fe,gt.data):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+re,Pe+1,Xe,gt.width,gt.height,0,Ne,Fe,gt.data)}}else{P?Q&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+re,0,0,0,Ne,Fe,me[re]):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+re,0,Xe,Ne,Fe,me[re]);for(let Pe=0;Pe<ye.length;Pe++){let Se=ye[Pe];P?Q&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+re,Pe+1,0,0,Ne,Fe,Se.image[re]):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+re,Pe+1,Xe,Ne,Fe,Se.image[re])}}}p(_)&&S(s.TEXTURE_CUBE_MAP),ae.__version=Z.version,_.onUpdate&&_.onUpdate(_)}R.__version=_.version}function Me(R,_,L,k,Z,ae){let ue=r.convert(L.format,L.colorSpace),j=r.convert(L.type),ee=y(L.internalFormat,ue,j,L.normalized,L.colorSpace),fe=n.get(_),Ie=n.get(L);if(Ie.__renderTarget=_,!fe.__hasExternalTextures){let me=Math.max(1,_.width>>ae),he=Math.max(1,_.height>>ae);Z===s.TEXTURE_3D||Z===s.TEXTURE_2D_ARRAY?t.texImage3D(Z,ae,ee,me,he,_.depth,0,ue,j,null):t.texImage2D(Z,ae,ee,me,he,0,ue,j,null)}t.bindFramebuffer(s.FRAMEBUFFER,R),Ft(_)?o.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,k,Z,Ie.__webglTexture,0,Pt(_)):(Z===s.TEXTURE_2D||Z>=s.TEXTURE_CUBE_MAP_POSITIVE_X&&Z<=s.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&s.framebufferTexture2D(s.FRAMEBUFFER,k,Z,Ie.__webglTexture,ae),t.bindFramebuffer(s.FRAMEBUFFER,null)}function $e(R,_,L){if(s.bindRenderbuffer(s.RENDERBUFFER,R),_.depthBuffer){let k=_.depthTexture,Z=k&&k.isDepthTexture?k.type:null,ae=b(_.stencilBuffer,Z),ue=_.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT;Ft(_)?o.renderbufferStorageMultisampleEXT(s.RENDERBUFFER,Pt(_),ae,_.width,_.height):L?s.renderbufferStorageMultisample(s.RENDERBUFFER,Pt(_),ae,_.width,_.height):s.renderbufferStorage(s.RENDERBUFFER,ae,_.width,_.height),s.framebufferRenderbuffer(s.FRAMEBUFFER,ue,s.RENDERBUFFER,R)}else{let k=_.textures;for(let Z=0;Z<k.length;Z++){let ae=k[Z],ue=r.convert(ae.format,ae.colorSpace),j=r.convert(ae.type),ee=y(ae.internalFormat,ue,j,ae.normalized,ae.colorSpace);Ft(_)?o.renderbufferStorageMultisampleEXT(s.RENDERBUFFER,Pt(_),ee,_.width,_.height):L?s.renderbufferStorageMultisample(s.RENDERBUFFER,Pt(_),ee,_.width,_.height):s.renderbufferStorage(s.RENDERBUFFER,ee,_.width,_.height)}}s.bindRenderbuffer(s.RENDERBUFFER,null)}function At(R,_,L){let k=_.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(s.FRAMEBUFFER,R),!(_.depthTexture&&_.depthTexture.isDepthTexture))throw new Error("THREE.WebGLTextures: renderTarget.depthTexture must be an instance of THREE.DepthTexture.");let Z=n.get(_.depthTexture);if(Z.__renderTarget=_,(!Z.__webglTexture||_.depthTexture.image.width!==_.width||_.depthTexture.image.height!==_.height)&&(_.depthTexture.image.width=_.width,_.depthTexture.image.height=_.height,_.depthTexture.needsUpdate=!0),k){if(Z.__webglInit===void 0&&(Z.__webglInit=!0,_.depthTexture.addEventListener("dispose",A)),Z.__webglTexture===void 0){Z.__webglTexture=s.createTexture(),t.bindTexture(s.TEXTURE_CUBE_MAP,Z.__webglTexture),rt(s.TEXTURE_CUBE_MAP,_.depthTexture);let fe=r.convert(_.depthTexture.format),Ie=r.convert(_.depthTexture.type),me;_.depthTexture.format===jn?me=s.DEPTH_COMPONENT24:_.depthTexture.format===Zi&&(me=s.DEPTH24_STENCIL8);for(let he=0;he<6;he++)s.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+he,0,me,_.width,_.height,0,fe,Ie,null)}}else se(_.depthTexture,0);let ae=Z.__webglTexture,ue=Pt(_),j=k?s.TEXTURE_CUBE_MAP_POSITIVE_X+L:s.TEXTURE_2D,ee=_.depthTexture.format===Zi?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT;if(_.depthTexture.format===jn)Ft(_)?o.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,ee,j,ae,0,ue):s.framebufferTexture2D(s.FRAMEBUFFER,ee,j,ae,0);else if(_.depthTexture.format===Zi)Ft(_)?o.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,ee,j,ae,0,ue):s.framebufferTexture2D(s.FRAMEBUFFER,ee,j,ae,0);else throw new Error("THREE.WebGLTextures: Unknown depthTexture format.")}function Ke(R){let _=n.get(R),L=R.isWebGLCubeRenderTarget===!0;if(_.__boundDepthTexture!==R.depthTexture){let k=R.depthTexture;if(_.__depthDisposeCallback&&_.__depthDisposeCallback(),k){let Z=()=>{delete _.__boundDepthTexture,delete _.__depthDisposeCallback,k.removeEventListener("dispose",Z)};k.addEventListener("dispose",Z),_.__depthDisposeCallback=Z}_.__boundDepthTexture=k}if(R.depthTexture&&!_.__autoAllocateDepthBuffer)if(L)for(let k=0;k<6;k++)At(_.__webglFramebuffer[k],R,k);else{let k=R.texture.mipmaps;k&&k.length>0?At(_.__webglFramebuffer[0],R,0):At(_.__webglFramebuffer,R,0)}else if(L){_.__webglDepthbuffer=[];for(let k=0;k<6;k++)if(t.bindFramebuffer(s.FRAMEBUFFER,_.__webglFramebuffer[k]),_.__webglDepthbuffer[k]===void 0)_.__webglDepthbuffer[k]=s.createRenderbuffer(),$e(_.__webglDepthbuffer[k],R,!1);else{let Z=R.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,ae=_.__webglDepthbuffer[k];s.bindRenderbuffer(s.RENDERBUFFER,ae),s.framebufferRenderbuffer(s.FRAMEBUFFER,Z,s.RENDERBUFFER,ae)}}else{let k=R.texture.mipmaps;if(k&&k.length>0?t.bindFramebuffer(s.FRAMEBUFFER,_.__webglFramebuffer[0]):t.bindFramebuffer(s.FRAMEBUFFER,_.__webglFramebuffer),_.__webglDepthbuffer===void 0)_.__webglDepthbuffer=s.createRenderbuffer(),$e(_.__webglDepthbuffer,R,!1);else{let Z=R.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,ae=_.__webglDepthbuffer;s.bindRenderbuffer(s.RENDERBUFFER,ae),s.framebufferRenderbuffer(s.FRAMEBUFFER,Z,s.RENDERBUFFER,ae)}}t.bindFramebuffer(s.FRAMEBUFFER,null)}function ut(R,_,L){let k=n.get(R);_!==void 0&&Me(k.__webglFramebuffer,R,R.texture,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,0),L!==void 0&&Ke(R)}function xt(R){let _=R.texture,L=n.get(R),k=n.get(_);R.addEventListener("dispose",x);let Z=R.textures,ae=R.isWebGLCubeRenderTarget===!0,ue=Z.length>1;if(ue||(k.__webglTexture===void 0&&(k.__webglTexture=s.createTexture()),k.__version=_.version,a.memory.textures++),ae){L.__webglFramebuffer=[];for(let j=0;j<6;j++)if(_.mipmaps&&_.mipmaps.length>0){L.__webglFramebuffer[j]=[];for(let ee=0;ee<_.mipmaps.length;ee++)L.__webglFramebuffer[j][ee]=s.createFramebuffer()}else L.__webglFramebuffer[j]=s.createFramebuffer()}else{if(_.mipmaps&&_.mipmaps.length>0){L.__webglFramebuffer=[];for(let j=0;j<_.mipmaps.length;j++)L.__webglFramebuffer[j]=s.createFramebuffer()}else L.__webglFramebuffer=s.createFramebuffer();if(ue)for(let j=0,ee=Z.length;j<ee;j++){let fe=n.get(Z[j]);fe.__webglTexture===void 0&&(fe.__webglTexture=s.createTexture(),a.memory.textures++)}if(R.samples>0&&Ft(R)===!1){L.__webglMultisampledFramebuffer=s.createFramebuffer(),L.__webglColorRenderbuffer=[],t.bindFramebuffer(s.FRAMEBUFFER,L.__webglMultisampledFramebuffer);for(let j=0;j<Z.length;j++){let ee=Z[j];L.__webglColorRenderbuffer[j]=s.createRenderbuffer(),s.bindRenderbuffer(s.RENDERBUFFER,L.__webglColorRenderbuffer[j]);let fe=r.convert(ee.format,ee.colorSpace),Ie=r.convert(ee.type),me=y(ee.internalFormat,fe,Ie,ee.normalized,ee.colorSpace,R.isXRRenderTarget===!0),he=Pt(R);s.renderbufferStorageMultisample(s.RENDERBUFFER,he,me,R.width,R.height),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+j,s.RENDERBUFFER,L.__webglColorRenderbuffer[j])}s.bindRenderbuffer(s.RENDERBUFFER,null),R.depthBuffer&&(L.__webglDepthRenderbuffer=s.createRenderbuffer(),$e(L.__webglDepthRenderbuffer,R,!0)),t.bindFramebuffer(s.FRAMEBUFFER,null)}}if(ae){t.bindTexture(s.TEXTURE_CUBE_MAP,k.__webglTexture),rt(s.TEXTURE_CUBE_MAP,_);for(let j=0;j<6;j++)if(_.mipmaps&&_.mipmaps.length>0)for(let ee=0;ee<_.mipmaps.length;ee++)Me(L.__webglFramebuffer[j][ee],R,_,s.COLOR_ATTACHMENT0,s.TEXTURE_CUBE_MAP_POSITIVE_X+j,ee);else Me(L.__webglFramebuffer[j],R,_,s.COLOR_ATTACHMENT0,s.TEXTURE_CUBE_MAP_POSITIVE_X+j,0);p(_)&&S(s.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(ue){for(let j=0,ee=Z.length;j<ee;j++){let fe=Z[j],Ie=n.get(fe),me=s.TEXTURE_2D;(R.isWebGL3DRenderTarget||R.isWebGLArrayRenderTarget)&&(me=R.isWebGL3DRenderTarget?s.TEXTURE_3D:s.TEXTURE_2D_ARRAY),t.bindTexture(me,Ie.__webglTexture),rt(me,fe),Me(L.__webglFramebuffer,R,fe,s.COLOR_ATTACHMENT0+j,me,0),p(fe)&&S(me)}t.unbindTexture()}else{let j=s.TEXTURE_2D;if((R.isWebGL3DRenderTarget||R.isWebGLArrayRenderTarget)&&(j=R.isWebGL3DRenderTarget?s.TEXTURE_3D:s.TEXTURE_2D_ARRAY),t.bindTexture(j,k.__webglTexture),rt(j,_),_.mipmaps&&_.mipmaps.length>0)for(let ee=0;ee<_.mipmaps.length;ee++)Me(L.__webglFramebuffer[ee],R,_,s.COLOR_ATTACHMENT0,j,ee);else Me(L.__webglFramebuffer,R,_,s.COLOR_ATTACHMENT0,j,0);p(_)&&S(j),t.unbindTexture()}R.depthBuffer&&Ke(R)}function et(R){let _=R.textures;for(let L=0,k=_.length;L<k;L++){let Z=_[L];if(p(Z)){let ae=w(R),ue=n.get(Z).__webglTexture;t.bindTexture(ae,ue),S(ae),t.unbindTexture()}}}let Rt=[],Ut=[];function qt(R){if(R.samples>0){if(Ft(R)===!1){let _=R.textures,L=R.width,k=R.height,Z=s.COLOR_BUFFER_BIT,ae=R.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,ue=n.get(R),j=_.length>1;if(j)for(let fe=0;fe<_.length;fe++)t.bindFramebuffer(s.FRAMEBUFFER,ue.__webglMultisampledFramebuffer),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+fe,s.RENDERBUFFER,null),t.bindFramebuffer(s.FRAMEBUFFER,ue.__webglFramebuffer),s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0+fe,s.TEXTURE_2D,null,0);t.bindFramebuffer(s.READ_FRAMEBUFFER,ue.__webglMultisampledFramebuffer);let ee=R.texture.mipmaps;ee&&ee.length>0?t.bindFramebuffer(s.DRAW_FRAMEBUFFER,ue.__webglFramebuffer[0]):t.bindFramebuffer(s.DRAW_FRAMEBUFFER,ue.__webglFramebuffer);for(let fe=0;fe<_.length;fe++){if(R.resolveDepthBuffer&&(R.depthBuffer&&(Z|=s.DEPTH_BUFFER_BIT),R.stencilBuffer&&R.resolveStencilBuffer&&(Z|=s.STENCIL_BUFFER_BIT)),j){s.framebufferRenderbuffer(s.READ_FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.RENDERBUFFER,ue.__webglColorRenderbuffer[fe]);let Ie=n.get(_[fe]).__webglTexture;s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,Ie,0)}s.blitFramebuffer(0,0,L,k,0,0,L,k,Z,s.NEAREST),c===!0&&(Rt.length=0,Ut.length=0,Rt.push(s.COLOR_ATTACHMENT0+fe),R.depthBuffer&&R.storeMultisampledDepthBuffer===!1&&(Rt.push(ae),Ut.push(ae),s.invalidateFramebuffer(s.DRAW_FRAMEBUFFER,Ut)),s.invalidateFramebuffer(s.READ_FRAMEBUFFER,Rt))}if(t.bindFramebuffer(s.READ_FRAMEBUFFER,null),t.bindFramebuffer(s.DRAW_FRAMEBUFFER,null),j)for(let fe=0;fe<_.length;fe++){t.bindFramebuffer(s.FRAMEBUFFER,ue.__webglMultisampledFramebuffer),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+fe,s.RENDERBUFFER,ue.__webglColorRenderbuffer[fe]);let Ie=n.get(_[fe]).__webglTexture;t.bindFramebuffer(s.FRAMEBUFFER,ue.__webglFramebuffer),s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0+fe,s.TEXTURE_2D,Ie,0)}t.bindFramebuffer(s.DRAW_FRAMEBUFFER,ue.__webglMultisampledFramebuffer)}else if(R.depthBuffer&&R.storeMultisampledDepthBuffer===!1&&c){let _=R.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT;s.invalidateFramebuffer(s.DRAW_FRAMEBUFFER,[_])}}}function Pt(R){return Math.min(i.maxSamples,R.samples)}function Ft(R){let _=n.get(R);return R.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&_.__useRenderToTexture!==!1}function F(R){let _=a.render.frame;h.get(R)!==_&&(h.set(R,_),R.update())}function Jt(R,_){let L=R.colorSpace,k=R.format,Z=R.type;return R.isCompressedTexture===!0||R.isVideoTexture===!0||L!==cn&&L!==Ai&&(it.getTransfer(L)===yt?(k!==wn||Z!==vn)&&Ue("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):We("WebGLTextures: Unsupported texture color space:",L)),_}function mt(R){return typeof HTMLImageElement<"u"&&R instanceof HTMLImageElement?(l.width=R.naturalWidth||R.width,l.height=R.naturalHeight||R.height):typeof VideoFrame<"u"&&R instanceof VideoFrame?(l.width=R.displayWidth,l.height=R.displayHeight):(l.width=R.width,l.height=R.height),l}this.allocateTextureUnit=$,this.resetTextureUnits=G,this.getTextureUnits=D,this.setTextureUnits=X,this.setTexture2D=se,this.setTexture2DArray=W,this.setTexture3D=ne,this.setTextureCube=ie,this.rebindTextures=ut,this.setupRenderTarget=xt,this.updateRenderTargetMipmap=et,this.updateMultisampleRenderTarget=qt,this.setupDepthRenderbuffer=Ke,this.setupFrameBufferTexture=Me,this.useMultisampledRTT=Ft,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function Px(s,e){function t(n,i=Ai){let r,a=it.getTransfer(i);if(n===vn)return s.UNSIGNED_BYTE;if(n===Ko)return s.UNSIGNED_SHORT_4_4_4_4;if(n===Jo)return s.UNSIGNED_SHORT_5_5_5_1;if(n===Kl)return s.UNSIGNED_INT_5_9_9_9_REV;if(n===Jl)return s.UNSIGNED_INT_10F_11F_11F_REV;if(n===Yl)return s.BYTE;if(n===Zl)return s.SHORT;if(n===gr)return s.UNSIGNED_SHORT;if(n===Zo)return s.INT;if(n===qn)return s.UNSIGNED_INT;if(n===En)return s.FLOAT;if(n===Yn)return s.HALF_FLOAT;if(n===$l)return s.ALPHA;if(n===jl)return s.RGB;if(n===wn)return s.RGBA;if(n===jn)return s.DEPTH_COMPONENT;if(n===Zi)return s.DEPTH_STENCIL;if(n===$o)return s.RED;if(n===jo)return s.RED_INTEGER;if(n===Ki)return s.RG;if(n===Qo)return s.RG_INTEGER;if(n===ec)return s.RGBA_INTEGER;if(n===va||n===Ma||n===Sa||n===ba)if(a===yt)if(r=e.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===va)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===Ma)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===Sa)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===ba)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=e.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===va)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===Ma)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===Sa)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===ba)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===tc||n===nc||n===ic||n===sc)if(r=e.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===tc)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===nc)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===ic)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===sc)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===rc||n===ac||n===oc||n===cc||n===lc||n===Ta||n===hc)if(r=e.get("WEBGL_compressed_texture_etc"),r!==null){if(n===rc||n===ac)return a===yt?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===oc)return a===yt?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC;if(n===cc)return r.COMPRESSED_R11_EAC;if(n===lc)return r.COMPRESSED_SIGNED_R11_EAC;if(n===Ta)return r.COMPRESSED_RG11_EAC;if(n===hc)return r.COMPRESSED_SIGNED_RG11_EAC}else return null;if(n===uc||n===dc||n===fc||n===pc||n===mc||n===gc||n===_c||n===xc||n===yc||n===vc||n===Mc||n===Sc||n===bc||n===Tc)if(r=e.get("WEBGL_compressed_texture_astc"),r!==null){if(n===uc)return a===yt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===dc)return a===yt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===fc)return a===yt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===pc)return a===yt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===mc)return a===yt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===gc)return a===yt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===_c)return a===yt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===xc)return a===yt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===yc)return a===yt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===vc)return a===yt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===Mc)return a===yt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===Sc)return a===yt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===bc)return a===yt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Tc)return a===yt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Ec||n===wc||n===Ac)if(r=e.get("EXT_texture_compression_bptc"),r!==null){if(n===Ec)return a===yt?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===wc)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Ac)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Rc||n===Cc||n===Ea||n===Ic)if(r=e.get("EXT_texture_compression_rgtc"),r!==null){if(n===Rc)return r.COMPRESSED_RED_RGTC1_EXT;if(n===Cc)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Ea)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===Ic)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===_r?s.UNSIGNED_INT_24_8:s[n]!==void 0?s[n]:null}return{convert:t}}var Lx=`
void main() {
...
}`,wh=class{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){let n=new ra(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=n}}getMesh(e){if(this.texture!==null&&this.mesh===null){let t=e.cameras[0].viewport,n=new Tn({vertexShader:Lx,fragmentShader:Nx,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new Ge(new Gi(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}},Ah=class extends kn{constructor(e,t){super();let n=this,i=null,r=1,a=null,o="local-floor",c=1,l=null,h=null,u=null,d=null,f=null,g=null,v=typeof XRWebGLBinding<"u",m=new wh,p={},S=t.getContextAttributes(),w=null,y=null,b=[],T=[],A=new ve,x=null,E=null,I=new Wt;I.viewport=new St;let U=new Wt;U.viewport=new St;let B=[I,U],G=new ko,D=null,X=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(J){let te=b[J];return te===void 0&&(te=new tr,b[J]=te),te.getTargetRaySpace()},this.getControllerGrip=function(J){let te=b[J];return te===void 0&&(te=new tr,b[J]=te),te.getGripSpace()},this.getHand=function(J){let te=b[J];return te===void 0&&(te=new tr,b[J]=te),te.getHandSpace()};function $(J){let te=T.indexOf(J.inputSource);if(te===-1)return;let Te=b[te];Te!==void 0&&(Te.update(J.inputSource,J.frame,l||a),Te.dispatchEvent({type:J.type,data:J.inputSource}))}function K(){i.removeEventListener("select",$),i.removeEventListener("selectstart",$),i.removeEventListener("selectend",$),i.removeEventListener("squeeze",$),i.removeEventListener("squeezestart",$),i.removeEventListener("squeezeend",$),i.removeEventListener("end",K),i.removeEventListener("inputsourceschange",se);for(let J=0;J<b.length;J++){let te=T[J];te!==null&&(T[J]=null,b[J].disconnect(te))}D=null,X=null,m.reset();for(let J in p)delete p[J];if(e.setRenderTarget(w),f=null,d=null,u=null,i=null,y=null,ot.stop(),n.isPresenting=!1,e.setPixelRatio(x),e.setSize(A.width,A.height,!1),E!==null){let J=E.camera;J.fov=E.fov,J.zoom=E.zoom,J.updateProjectionMatrix(),E=null}n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(J){r=J,n.isPresenting===!0&&Ue("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(J){o=J,n.isPresenting===!0&&Ue("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return l||a},this.setReferenceSpace=function(J){l=J},this.getBaseLayer=function(){return d!==null?d:f},this.getBinding=function(){return u===null&&v&&(u=new XRWebGLBinding(i,t)),u},this.getFrame=function(){return g},this.getSession=function(){return i},this.setSession=async function(J){if(i=J,i!==null){if(w=e.getRenderTarget(),i.addEventListener("select",$),i.addEventListener("selectstart",$),i.addEventListener("selectend",$),i.addEventListener("squeeze",$),i.addEventListener("squeezestart",$),i.addEventListener("squeezeend",$),i.addEventListener("end",K),i.addEventListener("inputsourceschange",se),S.xrCompatible!==!0&&await t.makeXRCompatible(),x=e.getPixelRatio(),e.getSize(A),v&&"createProjectionLayer"in XRWebGLBinding.prototype){let Te=null,Be=null,Me=null;S.depth&&(Me=S.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,Te=S.stencil?Zi:jn,Be=S.stencil?_r:qn);let $e={colorFormat:t.RGBA8,depthFormat:Me,scaleFactor:r};u=this.getBinding(),d=u.createProjectionLayer($e),i.updateRenderState({layers:[d]}),e.setPixelRatio(1),e.setSize(d.textureWidth,d.textureHeight,!1),y=new gn(d.textureWidth,d.textureHeight,{format:wn,type:vn,depthTexture:new Vi(d.textureWidth,d.textureHeight,Be,void 0,void 0,void 0,void 0,void 0,void 0,Te),stencilBuffer:S.stencil,colorSpace:e.outputColorSpace,samples:S.antialias?4:0,resolveDepthBuffer:d.ignoreDepthValues===!1,resolveStencilBuffer:d.ignoreDepthValues===!1,storeMultisampledDepthBuffer:d.ignoreDepthValues===!1,storeMultisampledStencilBuffer:d.ignoreDepthValues===!1})}else{let Te={antialias:S.antialias,alpha:!0,depth:S.depth,stencil:S.stencil,framebufferScaleFactor:r};f=new XRWebGLLayer(i,t,Te),i.updateRenderState({baseLayer:f}),e.setPixelRatio(1),e.setSize(f.framebufferWidth,f.framebufferHeight,!1),y=new gn(f.framebufferWidth,f.framebufferHeight,{format:wn,type:vn,colorSpace:e.outputColorSpace,stencilBuffer:S.stencil,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1,storeMultisampledDepthBuffer:f.ignoreDepthValues===!1,storeMultisampledStencilBuffer:f.ignoreDepthValues===!1})}y.isXRRenderTarget=!0,this.setFoveation(c),l=null,a=await i.requestReferenceSpace(o),ot.setContext(i),ot.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(i!==null)return i.environmentBlendMode},this.getDepthTexture=function(){return m.getDepthTexture()};function se(J){for(let te=0;te<J.removed.length;te++){let Te=J.removed[te],Be=T.indexOf(Te);Be>=0&&(T[Be]=null,b[Be].disconnect(Te))}for(let te=0;te<J.added.length;te++){let Te=J.added[te],Be=T.indexOf(Te);if(Be===-1){for(let $e=0;$e<b.length;$e++)if($e>=T.length){T.push(Te),Be=$e;break}else if(T[$e]===null){T[$e]=Te,Be=$e;break}if(Be===-1)break}let Me=b[Be];Me&&Me.connect(Te)}}let W=new C,ne=new C;function ie(J,te,Te){W.setFromMatrixPosition(te.matrixWorld),ne.setFromMatrixPosition(Te.matrixWorld);let Be=W.distanceTo(ne),Me=te.projectionMatrix.elements,$e=Te.projectionMatrix.elements,At=Me[14]/(Me[10]-1),Ke=Me[14]/(Me[10]+1),ut=(Me[9]+1)/Me[5],xt=(Me[9]-1)/Me[5],et=(Me[8]-1)/Me[0],Rt=($e[8]+1)/$e[0],Ut=At*et,qt=At*Rt,Pt=Be/(-et+Rt),Ft=Pt*-et;if(te.matrixWorld.decompose(J.position,J.quaternion,J.scale),J.translateX(Ft),J.translateZ(Pt),J.matrixWorld.compose(J.position,J.quaternion,J.scale),J.matrixWorldInverse.copy(J.matrixWorld).invert(),Me[10]===-1)J.projectionMatrix.copy(te.projectionMatrix),J.projectionMatrixInverse.copy(te.projectionMatrixInverse);else{let F=At+Pt,Jt=Ke+Pt,mt=Ut-Ft,R=qt+(Be-Ft),_=ut*Ke/Jt*F,L=xt*Ke/Jt*F;J.projectionMatrix.makePerspective(mt,R,_,L,F,Jt),J.projectionMatrixInverse.copy(J.projectionMatrix).invert()}}function Oe(J,te){te===null?J.matrixWorld.copy(J.matrix):J.matrixWorld.multiplyMatrices(te.matrixWorld,J.matrix),J.matrixWorldInverse.copy(J.matrixWorld).invert()}this.updateCamera=function(J){if(i===null)return;let te=J.near,Te=J.far;m.texture!==null&&(m.depthNear>0&&(te=m.depthNear),m.depthFar>0&&(Te=m.depthFar)),G.near=U.near=I.near=te,G.far=U.far=I.far=Te,(D!==G.near||X!==G.far)&&(i.updateRenderState({depthNear:G.near,depthFar:G.far}),D=G.near,X=G.far),G.layers.mask=J.layers.mask|6,I.layers.mask=G.layers.mask&-5,U.layers.mask=G.layers.mask&-3;let Be=J.parent,Me=G.cameras;Oe(G,Be);for(let $e=0;$e<Me.length;$e++)Oe(Me[$e],Be);Me.length===2?ie(G,I,U):G.projectionMatrix.copy(I.projectionMatrix),E===null&&J.isPerspectiveCamera&&(E={camera:J,fov:J.fov,zoom:J.zoom}),Le(J,G,Be)};function Le(J,te,Te){Te===null?J.matrix.copy(te.matrixWorld):(J.matrix.copy(Te.matrixWorld),J.matrix.invert(),J.matrix.multiply(te.matrixWorld)),J.matrix.decompose(J.position,J.quaternion,J.scale),J.updateMatrixWorld(!0),J.projectionMatrix.copy(te.projectionMatrix),J.projectionMatrixInverse.copy(te.projectionMatrixInverse),J.isPerspectiveCamera&&(J.fov=ls*2*Math.atan(1/J.projectionMatrix.elements[5]),J.zoom=1)}this.getCamera=function(){return G},this.getFoveation=function(){if(!(d===null&&f===null))return c},this.setFoveation=function(J){c=J,d!==null&&(d.fixedFoveation=J),f!==null&&f.fixedFoveation!==void 0&&(f.fixedFoveation=J)},this.hasDepthSensing=function(){return m.texture!==null},this.getDepthSensingMesh=function(){return m.getMesh(G)},this.getCameraTexture=function(J){return p[J]};let vt=null;function rt(J,te){if(h=te.getViewerPose(l||a),g=te,h!==null){let Te=h.views;f!==null&&(e.setRenderTargetFramebuffer(y,f.framebuffer),e.setRenderTarget(y));let Be=!1;Te.length!==G.cameras.length&&(G.cameras.length=0,Be=!0);for(let Ke=0;Ke<Te.length;Ke++){let ut=Te[Ke],xt=null;if(f!==null)xt=f.getViewport(ut);else{let Rt=u.getViewSubImage(d,ut);xt=Rt.viewport,Ke===0&&(e.setRenderTargetTextures(y,Rt.colorTexture,Rt.depthStencilTexture),e.setRenderTarget(y))}let et=B[Ke];et===void 0&&(et=new Wt,et.layers.enable(Ke),et.viewport=new St,B[Ke]=et),et.matrix.fromArray(ut.transform.matrix),et.matrix.decompose(et.position,et.quaternion,et.scale),et.projectionMatrix.fromArray(ut.projectionMatrix),et.projectionMatrixInverse.copy(et.projectionMatrix).invert(),et.viewport.set(xt.x,xt.y,xt.width,xt.height),Ke===0&&(G.matrix.copy(et.matrix),G.matrix.decompose(G.position,G.quaternion,G.scale)),Be===!0&&G.cameras.push(et)}let Me=i.enabledFeatures;if(Me&&Me.includes("depth-sensing")&&i.depthUsage=="gpu-optimized"&&v){u=n.getBinding();let Ke=u.getDepthInformation(Te[0]);Ke&&Ke.isValid&&Ke.texture&&m.init(Ke,i.renderState)}if(Me&&Me.includes("camera-access")&&v){e.state.unbindTexture(),u=n.getBinding();for(let Ke=0;Ke<Te.length;Ke++){let ut=Te[Ke].camera;if(ut){let xt=p[ut];xt||(xt=new ra,p[ut]=xt);let et=u.getCameraImage(ut);xt.sourceTexture=et}}}}for(let Te=0;Te<b.length;Te++){let Be=T[Te],Me=b[Te];Be!==null&&Me!==void 0&&Me.update(Be,te,l||a)}vt&&vt(J,te),te.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:te}),g=null}let ot=new rf;ot.setAnimationLoop(rt),this.setAnimationLoop=function(J){vt=J},this.dispose=function(){}}},Dx=new Ze,uf=new Ye;uf.set(-1,0,0,0,1,0,0,0,1);function Ux(s,e){function t(m,p){m.matrixAutoUpdate===!0&&m.updateMatrix(),p.value.copy(m.matrix)}function n(m,p){p.color.getRGB(m.fogColor.value,sh(s)),p.isFog?(m.fogNear.value=p.near,m.fogFar.value=p.far):p.isFogExp2&&(m.fogDensity.value=p.density)}function i(m,p,S,w,y){p.isNodeMaterial?p.uniformsNeedUpdate=!1:p.isMeshBasicMaterial?r(m,p):p.isMeshLambertMaterial?(r(m,p),p.envMap&&(m.envMapIntensity.value=p.envMapIntensity)):p.isMeshToonMaterial?(r(m,p),u(m,p)):p.isMeshPhongMaterial?(r(m,p),h(m,p),p.envMap&&(m.envMapIntensity.value=p.envMapIntensity)):p.isMeshStandardMaterial?(r(m,p),d(m,p),p.isMeshPhysicalMaterial&&f(m,p,y)):p.isMeshMatcapMaterial?(r(m,p),g(m,p)):p.isMeshDepthMaterial?r(m,p):p.isMeshDistanceMaterial?(r(m,p),v(m,p)):p.isMeshNormalMaterial?r(m,p):p.isLineBasicMaterial?(a(m,p),p.isLineDashedMaterial&&o(m,p)):p.isPointsMaterial?c(m,p,S,w):p.isSpriteMaterial?l(m,p):p.isShadowMaterial?(m.color.value.copy(p.color),m.opacity.value=p.opacity):p.isShaderMaterial&&(p.uniformsNeedUpdate=!1)}function r(m,p){m.opacity.value=p.opacity,p.color&&m.diffuse.value.copy(p.color),p.emissive&&m.emissive.value.copy(p.emissive).multiplyScalar(p.emissiveIntensity),p.map&&(m.map.value=p.map,t(p.map,m.mapTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,t(p.alphaMap,m.alphaMapTransform)),p.bumpMap&&(m.bumpMap.value=p.bumpMap,t(p.bumpMap,m.bumpMapTransform),m.bumpScale.value=p.bumpScale,p.side===un&&(m.bumpScale.value*=-1)),p.normalMap&&(m.normalMap.value=p.normalMap,t(p.normalMap,m.normalMapTransform),m.normalScale.value.copy(p.normalScale),p.side===un&&m.normalScale.value.negate()),p.displacementMap&&(m.displacementMap.value=p.displacementMap,t(p.displacementMap,m.displacementMapTransform),m.displacementScale.value=p.displacementScale,m.displacementBias.value=p.displacementBias),p.emissiveMap&&(m.emissiveMap.value=p.emissiveMap,t(p.emissiveMap,m.emissiveMapTransform)),p.specularMap&&(m.specularMap.value=p.specularMap,t(p.specularMap,m.specularMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest);let S=e.get(p),w=S.envMap,y=S.envMapRotation;w&&(m.envMap.value=w,m.envMapRotation.value.setFromMatrix4(Dx.makeRotationFromEuler(y)).transpose(),w.isCubeTexture&&w.isRenderTargetTexture===!1&&m.envMapRotation.value.premultiply(uf),m.reflectivity.value=p.reflectivity,m.ior.value=p.ior,m.refractionRatio.value=p.refractionRatio),p.lightMap&&(m.lightMap.value=p.lightMap,m.lightMapIntensity.value=p.lightMapIntensity,t(p.lightMap,m.lightMapTransform)),p.aoMap&&(m.aoMap.value=p.aoMap,m.aoMapIntensity.value=p.aoMapIntensity,t(p.aoMap,m.aoMapTransform))}function a(m,p){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,p.map&&(m.map.value=p.map,t(p.map,m.mapTransform))}function o(m,p){m.dashSize.value=p.dashSize,m.totalSize.value=p.dashSize+p.gapSize,m.scale.value=p.scale}function c(m,p,S,w){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,m.size.value=p.size*S,m.scale.value=w*.5,p.map&&(m.map.value=p.map,t(p.map,m.uvTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,t(p.alphaMap,m.alphaMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest)}function l(m,p){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,m.rotation.value=p.rotation,p.map&&(m.map.value=p.map,t(p.map,m.mapTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,t(p.alphaMap,m.alphaMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest)}function h(m,p){m.specular.value.copy(p.specular),m.shininess.value=Math.max(p.shininess,1e-4)}function u(m,p){p.gradientMap&&(m.gradientMap.value=p.gradientMap)}function d(m,p){m.metalness.value=p.metalness,p.metalnessMap&&(m.metalnessMap.value=p.metalnessMap,t(p.metalnessMap,m.metalnessMapTransform)),m.roughness.value=p.roughness,p.roughnessMap&&(m.roughnessMap.value=p.roughnessMap,t(p.roughnessMap,m.roughnessMapTransform)),p.envMap&&(m.envMapIntensity.value=p.envMapIntensity)}function f(m,p,S){m.ior.value=p.ior,p.sheen>0&&(m.sheenColor.value.copy(p.sheenColor).multiplyScalar(p.sheen),m.sheenRoughness.value=p.sheenRoughness,p.sheenColorMap&&(m.sheenColorMap.value=p.sheenColorMap,t(p.sheenColorMap,m.sheenColorMapTransform)),p.sheenRoughnessMap&&(m.sheenRoughnessMap.value=p.sheenRoughnessMap,t(p.sheenRoughnessMap,m.sheenRoughnessMapTransform))),p.clearcoat>0&&(m.clearcoat.value=p.clearcoat,m.clearcoatRoughness.value=p.clearcoatRoughness,p.clearcoatMap&&(m.clearcoatMap.value=p.clearcoatMap,t(p.clearcoatMap,m.clearcoatMapTransform)),p.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=p.clearcoatRoughnessMap,t(p.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),p.clearcoatNormalMap&&(m.clearcoatNormalMap.value=p.clearcoatNormalMap,t(p.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(p.clearcoatNormalScale),p.side===un&&m.clearcoatNormalScale.value.negate())),p.dispersion>0&&(m.dispersion.value=p.dispersion),p.retroreflectivity>0&&(m.retroreflectivity.value=p.retroreflectivity),p.iridescence>0&&(m.iridescence.value=p.iridescence,m.iridescenceIOR.value=p.iridescenceIOR,m.iridescenceThicknessMinimum.value=p.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=p.iridescenceThicknessRange[1],p.iridescenceMap&&(m.iridescenceMap.value=p.iridescenceMap,t(p.iridescenceMap,m.iridescenceMapTransform)),p.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=p.iridescenceThicknessMap,t(p.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),p.transmission>0&&(m.transmission.value=p.transmission,m.transmissionSamplerMap.value=S.texture,m.transmissionSamplerSize.value.set(S.width,S.height),p.transmissionMap&&(m.transmissionMap.value=p.transmissionMap,t(p.transmissionMap,m.transmissionMapTransform)),m.thickness.value=p.thickness,p.thicknessMap&&(m.thicknessMap.value=p.thicknessMap,t(p.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=p.attenuationDistance,m.attenuationColor.value.copy(p.attenuationColor)),p.anisotropy>0&&(m.anisotropyVector.value.set(p.anisotropy*Math.cos(p.anisotropyRotation),p.anisotropy*Math.sin(p.anisotropyRotation)),p.anisotropyMap&&(m.anisotropyMap.value=p.anisotropyMap,t(p.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=p.specularIntensity,m.specularColor.value.copy(p.specularColor),p.specularColorMap&&(m.specularColorMap.value=p.specularColorMap,t(p.specularColorMap,m.specularColorMapTransform)),p.specularIntensityMap&&(m.specularIntensityMap.value=p.specularIntensityMap,t(p.specularIntensityMap,m.specularIntensityMapTransform))}function g(m,p){p.matcap&&(m.matcap.value=p.matcap)}function v(m,p){let S=e.get(p).light;m.referencePosition.value.setFromMatrixPosition(S.matrixWorld),m.nearDistance.value=S.shadow.camera.near,m.farDistance.value=S.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:i}}function Fx(s,e,t,n){let i={},r={},a=[],o=s.getParameter(s.MAX_UNIFORM_BUFFER_BINDINGS);function c(y,b){let T=b.program;n.uniformBlockBinding(y,T)}function l(y,b){let T=i[y.id];T===void 0&&(m(y),T=h(y),i[y.id]=T,y.addEventListener("dispose",S));let A=b.program;n.updateUBOMapping(y,A);let x=e.render.frame;r[y.id]!==x&&(d(y),r[y.id]=x)}function h(y){let b=u();y.__bindingPointIndex=b;let T=s.createBuffer(),A=y.__size,x=y.usage;return s.bindBuffer(s.UNIFORM_BUFFER,T),s.bufferData(s.UNIFORM_BUFFER,A,x),s.bindBuffer(s.UNIFORM_BUFFER,null),s.bindBufferBase(s.UNIFORM_BUFFER,b,T),T}function u(){for(let y=0;y<o;y++)if(a.indexOf(y)===-1)return a.push(y),y;return We("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function d(y){let b=i[y.id],T=y.uniforms,A=y.__cache;s.bindBuffer(s.UNIFORM_BUFFER,b);for(let x=0,E=T.length;x<E;x++){let I=T[x];if(Array.isArray(I))for(let U=0,B=I.length;U<B;U++)f(I[U],x,U,A);else f(I,x,0,A)}s.bindBuffer(s.UNIFORM_BUFFER,null)}function f(y,b,T,A){if(v(y,b,T,A)===!0){let x=y.__offset,E=y.value;if(Array.isArray(E)){let I=0;for(let U=0;U<E.length;U++){let B=E[U],G=p(B);g(B,y.__data,I),typeof B!="number"&&typeof B!="boolean"&&!B.isMatrix3&&!ArrayBuffer.isView(B)&&(I+=G.storage/Float32Array.BYTES_PER_ELEMENT)}}else g(E,y.__data,0);s.bufferSubData(s.UNIFORM_BUFFER,x,y.__data)}}function g(y,b,T){typeof y=="number"||typeof y=="boolean"?b[0]=y:y.isMatrix3?(b[0]=y.elements[0],b[1]=y.elements[1],b[2]=y.elements[2],b[3]=0,b[4]=y.elements[3],b[5]=y.elements[4],b[6]=y.elements[5],b[7]=0,b[8]=y.elements[6],b[9]=y.elements[7],b[10]=y.elements[8],b[11]=0):ArrayBuffer.isView(y)?b.set(new y.constructor(y.buffer,y.byteOffset,b.length)):y.toArray(b,T)}function v(y,b,T,A){let x=y.value,E=b+"_"+T;if(A[E]===void 0)return typeof x=="number"||typeof x=="boolean"?A[E]=x:ArrayBuffer.isView(x)?A[E]=x.slice():A[E]=x.clone(),!0;{let I=A[E];if(typeof x=="number"||typeof x=="boolean"){if(I!==x)return A[E]=x,!0}else{if(ArrayBuffer.isView(x))return!0;if(I.equals(x)===!1)return I.copy(x),!0}}return!1}function m(y){let b=y.uniforms,T=0,A=16;for(let E=0,I=b.length;E<I;E++){let U=Array.isArray(b[E])?b[E]:[b[E]];for(let B=0,G=U.length;B<G;B++){let D=U[B],X=Array.isArray(D.value)?D.value:[D.value];for(let $=0,K=X.length;$<K;$++){let se=X[$],W=p(se),ne=T%A,ie=ne%W.boundary,Oe=ne+ie;T+=ie,Oe!==0&&A-Oe<W.storage&&(T+=A-Oe),D.__data=new Float32Array(W.storage/Float32Array.BYTES_PER_ELEMENT),D.__offset=T,T+=W.storage}}}let x=T%A;return x>0&&(T+=A-x),y.__size=T,y.__cache={},this}function p(y){let b={boundary:0,storage:0};return typeof y=="number"||typeof y=="boolean"?(b.boundary=4,b.storage=4):y.isVector2?(b.boundary=8,b.storage=8):y.isVector3||y.isColor?(b.boundary=16,b.storage=12):y.isVector4?(b.boundary=16,b.storage=16):y.isMatrix3?(b.boundary=48,b.storage=48):y.isMatrix4?(b.boundary=64,b.storage=64):y.isTexture?Ue("WebGLRenderer: Texture samplers can not be part of an uniforms group."):ArrayBuffer.isView(y)?(b.boundary=16,b.storage=y.byteLength):Ue("WebGLRenderer: Unsupported uniform value type.",y),b}function S(y){let b=y.target;b.removeEventListener("dispose",S);let T=a.indexOf(b.__bindingPointIndex);a.splice(T,1),s.deleteBuffer(i[b.id]),delete i[b.id],delete r[b.id]}function w(){for(let y in i)s.deleteBuffer(i[y]);a=[],i={},r={}}return{bind:c,update:l,dispose:w}}var Ox=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]),si=null;function Bx(){return si===null&&(si=new sr(Ox,16,16,Ki,Yn),si.name="DFG_LUT",si.minFilter=Ht,si.magFilter=Ht,si.wrapS=Cn,si.wrapT=Cn,si.generateMipmaps=!1,si.needsUpdate=!0),si}var zc=class{constructor(e={}){let{canvas:t=Rd(),context:n=null,depth:i=!0,stencil:r=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:c=!0,preserveDrawingBuffer:l=!1,powerPreference:h="default",failIfMajorPerformanceCaveat:u=!1,reversedDepthBuffer:d=!1,outputBufferType:f=vn}=e;this.isWebGLRenderer=!0;let g;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");g=n.getContextAttributes().alpha}else g=a;let v=f,m=new Set([ec,Qo,jo]),p=new Set([vn,qn,gr,_r,Ko,Jo]),S=new Uint32Array(4),w=new Int32Array(4),y=new C,b=null,T=null,A=[],x=[],E=null;this.domElement=t,this.debug={checkShaderErrors:!0,diagnostics:{keywords:!1},onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=Wn,this.toneMappingExposure=1,this.transmissionResolutionScale=1;let I=this,U=!1,B=null,G=null,D=null,X=null;this._outputColorSpace=Ot;let $=0,K=0,se=null,W=-1,ne=null,ie=new St,Oe=new St,Le=null,vt=new ze(0),rt=0,ot=t.width,J=t.height,te=1,Te=null,Be=null,Me=new St(0,0,ot,J),$e=new St(0,0,ot,J),At=!1,Ke=new rr,ut=!1,xt=!1,et=new Ze,Rt=new C,Ut=new St,qt={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},Pt=!1;function Ft(){return se===null?te:1}let F=n;function Jt(M,N){return t.getContext(M,N)}let mt,R,_,L,k,Z,ae,ue,j,ee,fe,Ie,me,he,Ne,Fe,Xe,P,pe,Q,de,ye,re;try{let M={alpha:!0,depth:i,stencil:r,antialias:o,premultipliedAlpha:c,preserveDrawingBuffer:l,powerPreference:h,failIfMajorPerformanceCaveat:u};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${"186"}`),t.addEventListener("webglcontextlost",gt,!1),t.addEventListener("webglcontextrestored",ct,!1),t.addEventListener("webglcontextcreationerror",fn,!1),F===null){let N="webgl2";if(F=Jt(N,M),F===null)throw Jt(N)?new Error("THREE.WebGLRenderer: Error creating WebGL context with your selected attributes."):new Error("THREE.WebGLRenderer: Error creating WebGL context.")}Pe()}catch(M){throw t.removeEventListener("webglcontextlost",gt,!1),t.removeEventListener("webglcontextrestored",ct,!1),t.removeEventListener("webglcontextcreationerror",fn,!1),We("WebGLRenderer: "+M.message),M}function Pe(){mt=new X0(F),mt.init(),de=new Px(F,mt),R=new U0(F,mt,e,de),_=new Cx(F,mt),R.reversedDepthBuffer&&d&&_.buffers.depth.setReversed(!0),G=F.createFramebuffer(),D=F.createFramebuffer(),X=F.createFramebuffer(),L=new Z0(F),k=new mx,Z=new Ix(F,mt,_,k,R,de,L),ae=new W0(I),ue=new Jp(F),ye=new N0(F,ue),j=new q0(F,ue,L,ye),ee=new J0(F,j,ue,ye,L),P=new K0(F,R,Z),Ne=new F0(k),fe=new px(I,ae,mt,R,ye,Ne),Ie=new Ux(I,k),me=new _x,he=new bx(mt),Xe=new L0(I,ae,_,ee,g,c),Fe=new Rx(I,ee,R),re=new Fx(F,L,R,_),pe=new D0(F,mt,L),Q=new Y0(F,mt,L),L.programs=fe.programs,I.capabilities=R,I.extensions=mt,I.properties=k,I.renderLists=me,I.shadowMap=Fe,I.state=_,I.info=L}v!==vn&&(E=new j0(v,t.width,t.height,o,i,r));let Se=new Ah(I,F);this.xr=Se,this.getContext=function(){return F},this.getContextAttributes=function(){return F.getContextAttributes()},this.forceContextLoss=function(){let M=mt.get("WEBGL_lose_context");M&&M.loseContext()},this.forceContextRestore=function(){let M=mt.get("WEBGL_lose_context");M&&M.restoreContext()},this.getPixelRatio=function(){return te},this.setPixelRatio=function(M){M!==void 0&&(te=M,this.setSize(ot,J,!1))},this.getSize=function(M){return M.set(ot,J)},this.setSize=function(M,N,Y=!0){if(Se.isPresenting){Ue("WebGLRenderer: Can't change size while VR device is presenting.");return}ot=M,J=N,t.width=Math.floor(M*te),t.height=Math.floor(N*te),Y===!0&&(t.style.width=M+"px",t.style.height=N+"px"),E!==null&&E.setSize(t.width,t.height),this.setViewport(0,0,M,N)},this.getDrawingBufferSize=function(M){return M.set(ot*te,J*te).floor()},this.setDrawingBufferSize=function(M,N,Y){ot=M,J=N,te=Y,t.width=Math.floor(M*Y),t.height=Math.floor(N*Y),this.setViewport(0,0,M,N)},this.setEffects=function(M){if(v===vn){We("WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(M){for(let N=0;N<M.length;N++)if(M[N].isOutputPass===!0){Ue("WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}E.setEffects(M||[])},this.getCurrentViewport=function(M){return M.copy(ie)},this.getViewport=function(M){return M.copy(Me)},this.setViewport=function(M,N,Y,H){M.isVector4?Me.set(M.x,M.y,M.z,M.w):Me.set(M,N,Y,H),_.viewport(ie.copy(Me).multiplyScalar(te).round())},this.getScissor=function(M){return M.copy($e)},this.setScissor=function(M,N,Y,H){M.isVector4?$e.set(M.x,M.y,M.z,M.w):$e.set(M,N,Y,H),_.scissor(Oe.copy($e).multiplyScalar(te).round())},this.getScissorTest=function(){return At},this.setScissorTest=function(M){_.setScissorTest(At=M)},this.setOpaqueSort=function(M){Te=M},this.setTransparentSort=function(M){Be=M},this.getClearColor=function(M){return M.copy(Xe.getClearColor())},this.setClearColor=function(){Xe.setClearColor(...arguments)},this.getClearAlpha=function(){return Xe.getClearAlpha()},this.setClearAlpha=function(){Xe.setClearAlpha(...arguments)},this.clear=function(M=!0,N=!0,Y=!0){let H=0;if(M){let z=!1;if(se!==null){let ge=se.texture.format;z=m.has(ge)}if(z){let ge=se.texture.type,be=p.has(ge),_e=Xe.getClearColor(),Ae=Xe.getClearAlpha(),Ce=_e.r,Je=_e.g,je=_e.b;be?(S[0]=Ce,S[1]=Je,S[2]=je,S[3]=Ae,F.clearBufferuiv(F.COLOR,0,S)):(w[0]=Ce,w[1]=Je,w[2]=je,w[3]=Ae,F.clearBufferiv(F.COLOR,0,w))}else H|=F.COLOR_BUFFER_BIT}N&&(H|=F.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),Y&&(H|=F.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),H!==0&&F.clear(H)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(M){M.setRenderer(this),B=M},this.dispose=function(){t.removeEventListener("webglcontextlost",gt,!1),t.removeEventListener("webglcontextrestored",ct,!1),t.removeEventListener("webglcontextcreationerror",fn,!1),Xe.dispose(),me.dispose(),he.dispose(),k.dispose(),ae.dispose(),ee.dispose(),ye.dispose(),re.dispose(),fe.dispose(),Se.dispose(),Se.removeEventListener("sessionstart",ws),Se.removeEventListener("sessionend",Pa),An.stop()};function gt(M){M.preventDefault(),Wr("WebGLRenderer: Context Lost."),U=!0}function ct(){Wr("WebGLRenderer: Context Restored."),U=!1;let M=L.autoReset,N=Fe.enabled,Y=Fe.autoUpdate,H=Fe.needsUpdate,z=Fe.type;Pe(),L.autoReset=M,Fe.enabled=N,Fe.autoUpdate=Y,Fe.needsUpdate=H,Fe.type=z}function fn(M){We("WebGLRenderer: A WebGL context could not be created. Reason: ",M.statusMessage)}function Ee(M){let N=M.target;N.removeEventListener("dispose",Ee),oi(N)}function oi(M){Qt(M),k.remove(M)}function Qt(M){let N=k.get(M).programs;N!==void 0&&(N.forEach(function(Y){fe.releaseProgram(Y)}),M.isShaderMaterial&&fe.releaseShaderCache(M))}this.renderBufferDirect=function(M,N,Y,H,z,ge){N===null&&(N=qt);let be=z.isMesh&&z.matrixWorld.determinantAffine()<0,_e=Pi(M,N,Y,H,z);_.setMaterial(H,be);let Ae=Y.index,Ce=1;if(H.wireframe===!0){if(Ae=j.getWireframeAttribute(Y),Ae===void 0)return;Ce=2}let Je=Y.drawRange,je=Y.attributes.position,we=Je.start*Ce,dt=(Je.start+Je.count)*Ce;ge!==null&&(we=Math.max(we,ge.start*Ce),dt=Math.min(dt,(ge.start+ge.count)*Ce)),Ae!==null?(we=Math.max(we,0),dt=Math.min(dt,Ae.count)):je!=null&&(we=Math.max(we,0),dt=Math.min(dt,je.count));let Nt=dt-we;if(Nt<0||Nt===1/0)return;ye.setup(z,H,_e,Y,Ae);let Ct,O=pe;if(Ae!==null&&(Ct=ue.get(Ae),O=Q,O.setIndex(Ct)),z.isMesh)H.wireframe===!0?(_.setLineWidth(H.wireframeLinewidth*Ft()),O.setMode(F.LINES)):O.setMode(F.TRIANGLES);else if(z.isLine){let V=H.linewidth;V===void 0&&(V=1),_.setLineWidth(V*Ft()),z.isLineSegments?O.setMode(F.LINES):z.isLineLoop?O.setMode(F.LINE_LOOP):O.setMode(F.LINE_STRIP)}else z.isPoints?O.setMode(F.POINTS):z.isSprite&&O.setMode(F.TRIANGLES);if(z.isBatchedMesh)if(mt.get("WEBGL_multi_draw"))O.renderMultiDraw(z._multiDrawStarts,z._multiDrawCounts,z._multiDrawCount);else{let V=z._multiDrawStarts,q=z._multiDrawCounts,oe=z._multiDrawCount,ce=Ae?ue.get(Ae).bytesPerElement:1,Lt=k.get(H).currentProgram.getUniforms();for(let Dt=0;Dt<oe;Dt++)Lt.setValue(F,"_gl_DrawID",Dt),O.render(V[Dt]/ce,q[Dt])}else if(z.isInstancedMesh)O.renderInstances(we,Nt,z.count);else if(Y.isInstancedBufferGeometry){let V=Y._maxInstanceCount!==void 0?Y._maxInstanceCount:1/0,q=Math.min(Y.instanceCount,V);O.renderInstances(we,Nt,q)}else O.render(we,Nt)};function pn(M,N,Y,H){B!==null&&M.isNodeMaterial&&B.setObject(H,M),ut===!0&&Ne.setState(M,Y,!1),M.transparent===!0&&M.side===tn&&M.forceSinglePass===!1?(M.side=un,M.needsUpdate=!0,Ci(M,N,H),M.side=ni,M.needsUpdate=!0,Ci(M,N,H),M.side=tn):Ci(M,N,H)}this.compile=function(M,N,Y=null){Y===null&&(Y=M),B!==null&&B.renderStart(M,N,Y),T=he.get(Y),T.init(N),x.push(T),Y.traverseVisible(function(z){z.isLight&&z.layers.test(N.layers)&&(T.pushLight(z),z.castShadow&&T.pushShadow(z))}),M!==Y&&M.traverseVisible(function(z){z.isLight&&z.layers.test(N.layers)&&(T.pushLight(z),z.castShadow&&T.pushShadow(z))}),T.setupLights(),B!==null&&B.updateLights(T.state.lightsArray),xt=this.localClippingEnabled,ut=Ne.init(this.clippingPlanes,xt),ut===!0&&Ne.setGlobalState(this.clippingPlanes,N),B!==null&&Fe.render(T.state.shadowsArray,Y,N);let H=new Set;return M.traverse(function(z){if(!(z.isMesh||z.isPoints||z.isLine||z.isSprite))return;let ge=z.material;if(ge)if(Array.isArray(ge))for(let be=0;be<ge.length;be++){let _e=ge[be];pn(_e,Y,N,z),H.add(_e)}else pn(ge,Y,N,z),H.add(ge)}),T=x.pop(),B!==null&&B.renderEnd(),H},this.compileAsync=function(M,N,Y=null){let H=this.compile(M,N,Y);return new Promise(z=>{function ge(){if(H.forEach(function(be){let Ae=k.get(be).currentProgram;(Ae===void 0||Ae.isReady())&&H.delete(be)}),H.size===0){z(M);return}setTimeout(ge,10)}mt.get("KHR_parallel_shader_compile")!==null?ge():setTimeout(ge,10)})};let Es=null;function Jc(M){Es&&Es(M)}function ws(){An.stop()}function Pa(){An.start()}let An=new rf;An.setAnimationLoop(Jc),typeof self<"u"&&An.setContext(self),this.setAnimationLoop=function(M){Es=M,Se.setAnimationLoop(M),M===null?An.stop():An.start()},Se.addEventListener("sessionstart",ws),Se.addEventListener("sessionend",Pa),this.render=function(M,N){if(N!==void 0&&N.isCamera!==!0){We("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(U===!0)return;B!==null&&B.renderStart(M,N);let Y=Se.enabled===!0&&Se.isPresenting===!0,H=E!==null&&(se===null||Y)&&E.begin(I,se);if(M.matrixWorldAutoUpdate===!0&&M.updateMatrixWorld(),N.parent===null&&N.matrixWorldAutoUpdate===!0&&N.updateMatrixWorld(),Se.enabled===!0&&Se.isPresenting===!0&&(E===null||E.isCompositing()===!1)&&(Se.cameraAutoUpdate===!0&&Se.updateCamera(N),N=Se.getCamera()),M.isScene===!0&&M.onBeforeRender(I,M,N,se),T=he.get(M,x.length),T.init(N),T.state.textureUnits=Z.getTextureUnits(),x.push(T),et.multiplyMatrices(N.projectionMatrix,N.matrixWorldInverse),Ke.setFromProjectionMatrix(et,zn,N.reversedDepth),xt=this.localClippingEnabled,ut=Ne.init(this.clippingPlanes,xt),b=me.get(M,A.length),b.init(),A.push(b),Se.enabled===!0&&Se.isPresenting===!0){let be=I.xr.getDepthSensingMesh();be!==null&&Ri(be,N,-1/0,I.sortObjects)}Ri(M,N,0,I.sortObjects),b.finish(),B!==null&&B.updateLights(T.state.lightsArray),I.sortObjects===!0&&b.sort(Te,Be),Pt=Se.enabled===!1||Se.isPresenting===!1||Se.hasDepthSensing()===!1,Pt&&Xe.addToRenderList(b,M),this.info.render.frame++,this.info.autoReset===!0&&this.info.reset(),ut===!0&&Ne.beginShadows();let z=T.state.shadowsArray;if(Fe.render(z,M,N),ut===!0&&Ne.endShadows(),(H&&E.hasRenderPass())===!1){let be=b.opaque,_e=b.transmissive;if(T.setupLights(),N.isArrayCamera){let Ae=N.cameras;if(_e.length>0)for(let Ce=0,Je=Ae.length;Ce<Je;Ce++){let je=Ae[Ce];ci(be,_e,M,je)}Pt&&Xe.render(M);for(let Ce=0,Je=Ae.length;Ce<Je;Ce++){let je=Ae[Ce];As(b,M,je,je.viewport)}}else _e.length>0&&ci(be,_e,M,N),Pt&&Xe.render(M),As(b,M,N)}se!==null&&K===0&&(Z.updateMultisampleRenderTarget(se),Z.updateRenderTargetMipmap(se)),H&&E.end(I),M.isScene===!0&&M.onAfterRender(I,M,N),ye.resetDefaultState(),W=-1,ne=null,x.pop(),x.length>0?(T=x[x.length-1],Z.setTextureUnits(T.state.textureUnits),ut===!0&&Ne.setGlobalState(I.clippingPlanes,T.state.camera)):T=null,A.pop(),A.length>0?b=A[A.length-1]:b=null,B!==null&&B.renderEnd()};function Ri(M,N,Y,H){if(M.visible===!1)return;if(M.layers.test(N.layers)){if(M.isGroup)Y=M.renderOrder;else if(M.isLOD)M.autoUpdate===!0&&M.update(N);else if(M.isLightProbeGrid)T.pushLightProbeGrid(M);else if(M.isLight)T.pushLight(M),M.castShadow&&T.pushShadow(M);else if(M.isSprite){if(!M.frustumCulled||M.intersectsFrustum(Ke)){H&&Ut.setFromMatrixPosition(M.matrixWorld).applyMatrix4(et);let be=ee.update(M),_e=M.material;_e.visible&&b.push(M,be,_e,Y,Ut.z,null,N)}}else if((M.isMesh||M.isLine||M.isPoints)&&(!M.frustumCulled||M.intersectsFrustum(Ke))){let be=ee.update(M),_e=M.material;if(H&&(M.boundingSphere!==void 0?(M.boundingSphere===null&&M.computeBoundingSphere(),Ut.copy(M.boundingSphere.center)):(be.boundingSphere===null&&be.computeBoundingSphere(),Ut.copy(be.boundingSphere.center)),Ut.applyMatrix4(M.matrixWorld).applyMatrix4(et)),Array.isArray(_e)){let Ae=be.groups;for(let Ce=0,Je=Ae.length;Ce<Je;Ce++){let je=Ae[Ce],we=_e[je.materialIndex];we&&we.visible&&b.push(M,be,we,Y,Ut.z,je,N)}}else _e.visible&&b.push(M,be,_e,Y,Ut.z,null,N)}}let ge=M.children;for(let be=0,_e=ge.length;be<_e;be++)Ri(ge[be],N,Y,H)}function As(M,N,Y,H){let{opaque:z,transmissive:ge,transparent:be}=M;T.setupLightsView(Y),ut===!0&&Ne.setGlobalState(I.clippingPlanes,Y),H&&_.viewport(ie.copy(H)),z.length>0&&Nn(z,N,Y),ge.length>0&&Nn(ge,N,Y),be.length>0&&Nn(be,N,Y),_.buffers.depth.setTest(!0),_.buffers.depth.setMask(!0),_.buffers.color.setMask(!0),_.setPolygonOffset(!1)}function ci(M,N,Y,H){if((Y.isScene===!0?Y.overrideMaterial:null)!==null)return;if(T.state.transmissionRenderTarget[H.id]===void 0){let we=mt.has("EXT_color_buffer_half_float")||mt.has("EXT_color_buffer_float");T.state.transmissionRenderTarget[H.id]=new gn(1,1,{generateMipmaps:!0,type:we?Yn:vn,minFilter:Xn,samples:Math.max(4,R.samples),stencilBuffer:r,resolveDepthBuffer:!1,resolveStencilBuffer:!1,storeMultisampledDepthBuffer:!1,storeMultisampledStencilBuffer:!1,colorSpace:it.workingColorSpace})}let ge=T.state.transmissionRenderTarget[H.id],be=H.viewport||ie;ge.setSize(be.z*I.transmissionResolutionScale,be.w*I.transmissionResolutionScale);let _e=I.getRenderTarget(),Ae=I.getActiveCubeFace(),Ce=I.getActiveMipmapLevel();I.setRenderTarget(ge),I.getClearColor(vt),rt=I.getClearAlpha(),rt<1&&I.setClearColor(16777215,.5),I.clear(),Pt&&Xe.render(Y);let Je=I.toneMapping;I.toneMapping=Wn;let je=H.viewport;if(H.viewport!==void 0&&(H.viewport=void 0),T.setupLightsView(H),ut===!0&&Ne.setGlobalState(I.clippingPlanes,H),Nn(M,Y,H),Z.updateMultisampleRenderTarget(ge),Z.updateRenderTargetMipmap(ge),mt.has("WEBGL_multisampled_render_to_texture")===!1){let we=!1;for(let dt=0,Nt=N.length;dt<Nt;dt++){let Ct=N[dt],{object:O,geometry:V,material:q,group:oe}=Ct;if(q.side===tn&&O.layers.test(H.layers)){let ce=q.side;q.side=un,q.needsUpdate=!0,Er(O,Y,H,V,q,oe),q.side=ce,q.needsUpdate=!0,we=!0}}we===!0&&(Z.updateMultisampleRenderTarget(ge),Z.updateRenderTargetMipmap(ge))}I.setRenderTarget(_e,Ae,Ce),I.setClearColor(vt,rt),je!==void 0&&(H.viewport=je),I.toneMapping=Je}function Nn(M,N,Y){let H=N.isScene===!0?N.overrideMaterial:null;for(let z=0,ge=M.length;z<ge;z++){let be=M[z],{object:_e,geometry:Ae,group:Ce}=be,Je=be.material;Je.allowOverride===!0&&H!==null&&(Je=H),_e.layers.test(Y.layers)&&Er(_e,N,Y,Ae,Je,Ce)}}function Er(M,N,Y,H,z,ge){B!==null&&z.isNodeMaterial&&B.setObject(M,z),M.onBeforeRender(I,N,Y,H,z,ge),M.modelViewMatrix.multiplyMatrices(Y.matrixWorldInverse,M.matrixWorld),M.normalMatrix.getNormalMatrix(M.modelViewMatrix),z.onBeforeRender(I,N,Y,H,M,ge),z.transparent===!0&&z.side===tn&&z.forceSinglePass===!1?(z.side=un,z.needsUpdate=!0,I.renderBufferDirect(Y,N,H,z,M,ge),z.side=ni,z.needsUpdate=!0,I.renderBufferDirect(Y,N,H,z,M,ge),z.side=tn):I.renderBufferDirect(Y,N,H,z,M,ge),M.onAfterRender(I,N,Y,H,z,ge)}function Ci(M,N,Y){N.isScene!==!0&&(N=qt);let H=k.get(M),z=T.state.lights,ge=T.state.shadowsArray,be=z.state.version,_e=fe.getParameters(M,z.state,ge,N,Y,T.state.lightProbeGridArray),Ae=fe.getProgramCacheKey(_e),Ce=H.programs;H.environment=M.isMeshStandardMaterial||M.isMeshLambertMaterial||M.isMeshPhongMaterial?N.environment:null,H.fog=N.fog;let Je=M.isMeshStandardMaterial||M.isMeshLambertMaterial&&!M.envMap||M.isMeshPhongMaterial&&!M.envMap;H.envMap=ae.get(M.envMap||H.environment,Je),H.envMapRotation=H.environment!==null&&M.envMap===null?N.environmentRotation:M.envMapRotation,Ce===void 0&&(M.addEventListener("dispose",Ee),Ce=new Map,H.programs=Ce);let je=Ce.get(Ae);if(je!==void 0){if(H.currentProgram===je&&H.lightsStateVersion===be)return Qi(M,_e),je}else _e.uniforms=fe.getUniforms(M),B!==null&&M.isNodeMaterial&&B.build(M,Y,_e),M.onBeforeCompile(_e,I),je=fe.acquireProgram(_e,Ae),Ce.set(Ae,je),H.uniforms=_e.uniforms;let we=H.uniforms;return(!M.isShaderMaterial&&!M.isRawShaderMaterial||M.clipping===!0)&&(we.clippingPlanes=Ne.uniform),Qi(M,_e),H.needsLights=li(M),H.lightsStateVersion=be,H.needsLights&&(we.ambientLightColor.value=z.state.ambient,we.lightProbe.value=z.state.probe,we.sunLights.value=z.state.sun,we.sunLightShadows.value=z.state.sunShadow,we.directionalLights.value=z.state.directional,we.directionalLightShadows.value=z.state.directionalShadow,we.spotLights.value=z.state.spot,we.spotLightShadows.value=z.state.spotShadow,we.rectAreaLights.value=z.state.rectArea,we.ltc_1.value=z.state.rectAreaLTC1,we.ltc_2.value=z.state.rectAreaLTC2,we.pointLights.value=z.state.point,we.pointLightShadows.value=z.state.pointShadow,we.hemisphereLights.value=z.state.hemi,we.sunShadowMatrix.value=z.state.sunShadowMatrix,we.sunShadowCascade.value=z.state.sunShadowCascade,we.directionalShadowMatrix.value=z.state.directionalShadowMatrix,we.spotLightMatrix.value=z.state.spotLightMatrix,we.spotLightMap.value=z.state.spotLightMap,we.pointShadowMatrix.value=z.state.pointShadowMatrix),H.lightProbeGrid=T.state.lightProbeGridArray.length>0,H.currentProgram=je,H.uniformsList=null,je}function Rs(M){if(M.uniformsList===null){let N=M.currentProgram.getUniforms();M.uniformsList=Mr.seqWithValue(N.seq,M.uniforms)}return M.uniformsList}function Qi(M,N){let Y=k.get(M);Y.outputColorSpace=N.outputColorSpace,Y.batching=N.batching,Y.batchingColor=N.batchingColor,Y.instancing=N.instancing,Y.instancingColor=N.instancingColor,Y.instancingMorph=N.instancingMorph,Y.skinning=N.skinning,Y.morphTargets=N.morphTargets,Y.morphNormals=N.morphNormals,Y.morphColors=N.morphColors,Y.morphTargetsCount=N.morphTargetsCount,Y.numClippingPlanes=N.numClippingPlanes,Y.numIntersection=N.numClipIntersection,Y.vertexAlphas=N.vertexAlphas,Y.vertexTangents=N.vertexTangents,Y.toneMapping=N.toneMapping}function Ii(M,N){if(M.length===0)return null;if(M.length===1)return M[0].texture!==null?M[0]:null;y.setFromMatrixPosition(N.matrixWorld);for(let Y=0,H=M.length;Y<H;Y++){let z=M[Y];if(z.texture!==null&&z.boundingBox.containsPoint(y))return z}return null}function Pi(M,N,Y,H,z){N.isScene!==!0&&(N=qt),Z.resetTextureUnits();let ge=N.fog,be=H.isMeshStandardMaterial||H.isMeshLambertMaterial||H.isMeshPhongMaterial?N.environment:null,_e=se===null?I.outputColorSpace:se.isXRRenderTarget===!0?se.texture.colorSpace:it.workingColorSpace,Ae=H.isMeshStandardMaterial||H.isMeshLambertMaterial&&!H.envMap||H.isMeshPhongMaterial&&!H.envMap,Ce=ae.get(H.envMap||be,Ae),Je=H.vertexColors===!0&&!!Y.attributes.color&&Y.attributes.color.itemSize===4,je=!!Y.attributes.tangent&&(!!H.normalMap||H.anisotropy>0),we=!!Y.morphAttributes.position,dt=!!Y.morphAttributes.normal,Nt=!!Y.morphAttributes.color,Ct=Wn;H.toneMapped&&(se===null||se.isXRRenderTarget===!0)&&(Ct=I.toneMapping);let O=Y.morphAttributes.position||Y.morphAttributes.normal||Y.morphAttributes.color,V=O!==void 0?O.length:0,q=k.get(H),oe=T.state.lights;if(ut===!0&&(xt===!0||M!==ne)){let ke=M===ne&&H.id===W;Ne.setState(H,M,ke)}let ce=!1;H.version===q.__version?(q.needsLights&&q.lightsStateVersion!==oe.state.version||q.outputColorSpace!==_e||z.isBatchedMesh&&q.batching===!1||!z.isBatchedMesh&&q.batching===!0||z.isBatchedMesh&&q.batchingColor===!0&&z._colorsTexture===null||z.isBatchedMesh&&q.batchingColor===!1&&z._colorsTexture!==null||z.isInstancedMesh&&q.instancing===!1||!z.isInstancedMesh&&q.instancing===!0||z.isSkinnedMesh&&q.skinning===!1||!z.isSkinnedMesh&&q.skinning===!0||z.isInstancedMesh&&q.instancingColor===!0&&z.instanceColor===null||z.isInstancedMesh&&q.instancingColor===!1&&z.instanceColor!==null||z.isInstancedMesh&&q.instancingMorph===!0&&z.morphTexture===null||z.isInstancedMesh&&q.instancingMorph===!1&&z.morphTexture!==null||q.envMap!==Ce||H.fog===!0&&q.fog!==ge||q.numClippingPlanes!==void 0&&(q.numClippingPlanes!==Ne.numPlanes||q.numIntersection!==Ne.numIntersection)||q.vertexAlphas!==Je||q.vertexTangents!==je||q.morphTargets!==we||q.morphNormals!==dt||q.morphColors!==Nt||q.toneMapping!==Ct||q.morphTargetsCount!==V||!!q.lightProbeGrid!=T.state.lightProbeGridArray.length>0)&&(ce=!0):(ce=!0,q.__version=H.version);let Lt=q.currentProgram;ce===!0&&(Lt=Ci(H,N,z),B&&H.isNodeMaterial&&B.onUpdateProgram(H,Lt,q));let Dt=!1,It=!1,_t=!1,Re=Lt.getUniforms(),qe=q.uniforms;if(_.useProgram(Lt.program)&&(Dt=!0,It=!0,_t=!0),H.id!==W&&(W=H.id,It=!0),q.needsLights){let ke=Ii(T.state.lightProbeGridArray,z);q.lightProbeGrid!==ke&&(q.lightProbeGrid=ke,It=!0)}if(Dt||ne!==M){_.buffers.depth.getReversed()&&M.reversedDepth!==!0&&(M._reversedDepth=!0,M.updateProjectionMatrix()),Re.setValue(F,"projectionMatrix",M.projectionMatrix),Re.setValue(F,"viewMatrix",M.matrixWorldInverse);let He=Re.map.cameraPosition;He!==void 0&&He.setValue(F,Rt.setFromMatrixPosition(M.matrixWorld)),R.logarithmicDepthBuffer&&Re.setValue(F,"logDepthBufFC",2/(Math.log(M.far+1)/Math.LN2)),(H.isMeshPhongMaterial||H.isMeshToonMaterial||H.isMeshLambertMaterial||H.isMeshBasicMaterial||H.isMeshStandardMaterial||H.isShaderMaterial)&&Re.setValue(F,"isOrthographic",M.isOrthographicCamera===!0),ne!==M&&(ne=M,It=!0,_t=!0)}if(q.needsLights&&(oe.state.sunShadowMap.length>0&&Re.setValue(F,"sunShadowMap",oe.state.sunShadowMap,Z),oe.state.directionalShadowMap.length>0&&Re.setValue(F,"directionalShadowMap",oe.state.directionalShadowMap,Z),oe.state.spotShadowMap.length>0&&Re.setValue(F,"spotShadowMap",oe.state.spotShadowMap,Z),oe.state.pointShadowMap.length>0&&Re.setValue(F,"pointShadowMap",oe.state.pointShadowMap,Z)),z.isSkinnedMesh){Re.setOptional(F,z,"bindMatrix"),Re.setOptional(F,z,"bindMatrixInverse");let ke=z.skeleton;ke&&(ke.boneTexture===null&&ke.computeBoneTexture(),Re.setValue(F,"boneTexture",ke.boneTexture,Z))}z.isBatchedMesh&&(Re.setOptional(F,z,"batchingTexture"),Re.setValue(F,"batchingTexture",z._matricesTexture,Z),Re.setOptional(F,z,"batchingIdTexture"),Re.setValue(F,"batchingIdTexture",z._indirectTexture,Z),Re.setOptional(F,z,"batchingColorTexture"),z._colorsTexture!==null&&Re.setValue(F,"batchingColorTexture",z._colorsTexture,Z));let lt=Y.morphAttributes;if((lt.position!==void 0||lt.normal!==void 0||lt.color!==void 0)&&P.update(z,Y,Lt),(It||q.receiveShadow!==z.receiveShadow)&&(q.receiveShadow=z.receiveShadow,Re.setValue(F,"receiveShadow",z.receiveShadow)),(H.isMeshStandardMaterial||H.isMeshLambertMaterial||H.isMeshPhongMaterial)&&H.envMap===null&&N.environment!==null&&(qe.envMapIntensity.value=N.environmentIntensity),qe.dfgLUT!==void 0&&(qe.dfgLUT.value=Bx()),It){if(Re.setValue(F,"toneMappingExposure",I.toneMappingExposure),q.needsLights&&Cs(qe,_t),ge&&H.fog===!0&&Ie.refreshFogUniforms(qe,ge),Ie.refreshMaterialUniforms(qe,H,te,J,T.state.transmissionRenderTarget[M.id]),q.needsLights&&q.lightProbeGrid){let ke=q.lightProbeGrid;qe.probesSH.value=ke.texture,qe.probesMin.value.copy(ke.boundingBox.min),qe.probesMax.value.copy(ke.boundingBox.max),qe.probesResolution.value.copy(ke.resolution)}Mr.upload(F,Rs(q),qe,Z)}if(H.isShaderMaterial&&H.uniformsNeedUpdate===!0&&(Mr.upload(F,Rs(q),qe,Z),H.uniformsNeedUpdate=!1),H.isSpriteMaterial&&Re.setValue(F,"center",z.center),Re.setValue(F,"modelViewMatrix",z.modelViewMatrix),Re.setValue(F,"normalMatrix",z.normalMatrix),Re.setValue(F,"modelMatrix",z.matrixWorld),H.uniformsGroups!==void 0){let ke=H.uniformsGroups;for(let He=0,De=ke.length;He<De;He++){let le=ke[He];re.update(le,Lt),re.bind(le,Lt)}}return Lt}function Cs(M,N){M.ambientLightColor.needsUpdate=N,M.lightProbe.needsUpdate=N,M.sunLights.needsUpdate=N,M.sunLightShadows.needsUpdate=N,M.directionalLights.needsUpdate=N,M.directionalLightShadows.needsUpdate=N,M.pointLights.needsUpdate=N,M.pointLightShadows.needsUpdate=N,M.spotLights.needsUpdate=N,M.spotLightShadows.needsUpdate=N,M.rectAreaLights.needsUpdate=N,M.hemisphereLights.needsUpdate=N}function li(M){return M.isMeshLambertMaterial||M.isMeshToonMaterial||M.isMeshPhongMaterial||M.isMeshStandardMaterial||M.isShadowMaterial||M.isShaderMaterial&&M.lights===!0}this.getActiveCubeFace=function(){return $},this.getActiveMipmapLevel=function(){return K},this.getRenderTarget=function(){return se},this.setRenderTargetTextures=function(M,N,Y){let H=k.get(M);H.__autoAllocateDepthBuffer=M.resolveDepthBuffer===!1,H.__autoAllocateDepthBuffer===!1&&(H.__useRenderToTexture=!1),k.get(M.texture).__webglTexture=N,k.get(M.depthTexture).__webglTexture=H.__autoAllocateDepthBuffer?void 0:Y,H.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(M,N){let Y=k.get(M);Y.__webglFramebuffer=N,Y.__useDefaultFramebuffer=N===void 0},this.setRenderTarget=function(M,N=0,Y=0){se=M,$=N,K=Y;let H=null,z=!1,ge=!1;if(M){let _e=k.get(M);if(_e.__useDefaultFramebuffer!==void 0){_.bindFramebuffer(F.FRAMEBUFFER,_e.__webglFramebuffer),ie.copy(M.viewport),Oe.copy(M.scissor),Le=M.scissorTest,_.viewport(ie),_.scissor(Oe),_.setScissorTest(Le),W=-1;return}else if(_e.__webglFramebuffer===void 0)Z.setupRenderTarget(M);else if(_e.__hasExternalTextures)Z.rebindTextures(M,k.get(M.texture).__webglTexture,k.get(M.depthTexture).__webglTexture);else if(M.depthBuffer){let Je=M.depthTexture;if(_e.__boundDepthTexture!==Je){if(Je!==null&&k.has(Je)&&(M.width!==Je.image.width||M.height!==Je.image.height))throw new Error("THREE.WebGLRenderer: Attached DepthTexture is initialized to the incorrect size.");Z.setupDepthRenderbuffer(M)}}let Ae=M.texture;(Ae.isData3DTexture||Ae.isDataArrayTexture||Ae.isCompressedArrayTexture)&&(ge=!0);let Ce=k.get(M).__webglFramebuffer;M.isWebGLCubeRenderTarget?(Array.isArray(Ce[N])?H=Ce[N][Y]:H=Ce[N],z=!0):M.samples>0&&Z.useMultisampledRTT(M)===!1?H=k.get(M).__webglMultisampledFramebuffer:Array.isArray(Ce)?H=Ce[Y]:H=Ce,ie.copy(M.viewport),Oe.copy(M.scissor),Le=M.scissorTest}else ie.copy(Me).multiplyScalar(te).floor(),Oe.copy($e).multiplyScalar(te).floor(),Le=At;if(Y!==0&&(H=G),_.bindFramebuffer(F.FRAMEBUFFER,H)&&_.drawBuffers(M,H),_.viewport(ie),_.scissor(Oe),_.setScissorTest(Le),z){let _e=k.get(M.texture);F.framebufferTexture2D(F.FRAMEBUFFER,F.COLOR_ATTACHMENT0,F.TEXTURE_CUBE_MAP_POSITIVE_X+N,_e.__webglTexture,Y)}else if(ge){let _e=N;for(let Ae=0;Ae<M.textures.length;Ae++){let Ce=k.get(M.textures[Ae]);F.framebufferTextureLayer(F.FRAMEBUFFER,F.COLOR_ATTACHMENT0+Ae,Ce.__webglTexture,Y,_e)}}else if(M!==null&&Y!==0){let _e=k.get(M.texture);F.framebufferTexture2D(F.FRAMEBUFFER,F.COLOR_ATTACHMENT0,F.TEXTURE_2D,_e.__webglTexture,Y)}W=-1};function wr(M){let N=k.get(M);return(N.__readFormat!==M.format||N.__readType!==M.type)&&(N.__readFormat=M.format,N.__readType=M.type,N.__formatReadable=R.textureFormatReadable(M.format),N.__typeReadable=R.textureTypeReadable(M.type)),N}this.readRenderTargetPixels=function(M,N,Y,H,z,ge,be,_e=0){if(!(M&&M.isWebGLRenderTarget)){We("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Ae=k.get(M).__webglFramebuffer;if(M.isWebGLCubeRenderTarget&&be!==void 0&&(Ae=Ae[be]),Ae){_.bindFramebuffer(F.FRAMEBUFFER,Ae);try{let Ce=M.textures[_e],Je=Ce.format,je=Ce.type;M.textures.length>1&&F.readBuffer(F.COLOR_ATTACHMENT0+_e);let we=wr(Ce);if(we.__formatReadable===!1){We("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(we.__typeReadable===!1){We("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}N>=0&&N<=M.width-H&&Y>=0&&Y<=M.height-z&&F.readPixels(N,Y,H,z,de.convert(Je),de.convert(je),ge)}finally{let Ce=se!==null?k.get(se).__webglFramebuffer:null;_.bindFramebuffer(F.FRAMEBUFFER,Ce)}}},this.readRenderTargetPixelsAsync=async function(M,N,Y,H,z,ge,be,_e=0){if(!(M&&M.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Ae=k.get(M).__webglFramebuffer;if(M.isWebGLCubeRenderTarget&&be!==void 0&&(Ae=Ae[be]),Ae)if(N>=0&&N<=M.width-H&&Y>=0&&Y<=M.height-z){_.bindFramebuffer(F.FRAMEBUFFER,Ae);let Ce=M.textures[_e],Je=Ce.format,je=Ce.type;M.textures.length>1&&F.readBuffer(F.COLOR_ATTACHMENT0+_e);let we=wr(Ce);if(we.__formatReadable===!1)throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(we.__typeReadable===!1)throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");let dt=F.createBuffer();F.bindBuffer(F.PIXEL_PACK_BUFFER,dt),F.bufferData(F.PIXEL_PACK_BUFFER,ge.byteLength,F.STREAM_READ),F.readPixels(N,Y,H,z,de.convert(Je),de.convert(je),0),F.bindBuffer(F.PIXEL_PACK_BUFFER,null);let Nt=se!==null?k.get(se).__webglFramebuffer:null;_.bindFramebuffer(F.FRAMEBUFFER,Nt);let Ct=F.fenceSync(F.SYNC_GPU_COMMANDS_COMPLETE,0);return F.flush(),await Id(F,Ct,4),F.bindBuffer(F.PIXEL_PACK_BUFFER,dt),F.getBufferSubData(F.PIXEL_PACK_BUFFER,0,ge),F.bindBuffer(F.PIXEL_PACK_BUFFER,null),F.deleteBuffer(dt),F.deleteSync(Ct),ge}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(M,N=null,Y=0){let H=Math.pow(2,-Y),z=Math.floor(M.image.width*H),ge=Math.floor(M.image.height*H),be=N!==null?N.x:0,_e=N!==null?N.y:0;Z.setTexture2D(M,0),F.copyTexSubImage2D(F.TEXTURE_2D,Y,0,0,be,_e,z,ge),_.unbindTexture()},this.copyTextureToTexture=function(M,N,Y=null,H=null,z=0,ge=0){let be,_e,Ae,Ce,Je,je,we,dt,Nt,Ct=M.isCompressedTexture?M.mipmaps[ge]:M.image;if(Y!==null)be=Y.max.x-Y.min.x,_e=Y.max.y-Y.min.y,Ae=Y.isBox3?Y.max.z-Y.min.z:1,Ce=Y.min.x,Je=Y.min.y,je=Y.isBox3?Y.min.z:0;else{let qe=Math.pow(2,-z);be=Math.floor(Ct.width*qe),_e=Math.floor(Ct.height*qe),M.isDataArrayTexture?Ae=Ct.depth:M.isData3DTexture?Ae=Math.floor(Ct.depth*qe):Ae=1,Ce=0,Je=0,je=0}H!==null?(we=H.x,dt=H.y,Nt=H.z):(we=0,dt=0,Nt=0);let O=de.convert(N.format),V=de.convert(N.type),q;N.isData3DTexture?(Z.setTexture3D(N,0),q=F.TEXTURE_3D):N.isDataArrayTexture||N.isCompressedArrayTexture?(Z.setTexture2DArray(N,0),q=F.TEXTURE_2D_ARRAY):(Z.setTexture2D(N,0),q=F.TEXTURE_2D),_.activeTexture(F.TEXTURE0),_.pixelStorei(F.UNPACK_FLIP_Y_WEBGL,N.flipY),_.pixelStorei(F.UNPACK_PREMULTIPLY_ALPHA_WEBGL,N.premultiplyAlpha),_.pixelStorei(F.UNPACK_ALIGNMENT,N.unpackAlignment);let oe=_.getParameter(F.UNPACK_ROW_LENGTH),ce=_.getParameter(F.UNPACK_IMAGE_HEIGHT),Lt=_.getParameter(F.UNPACK_SKIP_PIXELS),Dt=_.getParameter(F.UNPACK_SKIP_ROWS),It=_.getParameter(F.UNPACK_SKIP_IMAGES);_.pixelStorei(F.UNPACK_ROW_LENGTH,Ct.width),_.pixelStorei(F.UNPACK_IMAGE_HEIGHT,Ct.height),_.pixelStorei(F.UNPACK_SKIP_PIXELS,Ce),_.pixelStorei(F.UNPACK_SKIP_ROWS,Je),_.pixelStorei(F.UNPACK_SKIP_IMAGES,je);let _t=M.isDataArrayTexture||M.isData3DTexture,Re=N.isDataArrayTexture||N.isData3DTexture;if(M.isDepthTexture){let qe=k.get(M),lt=k.get(N),ke=k.get(qe.__renderTarget),He=k.get(lt.__renderTarget);_.bindFramebuffer(F.READ_FRAMEBUFFER,ke.__webglFramebuffer),_.bindFramebuffer(F.DRAW_FRAMEBUFFER,He.__webglFramebuffer);for(let De=0;De<Ae;De++)_t&&(F.framebufferTextureLayer(F.READ_FRAMEBUFFER,F.COLOR_ATTACHMENT0,k.get(M).__webglTexture,z,je+De),F.framebufferTextureLayer(F.DRAW_FRAMEBUFFER,F.COLOR_ATTACHMENT0,k.get(N).__webglTexture,ge,Nt+De)),F.blitFramebuffer(Ce,Je,be,_e,we,dt,be,_e,F.DEPTH_BUFFER_BIT,F.NEAREST);_.bindFramebuffer(F.READ_FRAMEBUFFER,null),_.bindFramebuffer(F.DRAW_FRAMEBUFFER,null)}else if(z!==0||M.isRenderTargetTexture||k.has(M)){let qe=k.get(M),lt=k.get(N);_.bindFramebuffer(F.READ_FRAMEBUFFER,D),_.bindFramebuffer(F.DRAW_FRAMEBUFFER,X);for(let ke=0;ke<Ae;ke++)_t?F.framebufferTextureLayer(F.READ_FRAMEBUFFER,F.COLOR_ATTACHMENT0,qe.__webglTexture,z,je+ke):F.framebufferTexture2D(F.READ_FRAMEBUFFER,F.COLOR_ATTACHMENT0,F.TEXTURE_2D,qe.__webglTexture,z),Re?F.framebufferTextureLayer(F.DRAW_FRAMEBUFFER,F.COLOR_ATTACHMENT0,lt.__webglTexture,ge,Nt+ke):F.framebufferTexture2D(F.DRAW_FRAMEBUFFER,F.COLOR_ATTACHMENT0,F.TEXTURE_2D,lt.__webglTexture,ge),z!==0?F.blitFramebuffer(Ce,Je,be,_e,we,dt,be,_e,F.COLOR_BUFFER_BIT,F.NEAREST):Re?F.copyTexSubImage3D(q,ge,we,dt,Nt+ke,Ce,Je,be,_e):F.copyTexSubImage2D(q,ge,we,dt,Ce,Je,be,_e);_.bindFramebuffer(F.READ_FRAMEBUFFER,null),_.bindFramebuffer(F.DRAW_FRAMEBUFFER,null)}else Re?M.isDataTexture||M.isData3DTexture?F.texSubImage3D(q,ge,we,dt,Nt,be,_e,Ae,O,V,Ct.data):N.isCompressedArrayTexture?F.compressedTexSubImage3D(q,ge,we,dt,Nt,be,_e,Ae,O,Ct.data):F.texSubImage3D(q,ge,we,dt,Nt,be,_e,Ae,O,V,Ct):M.isDataTexture?F.texSubImage2D(F.TEXTURE_2D,ge,we,dt,be,_e,O,V,Ct.data):M.isCompressedTexture?F.compressedTexSubImage2D(F.TEXTURE_2D,ge,we,dt,Ct.width,Ct.height,O,Ct.data):F.texSubImage2D(F.TEXTURE_2D,ge,we,dt,be,_e,O,V,Ct);_.pixelStorei(F.UNPACK_ROW_LENGTH,oe),_.pixelStorei(F.UNPACK_IMAGE_HEIGHT,ce),_.pixelStorei(F.UNPACK_SKIP_PIXELS,Lt),_.pixelStorei(F.UNPACK_SKIP_ROWS,Dt),_.pixelStorei(F.UNPACK_SKIP_IMAGES,It),ge===0&&N.generateMipmaps&&F.generateMipmap(q),_.unbindTexture()},this.initRenderTarget=function(M){k.get(M).__webglFramebuffer===void 0&&Z.setupRenderTarget(M)},this.initTexture=function(M){M.isCubeTexture?Z.setTextureCube(M,0):M.isData3DTexture?Z.setTexture3D(M,0):M.isDataArrayTexture||M.isCompressedArrayTexture?Z.setTexture2DArray(M,0):Z.setTexture2D(M,0),_.unbindTexture()},this.resetState=function(){$=0,K=0,se=null,_.reset(),ye.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return zn}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;let t=this.getContext();t.drawingBufferColorSpace=it._getDrawingBufferColorSpace(e),t.unpackColorSpace=it._getUnpackColorSpace()}};function Rh(s,e){if(e===Ql)return console.warn("THREE.BufferGeometryUtils.toTrianglesDrawMode(): Geometry already defined as triangles."),s;if(e===xr||e===wa){let t=s.getIndex();if(t===null){let r=[],a=s.getAttribute("position");if(a!==void 0){for(let o=0;o<a.count;o++)r.push(o);s.setIndex(r),t=s.getIndex()}else return console.error("THREE.BufferGeometryUtils.toTrianglesDrawMode(): Undefined position attribute. Processing not possible."),s}let n=t.count-2,i=[];if(e===xr)for(let r=1;r<=n;r++)i.push(t.getX(0)),i.push(t.getX(r)),i.push(t.getX(r+1));else for(let r=0;r<n;r++)r%2===0?(i.push(t.getX(r)),i.push(t.getX(r+1)),i.push(t.getX(r+2))):(i.push(t.getX(r+2)),i.push(t.getX(r+1)),i.push(t.getX(r)));return i.length/3!==n&&console.error("THREE.BufferGeometryUtils.toTrianglesDrawMode(): Unable to generate correct amount of triangles."),s.setIndex(i),s.clearGroups(),s}else return console.error("THREE.BufferGeometryUtils.toTrianglesDrawMode(): Unknown draw mode:",e),s}function Vc(s){let e=new Map,t=new Map,n=s.clone();return df(s,n,function(i,r){e.set(r,i),t.set(i,r)}),n.traverse(function(i){if(!i.isSkinnedMesh)return;let r=i,a=e.get(i),o=a.skeleton.bones;r.skeleton=a.skeleton.clone(),r.bindMatrix.copy(a.bindMatrix),r.skeleton.bones=o.map(function(c){return t.get(c)}),r.bind(r.skeleton,r.bindMatrix)}),n}function df(s,e,t){t(s,e);for(let n=0;n<s.children.length;n++)df(s.children[n],e.children[n],t)}var Gc=class extends ti{constructor(e){super(e),this.dracoLoader=null,this.ktx2Loader=null,this.meshoptDecoder=null,this.pluginCallbacks=[],this.register(function(t){return new Uh(t)}),this.register(function(t){return new Fh(t)}),this.register(function(t){return new Xh(t)}),this.register(function(t){return new qh(t)}),this.register(function(t){return new Yh(t)}),this.register(function(t){return new Bh(t)}),this.register(function(t){return new zh(t)}),this.register(function(t){return new Hh(t)}),this.register(function(t){return new kh(t)}),this.register(function(t){return new Dh(t)}),this.register(function(t){return new Vh(t)}),this.register(function(t){return new Oh(t)}),this.register(function(t){return new Wh(t)}),this.register(function(t){return new Gh(t)}),this.register(function(t){return new Lh(t)}),this.register(function(t){return new Wc(t,at.EXT_MESHOPT_COMPRESSION)}),this.register(function(t){return new Wc(t,at.KHR_MESHOPT_COMPRESSION)}),this.register(function(t){return new Zh(t)})}load(e,t,n,i){let r=this,a;if(this.resourcePath!=="")a=this.resourcePath;else if(this.path!==""){let l=wi.extractUrlBase(e);a=wi.resolveURL(l,this.path)}else a=wi.extractUrlBase(e);this.manager.itemStart(e);let o=function(l){i?i(l):console.error(l),r.manager.itemError(e),r.manager.itemEnd(e)},c=new hr(this.manager);c.setPath(this.path),c.setResponseType("arraybuffer"),c.setRequestHeader(this.requestHeader),c.setWithCredentials(this.withCredentials),c.load(e,function(l){try{r.parse(l,a,function(h){t(h),r.manager.itemEnd(e)},o)}catch(h){o(h)}},n,o)}setDRACOLoader(e){return this.dracoLoader=e,this}setKTX2Loader(e){return this.ktx2Loader=e,this}setMeshoptDecoder(e){return this.meshoptDecoder=e,this}register(e){return this.pluginCallbacks.indexOf(e)===-1&&this.pluginCallbacks.push(e),this}unregister(e){return this.pluginCallbacks.indexOf(e)!==-1&&this.pluginCallbacks.splice(this.pluginCallbacks.indexOf(e),1),this}parse(e,t,n,i){let r,a={},o={},c=new TextDecoder;if(typeof e=="string")r=JSON.parse(e);else if(e instanceof ArrayBuffer)if(c.decode(new Uint8Array(e,0,4))===_f){try{a[at.KHR_BINARY_GLTF]=new Kh(e)}catch(u){i&&i(u);return}r=JSON.parse(a[at.KHR_BINARY_GLTF].content)}else r=JSON.parse(c.decode(e));else r=e;if(r.asset===void 0||r.asset.version[0]<2){i&&i(new Error("THREE.GLTFLoader: Unsupported asset. glTF versions >=2.0 are supported."));return}let l=new nu(r,{path:t||this.resourcePath||"",crossOrigin:this.crossOrigin,requestHeader:this.requestHeader,manager:this.manager,ktx2Loader:this.ktx2Loader,meshoptDecoder:this.meshoptDecoder});l.fileLoader.setRequestHeader(this.requestHeader);for(let h=0;h<this.pluginCallbacks.length;h++){let u=this.pluginCallbacks[h](l);u.name||console.error("THREE.GLTFLoader: Invalid plugin found: missing name"),o[u.name]=u,a[u.name]=!0}if(r.extensionsUsed)for(let h=0;h<r.extensionsUsed.length;++h){let u=r.extensionsUsed[h],d=r.extensionsRequired||[];switch(u){case at.KHR_MATERIALS_UNLIT:a[u]=new Nh;break;case at.KHR_DRACO_MESH_COMPRESSION:a[u]=new Jh(r,this.dracoLoader);break;case at.KHR_TEXTURE_TRANSFORM:a[u]=new $h;break;case at.KHR_MESH_QUANTIZATION:a[u]=new jh;break;default:d.indexOf(u)>=0&&o[u]===void 0&&console.warn('THREE.GLTFLoader: Unknown extension "'+u+'".')}}l.setExtensions(a),l.setPlugins(o),l.parse(n,i)}parseAsync(e,t){let n=this;return new Promise(function(i,r){n.parse(e,t,i,r)})}};function Hx(){let s={};return{get:function(e){return s[e]},add:function(e,t){s[e]=t},remove:function(e){delete s[e]},removeAll:function(){s={}}}}function Vt(s,e,t){let n=s.json.materials[e];return n.extensions&&n.extensions[t]?n.extensions[t]:null}var at={KHR_BINARY_GLTF:"KHR_binary_glTF",KHR_DRACO_MESH_COMPRESSION:"KHR_draco_mesh_compression",KHR_LIGHTS_PUNCTUAL:"KHR_lights_punctual",KHR_MATERIALS_CLEARCOAT:"KHR_materials_clearcoat",KHR_MATERIALS_DISPERSION:"KHR_materials_dispersion",KHR_MATERIALS_IOR:"KHR_materials_ior",KHR_MATERIALS_SHEEN:"KHR_materials_sheen",KHR_MATERIALS_SPECULAR:"KHR_materials_specular",KHR_MATERIALS_TRANSMISSION:"KHR_materials_transmission",KHR_MATERIALS_IRIDESCENCE:"KHR_materials_iridescence",KHR_MATERIALS_ANISOTROPY:"KHR_materials_anisotropy",KHR_MATERIALS_UNLIT:"KHR_materials_unlit",KHR_MATERIALS_VOLUME:"KHR_materials_volume",KHR_TEXTURE_BASISU:"KHR_texture_basisu",KHR_TEXTURE_TRANSFORM:"KHR_texture_transform",KHR_MESH_QUANTIZATION:"KHR_mesh_quantization",KHR_MATERIALS_EMISSIVE_STRENGTH:"KHR_materials_emissive_strength",EXT_MATERIALS_BUMP:"EXT_materials_bump",EXT_TEXTURE_WEBP:"EXT_texture_webp",EXT_TEXTURE_AVIF:"EXT_texture_avif",EXT_MESHOPT_COMPRESSION:"EXT_meshopt_compression",KHR_MESHOPT_COMPRESSION:"KHR_meshopt_compression",EXT_MESH_GPU_INSTANCING:"EXT_mesh_gpu_instancing"},Lh=class{constructor(e){this.parser=e,this.name=at.KHR_LIGHTS_PUNCTUAL,this.cache={refs:{},uses:{}}}_markDefs(){let e=this.parser,t=this.parser.json.nodes||[];for(let n=0,i=t.length;n<i;n++){let r=t[n];r.extensions&&r.extensions[this.name]&&r.extensions[this.name].light!==void 0&&e._addNodeRef(this.cache,r.extensions[this.name].light)}}_loadLight(e){let t=this.parser,n="light:"+e,i=t.cache.get(n);if(i)return i;let r=t.json,c=((r.extensions&&r.extensions[this.name]||{}).lights||[])[e],l,h=new ze(16777215);c.color!==void 0&&h.setRGB(c.color[0],c.color[1],c.color[2],cn);let u=c.range!==void 0?c.range:0;switch(c.type){case"directional":l=new qi(h),l.target.position.set(0,0,-1),l.add(l.target);break;case"point":l=new ma(h),l.distance=u;break;case"spot":l=new _s(h),l.distance=u,c.spot=c.spot||{},c.spot.innerConeAngle=c.spot.innerConeAngle!==void 0?c.spot.innerConeAngle:0,c.spot.outerConeAngle=c.spot.outerConeAngle!==void 0?c.spot.outerConeAngle:Math.PI/4,l.angle=c.spot.outerConeAngle,l.penumbra=1-c.spot.innerConeAngle/c.spot.outerConeAngle,l.target.position.set(0,0,-1),l.add(l.target);break;default:throw new Error("THREE.GLTFLoader: Unexpected light type: "+c.type)}return l.position.set(0,0,0),ai(l,c),c.intensity!==void 0&&(l.intensity=c.intensity),l.name=t.createUniqueName(c.name||"light_"+e),i=Promise.resolve(l),t.cache.add(n,i),i}getDependency(e,t){if(e==="light")return this._loadLight(t)}createNodeAttachment(e){let t=this,n=this.parser,r=n.json.nodes[e],o=(r.extensions&&r.extensions[this.name]||{}).light;return o===void 0?null:this._loadLight(o).then(function(c){return n._getNodeRef(t.cache,o,c)})}},Nh=class{constructor(){this.name=at.KHR_MATERIALS_UNLIT}getMaterialType(){return en}extendParams(e,t,n){let i=[];e.color=new ze(1,1,1),e.opacity=1;let r=t.pbrMetallicRoughness;if(r){if(Array.isArray(r.baseColorFactor)){let a=r.baseColorFactor;e.color.setRGB(a[0],a[1],a[2],cn),e.opacity=a[3]}r.baseColorTexture!==void 0&&i.push(n.assignTexture(e,"map",r.baseColorTexture,Ot))}return Promise.all(i)}},Dh=class{constructor(e){this.parser=e,this.name=at.KHR_MATERIALS_EMISSIVE_STRENGTH}extendMaterialParams(e,t){let n=Vt(this.parser,e,this.name);return n===null||n.emissiveStrength!==void 0&&(t.emissiveIntensity=n.emissiveStrength),Promise.resolve()}},Uh=class{constructor(e){this.parser=e,this.name=at.KHR_MATERIALS_CLEARCOAT}getMaterialType(e){return Vt(this.parser,e,this.name)!==null?xn:null}extendMaterialParams(e,t){let n=Vt(this.parser,e,this.name);if(n===null)return Promise.resolve();let i=[];if(n.clearcoatFactor!==void 0&&(t.clearcoat=n.clearcoatFactor),n.clearcoatTexture!==void 0&&i.push(this.parser.assignTexture(t,"clearcoatMap",n.clearcoatTexture)),n.clearcoatRoughnessFactor!==void 0&&(t.clearcoatRoughness=n.clearcoatRoughnessFactor),n.clearcoatRoughnessTexture!==void 0&&i.push(this.parser.assignTexture(t,"clearcoatRoughnessMap",n.clearcoatRoughnessTexture)),n.clearcoatNormalTexture!==void 0&&(i.push(this.parser.assignTexture(t,"clearcoatNormalMap",n.clearcoatNormalTexture)),n.clearcoatNormalTexture.scale!==void 0)){let r=n.clearcoatNormalTexture.scale;t.clearcoatNormalScale=new ve(r,r)}return Promise.all(i)}},Fh=class{constructor(e){this.parser=e,this.name=at.KHR_MATERIALS_DISPERSION}getMaterialType(e){return Vt(this.parser,e,this.name)!==null?xn:null}extendMaterialParams(e,t){let n=Vt(this.parser,e,this.name);return n===null||(t.dispersion=n.dispersion!==void 0?n.dispersion:0),Promise.resolve()}},Oh=class{constructor(e){this.parser=e,this.name=at.KHR_MATERIALS_IRIDESCENCE}getMaterialType(e){return Vt(this.parser,e,this.name)!==null?xn:null}extendMaterialParams(e,t){let n=Vt(this.parser,e,this.name);if(n===null)return Promise.resolve();let i=[];return n.iridescenceFactor!==void 0&&(t.iridescence=n.iridescenceFactor),n.iridescenceTexture!==void 0&&i.push(this.parser.assignTexture(t,"iridescenceMap",n.iridescenceTexture)),n.iridescenceIor!==void 0&&(t.iridescenceIOR=n.iridescenceIor),t.iridescenceThicknessRange===void 0&&(t.iridescenceThicknessRange=[100,400]),n.iridescenceThicknessMinimum!==void 0&&(t.iridescenceThicknessRange[0]=n.iridescenceThicknessMinimum),n.iridescenceThicknessMaximum!==void 0&&(t.iridescenceThicknessRange[1]=n.iridescenceThicknessMaximum),n.iridescenceThicknessTexture!==void 0&&i.push(this.parser.assignTexture(t,"iridescenceThicknessMap",n.iridescenceThicknessTexture)),Promise.all(i)}},Bh=class{constructor(e){this.parser=e,this.name=at.KHR_MATERIALS_SHEEN}getMaterialType(e){return Vt(this.parser,e,this.name)!==null?xn:null}extendMaterialParams(e,t){let n=Vt(this.parser,e,this.name);if(n===null)return Promise.resolve();let i=[];if(t.sheenColor=new ze(0,0,0),t.sheenRoughness=0,t.sheen=1,n.sheenColorFactor!==void 0){let r=n.sheenColorFactor;t.sheenColor.setRGB(r[0],r[1],r[2],cn)}return n.sheenRoughnessFactor!==void 0&&(t.sheenRoughness=n.sheenRoughnessFactor),n.sheenColorTexture!==void 0&&i.push(this.parser.assignTexture(t,"sheenColorMap",n.sheenColorTexture,Ot)),n.sheenRoughnessTexture!==void 0&&i.push(this.parser.assignTexture(t,"sheenRoughnessMap",n.sheenRoughnessTexture)),Promise.all(i)}},zh=class{constructor(e){this.parser=e,this.name=at.KHR_MATERIALS_TRANSMISSION}getMaterialType(e){return Vt(this.parser,e,this.name)!==null?xn:null}extendMaterialParams(e,t){let n=Vt(this.parser,e,this.name);if(n===null)return Promise.resolve();let i=[];return n.transmissionFactor!==void 0&&(t.transmission=n.transmissionFactor),n.transmissionTexture!==void 0&&i.push(this.parser.assignTexture(t,"transmissionMap",n.transmissionTexture)),Promise.all(i)}},Hh=class{constructor(e){this.parser=e,this.name=at.KHR_MATERIALS_VOLUME}getMaterialType(e){return Vt(this.parser,e,this.name)!==null?xn:null}extendMaterialParams(e,t){let n=Vt(this.parser,e,this.name);if(n===null)return Promise.resolve();let i=[];t.thickness=n.thicknessFactor!==void 0?n.thicknessFactor:0,n.thicknessTexture!==void 0&&i.push(this.parser.assignTexture(t,"thicknessMap",n.thicknessTexture)),t.attenuationDistance=n.attenuationDistance||1/0;let r=n.attenuationColor||[1,1,1];return t.attenuationColor=new ze().setRGB(r[0],r[1],r[2],cn),Promise.all(i)}},kh=class{constructor(e){this.parser=e,this.name=at.KHR_MATERIALS_IOR}getMaterialType(e){return Vt(this.parser,e,this.name)!==null?xn:null}extendMaterialParams(e,t){let n=Vt(this.parser,e,this.name);return n===null||(t.ior=n.ior!==void 0?n.ior:1.5,t.ior===0&&(t.ior=1e3)),Promise.resolve()}},Vh=class{constructor(e){this.parser=e,this.name=at.KHR_MATERIALS_SPECULAR}getMaterialType(e){return Vt(this.parser,e,this.name)!==null?xn:null}extendMaterialParams(e,t){let n=Vt(this.parser,e,this.name);if(n===null)return Promise.resolve();let i=[];t.specularIntensity=n.specularFactor!==void 0?n.specularFactor:1,n.specularTexture!==void 0&&i.push(this.parser.assignTexture(t,"specularIntensityMap",n.specularTexture));let r=n.specularColorFactor||[1,1,1];return t.specularColor=new ze().setRGB(r[0],r[1],r[2],cn),n.specularColorTexture!==void 0&&i.push(this.parser.assignTexture(t,"specularColorMap",n.specularColorTexture,Ot)),Promise.all(i)}},Gh=class{constructor(e){this.parser=e,this.name=at.EXT_MATERIALS_BUMP}getMaterialType(e){return Vt(this.parser,e,this.name)!==null?xn:null}extendMaterialParams(e,t){let n=Vt(this.parser,e,this.name);if(n===null)return Promise.resolve();let i=[];return t.bumpScale=n.bumpFactor!==void 0?n.bumpFactor:1,n.bumpTexture!==void 0&&i.push(this.parser.assignTexture(t,"bumpMap",n.bumpTexture)),Promise.all(i)}},Wh=class{constructor(e){this.parser=e,this.name=at.KHR_MATERIALS_ANISOTROPY}getMaterialType(e){return Vt(this.parser,e,this.name)!==null?xn:null}extendMaterialParams(e,t){let n=Vt(this.parser,e,this.name);if(n===null)return Promise.resolve();let i=[];return n.anisotropyStrength!==void 0&&(t.anisotropy=n.anisotropyStrength),n.anisotropyRotation!==void 0&&(t.anisotropyRotation=n.anisotropyRotation),n.anisotropyTexture!==void 0&&i.push(this.parser.assignTexture(t,"anisotropyMap",n.anisotropyTexture)),Promise.all(i)}},Xh=class{constructor(e){this.parser=e,this.name=at.KHR_TEXTURE_BASISU}loadTexture(e){let t=this.parser,n=t.json,i=n.textures[e];if(!i.extensions||!i.extensions[this.name])return null;let r=i.extensions[this.name],a=t.options.ktx2Loader;if(!a){if(n.extensionsRequired&&n.extensionsRequired.indexOf(this.name)>=0)throw new Error("THREE.GLTFLoader: setKTX2Loader must be called before loading KTX2 textures");return null}return t.loadTextureImage(e,r.source,a)}},qh=class{constructor(e){this.parser=e,this.name=at.EXT_TEXTURE_WEBP}loadTexture(e){let t=this.name,n=this.parser,i=n.json,r=i.textures[e];if(!r.extensions||!r.extensions[t])return null;let a=r.extensions[t],o=i.images[a.source],c=n.textureLoader;if(o.uri){let l=n.options.manager.getHandler(o.uri);l!==null&&(c=l)}return n.loadTextureImage(e,a.source,c)}},Yh=class{constructor(e){this.parser=e,this.name=at.EXT_TEXTURE_AVIF}loadTexture(e){let t=this.name,n=this.parser,i=n.json,r=i.textures[e];if(!r.extensions||!r.extensions[t])return null;let a=r.extensions[t],o=i.images[a.source],c=n.textureLoader;if(o.uri){let l=n.options.manager.getHandler(o.uri);l!==null&&(c=l)}return n.loadTextureImage(e,a.source,c)}},Wc=class{constructor(e,t){this.name=t,this.parser=e}loadBufferView(e){let t=this.parser.json,n=t.bufferViews[e];if(n.extensions&&n.extensions[this.name]){let i=n.extensions[this.name],r=this.parser.getDependency("buffer",i.buffer),a=this.parser.options.meshoptDecoder;if(!a||!a.supported){if(t.extensionsRequired&&t.extensionsRequired.indexOf(this.name)>=0)throw new Error("THREE.GLTFLoader: setMeshoptDecoder must be called before loading compressed files");return null}return r.then(function(o){let c=i.byteOffset||0,l=i.byteLength||0,h=i.count,u=i.byteStride,d=new Uint8Array(o,c,l);return a.decodeGltfBufferAsync?a.decodeGltfBufferAsync(h,u,d,i.mode,i.filter).then(function(f){return f.buffer}):a.ready.then(function(){let f=new ArrayBuffer(h*u);return a.decodeGltfBuffer(new Uint8Array(f),h,u,d,i.mode,i.filter),f})})}else return null}},Zh=class{constructor(e){this.name=at.EXT_MESH_GPU_INSTANCING,this.parser=e}createNodeMesh(e){let t=this.parser.json,n=t.nodes[e];if(!n.extensions||!n.extensions[this.name]||n.mesh===void 0)return null;let i=t.meshes[n.mesh];for(let l of i.primitives)if(l.mode!==Ln.TRIANGLES&&l.mode!==Ln.TRIANGLE_STRIP&&l.mode!==Ln.TRIANGLE_FAN&&l.mode!==void 0)return null;let a=n.extensions[this.name].attributes,o=[],c={};for(let l in a)o.push(this.parser.getDependency("accessor",a[l]).then(h=>(c[l]=h,c[l])));return o.length<1?null:(o.push(this.parser.createNodeMesh(e)),Promise.all(o).then(l=>{let h=l.pop(),u=h.isGroup?h.children:[h],d=l[0].count,f=[];for(let g of u){let v=new Ze,m=new C,p=new rn,S=new C(1,1,1),w=new ea(g.geometry,g.material,d);for(let b=0;b<d;b++)c.TRANSLATION&&m.fromBufferAttribute(c.TRANSLATION,b),c.ROTATION&&p.fromBufferAttribute(c.ROTATION,b),c.SCALE&&S.fromBufferAttribute(c.SCALE,b),w.setMatrixAt(b,v.compose(m,p,S));let y=null;for(let b in c)if(b==="_COLOR_0"){let T=c[b];w.instanceColor=new yi(T.array,T.itemSize,T.normalized)}else if(b!=="TRANSLATION"&&b!=="ROTATION"&&b!=="SCALE"){if(y===null){let A=w.geometry;y=new Et,y.name=A.name;for(let x in A.attributes)y.setAttribute(x,A.attributes[x]);for(let x in A.morphAttributes)y.morphAttributes[x]=A.morphAttributes[x];A.index!==null&&y.setIndex(A.index),y.morphTargetsRelative=A.morphTargetsRelative;for(let x of A.groups)y.addGroup(x.start,x.count,x.materialIndex);A.boundingBox!==null&&(y.boundingBox=A.boundingBox.clone()),A.boundingSphere!==null&&(y.boundingSphere=A.boundingSphere.clone()),y.drawRange.start=A.drawRange.start,y.drawRange.count=A.drawRange.count,y.userData=Object.assign({},A.userData),w.geometry=y}let T=c[b];y.setAttribute(b,new yi(T.array,T.itemSize,T.normalized))}wt.prototype.copy.call(w,g),this.parser.assignFinalMaterial(w),f.push(w)}return h.isGroup?(h.clear(),h.add(...f),h):f[0]}))}},_f="glTF",Ia=12,ff={JSON:1313821514,BIN:5130562},Kh=class{constructor(e){this.name=at.KHR_BINARY_GLTF,this.content=null,this.body=null;let t=new DataView(e,0,Ia),n=new TextDecoder;if(this.header={magic:n.decode(new Uint8Array(e.slice(0,4))),version:t.getUint32(4,!0),length:t.getUint32(8,!0)},this.header.magic!==_f)throw new Error("THREE.GLTFLoader: Unsupported glTF-Binary header.");if(this.header.version<2)throw new Error("THREE.GLTFLoader: Legacy binary file detected.");let i=this.header.length-Ia,r=new DataView(e,Ia),a=0;for(;a<i;){let o=r.getUint32(a,!0);a+=4;let c=r.getUint32(a,!0);if(a+=4,c===ff.JSON){let l=new Uint8Array(e,Ia+a,o);this.content=n.decode(l)}else if(c===ff.BIN){let l=Ia+a;this.body=e.slice(l,l+o)}a+=o}if(this.content===null)throw new Error("THREE.GLTFLoader: JSON content not found.")}},Jh=class{constructor(e,t){if(!t)throw new Error("THREE.GLTFLoader: No DRACOLoader instance provided.");this.name=at.KHR_DRACO_MESH_COMPRESSION,this.json=e,this.dracoLoader=t,this.dracoLoader.preload()}decodePrimitive(e,t){let n=this.json,i=this.dracoLoader,r=e.extensions[this.name].bufferView,a=e.extensions[this.name].attributes,o={},c={},l={};for(let h in a){let u=eu[h]||h.toLowerCase();o[u]=a[h]}for(let h in e.attributes){let u=eu[h]||h.toLowerCase();if(a[h]!==void 0){let d=n.accessors[e.attributes[h]],f=br[d.componentType];l[u]=f.name,c[u]=d.normalized===!0}}return t.getDependency("bufferView",r).then(function(h){return new Promise(function(u,d){i.decodeDracoFile(h,function(f){for(let g in f.attributes){let v=f.attributes[g],m=c[g];m!==void 0&&(v.normalized=m)}u(f)},o,l,cn,d)})})}},$h=class{constructor(){this.name=at.KHR_TEXTURE_TRANSFORM}extendTexture(e,t){if((t.texCoord===void 0||t.texCoord===e.channel)&&t.offset===void 0&&t.rotation===void 0&&t.scale===void 0)return e;if(e=e.clone(),t.texCoord!==void 0&&(e.channel=t.texCoord),t.offset!==void 0&&e.offset.fromArray(t.offset),t.rotation!==void 0&&(e.rotation=t.rotation),t.scale!==void 0&&e.repeat.fromArray(t.scale),t.rotation!==void 0){let n=Math.cos(e.rotation),i=Math.sin(e.rotation);e.matrix.set(e.repeat.x*n,e.repeat.y*i,e.offset.x,-e.repeat.x*i,e.repeat.y*n,e.offset.y,0,0,1),e.matrixAutoUpdate=!1}return e.needsUpdate=!0,e}},jh=class{constructor(){this.name=at.KHR_MESH_QUANTIZATION}},Xc=class extends ei{constructor(e,t,n,i){super(e,t,n,i)}copySampleValue_(e){let t=this.resultBuffer,n=this.sampleValues,i=this.valueSize,r=e*i*3+i;for(let a=0;a!==i;a++)t[a]=n[r+a];return t}interpolate_(e,t,n,i){let r=this.resultBuffer,a=this.sampleValues,o=this.valueSize,c=o*2,l=o*3,h=i-t,u=(n-t)/h,d=u*u,f=d*u,g=e*l,v=g-l,m=-2*f+3*d,p=f-d,S=1-m,w=p-d+u;for(let y=0;y!==o;y++){let b=a[v+y+o],T=a[v+y+c]*h,A=a[g+y+o],x=a[g+y]*h;r[y]=S*b+w*T+m*A+p*x}return r}},kx=new rn,Qh=class extends Xc{interpolate_(e,t,n,i){let r=super.interpolate_(e,t,n,i);return kx.fromArray(r).normalize().toArray(r),r}},Ln={FLOAT:5126,FLOAT_MAT3:35675,FLOAT_MAT4:35676,FLOAT_VEC2:35664,FLOAT_VEC3:35665,FLOAT_VEC4:35666,LINEAR:9729,REPEAT:10497,SAMPLER_2D:35678,POINTS:0,LINES:1,LINE_LOOP:2,LINE_STRIP:3,TRIANGLES:4,TRIANGLE_STRIP:5,TRIANGLE_FAN:6,UNSIGNED_BYTE:5121,UNSIGNED_SHORT:5123},br={5120:Int8Array,5121:Uint8Array,5122:Int16Array,5123:Uint16Array,5125:Uint32Array,5126:Float32Array},pf={9728:zt,9729:Ht,9984:Yo,9985:mr,9986:Ms,9987:Xn},mf={33071:Cn,33648:Js,10497:zi},Ch={SCALAR:1,VEC2:2,VEC3:3,VEC4:4,MAT2:4,MAT3:9,MAT4:16},eu={POSITION:"position",NORMAL:"normal",TANGENT:"tangent",TEXCOORD_0:"uv",TEXCOORD_1:"uv1",TEXCOORD_2:"uv2",TEXCOORD_3:"uv3",COLOR_0:"color",WEIGHTS_0:"skinWeight",JOINTS_0:"skinIndex"},Ji={scale:"scale",translation:"position",rotation:"quaternion",weights:"morphTargetInfluences"},Vx={CUBICSPLINE:void 0,LINEAR:cs,STEP:os},Ih={OPAQUE:"OPAQUE",MASK:"MASK",BLEND:"BLEND"};function Gx(s){return s.DefaultMaterial===void 0&&(s.DefaultMaterial=new kt({color:16777215,emissive:0,metalness:1,roughness:1,transparent:!1,depthTest:!0,side:ni})),s.DefaultMaterial}function Ts(s,e,t){for(let n in t.extensions)s[n]===void 0&&(e.userData.gltfExtensions=e.userData.gltfExtensions||{},e.userData.gltfExtensions[n]=t.extensions[n])}function ai(s,e){e.extras!==void 0&&(typeof e.extras=="object"?Object.assign(s.userData,e.extras):console.warn("THREE.GLTFLoader: Ignoring primitive type .extras, "+e.extras))}function Wx(s,e,t){let n=!1,i=!1,r=!1;for(let l=0,h=e.length;l<h;l++){let u=e[l];if(u.POSITION!==void 0&&(n=!0),u.NORMAL!==void 0&&(i=!0),u.COLOR_0!==void 0&&(r=!0),n&&i&&r)break}if(!n&&!i&&!r)return Promise.resolve(s);let a=[],o=[],c=[];for(let l=0,h=e.length;l<h;l++){let u=e[l];if(n){let d=u.POSITION!==void 0?t.getDependency("accessor",u.POSITION):s.attributes.position;a.push(d)}if(i){let d=u.NORMAL!==void 0?t.getDependency("accessor",u.NORMAL):s.attributes.normal;o.push(d)}if(r){let d=u.COLOR_0!==void 0?t.getDependency("accessor",u.COLOR_0):s.attributes.color;c.push(d)}}return Promise.all([Promise.all(a),Promise.all(o),Promise.all(c)]).then(function(l){let h=l[0],u=l[1],d=l[2];return n&&(s.morphAttributes.position=h),i&&(s.morphAttributes.normal=u),r&&(s.morphAttributes.color=d),s.morphTargetsRelative=!0,s})}function Xx(s,e){if(s.updateMorphTargets(),e.weights!==void 0)for(let t=0,n=e.weights.length;t<n;t++)s.morphTargetInfluences[t]=e.weights[t];if(e.extras&&Array.isArray(e.extras.targetNames)){let t=e.extras.targetNames;if(s.morphTargetInfluences.length===t.length){s.morphTargetDictionary={};for(let n=0,i=t.length;n<i;n++)s.morphTargetDictionary[t[n]]=n}else console.warn("THREE.GLTFLoader: Invalid extras.targetNames length. Ignoring names.")}}function qx(s){let e,t=s.extensions&&s.extensions[at.KHR_DRACO_MESH_COMPRESSION];if(t?e="draco:"+t.bufferView+":"+t.indices+":"+Ph(t.attributes):e=s.indices+":"+Ph(s.attributes)+":"+s.mode,s.targets!==void 0)for(let n=0,i=s.targets.length;n<i;n++)e+=":"+Ph(s.targets[n]);return e}function Ph(s){let e="",t=Object.keys(s).sort();for(let n=0,i=t.length;n<i;n++)e+=t[n]+":"+s[t[n]]+";";return e}function tu(s){switch(s){case Int8Array:return 1/127;case Uint8Array:return 1/255;case Int16Array:return 1/32767;case Uint16Array:return 1/65535;default:throw new Error("THREE.GLTFLoader: Unsupported normalized accessor component type.")}}function Yx(s){return s.search(/\.jpe?g($|\?)/i)>0||s.search(/^data\:image\/jpeg/)===0?"image/jpeg":s.search(/\.webp($|\?)/i)>0||s.search(/^data\:image\/webp/)===0?"image/webp":s.search(/\.ktx2($|\?)/i)>0||s.search(/^data\:image\/ktx2/)===0?"image/ktx2":"image/png"}var Zx=new Ze,nu=class{constructor(e={},t={}){this.json=e,this.extensions={},this.plugins={},this.options=t,this.cache=new Hx,this.associations=new Map,this.primitiveCache={},this.nodeCache={},this.meshCache={refs:{},uses:{}},this.cameraCache={refs:{},uses:{}},this.lightCache={refs:{},uses:{}},this.sourceCache={},this.textureCache={},this.nodeNamesUsed={};let n=!1,i=-1,r=!1,a=-1;if(typeof navigator<"u"&&typeof navigator.userAgent<"u"){let o=navigator.userAgent;n=/^((?!chrome|android).)*safari/i.test(o)===!0;let c=o.match(/Version\/(\d+)/);i=n&&c?parseInt(c[1],10):-1,r=o.indexOf("Firefox")>-1,a=r?o.match(/Firefox\/([0-9]+)\./)[1]:-1}typeof createImageBitmap>"u"||n&&i<17||r&&a<98?this.textureLoader=new da(this.options.manager):this.textureLoader=new ga(this.options.manager),this.textureLoader.setCrossOrigin(this.options.crossOrigin),this.textureLoader.setRequestHeader(this.options.requestHeader),this.fileLoader=new hr(this.options.manager),this.fileLoader.setResponseType("arraybuffer"),this.options.crossOrigin==="use-credentials"&&this.fileLoader.setWithCredentials(!0)}setExtensions(e){this.extensions=e}setPlugins(e){this.plugins=e}parse(e,t){let n=this,i=this.json,r=this.extensions;this.cache.removeAll(),this.nodeCache={},this._invokeAll(function(a){return a._markDefs&&a._markDefs()}),Promise.all(this._invokeAll(function(a){return a.beforeRoot&&a.beforeRoot()})).then(function(){return Promise.all([n.getDependencies("scene"),n.getDependencies("animation"),n.getDependencies("camera")])}).then(function(a){let o={scene:a[0][i.scene||0],scenes:a[0],animations:a[1],cameras:a[2],asset:i.asset,parser:n,userData:{}};return Ts(r,o,i),ai(o,i),Promise.all(n._invokeAll(function(c){return c.afterRoot&&c.afterRoot(o)})).then(function(){for(let c of o.scenes)c.updateMatrixWorld();e(o)})}).catch(t)}_markDefs(){let e=this.json.nodes||[],t=this.json.skins||[],n=this.json.meshes||[];for(let i=0,r=t.length;i<r;i++){let a=t[i].joints;for(let o=0,c=a.length;o<c;o++)e[a[o]].isBone=!0}for(let i=0,r=e.length;i<r;i++){let a=e[i];a.mesh!==void 0&&(this._addNodeRef(this.meshCache,a.mesh),a.skin!==void 0&&(n[a.mesh].isSkinnedMesh=!0)),a.camera!==void 0&&this._addNodeRef(this.cameraCache,a.camera)}}_addNodeRef(e,t){t!==void 0&&(e.refs[t]===void 0&&(e.refs[t]=e.uses[t]=0),e.refs[t]++)}_getNodeRef(e,t,n){if(e.refs[t]<=1)return n;let i=n.clone(),r=(a,o)=>{let c=this.associations.get(a);c!=null&&this.associations.set(o,c);for(let[l,h]of a.children.entries())r(h,o.children[l])};return r(n,i),i.name+="_instance_"+e.uses[t]++,i}_invokeOne(e){let t=Object.values(this.plugins);t.push(this);for(let n=0;n<t.length;n++){let i=e(t[n]);if(i)return i}return null}_invokeAll(e){let t=Object.values(this.plugins);t.unshift(this);let n=[];for(let i=0;i<t.length;i++){let r=e(t[i]);r&&n.push(r)}return n}getDependency(e,t){let n=e+":"+t,i=this.cache.get(n);if(!i){switch(e){case"scene":i=this.loadScene(t);break;case"node":i=this._invokeOne(function(r){return r.loadNode&&r.loadNode(t)});break;case"mesh":i=this._invokeOne(function(r){return r.loadMesh&&r.loadMesh(t)});break;case"accessor":i=this.loadAccessor(t);break;case"bufferView":i=this._invokeOne(function(r){return r.loadBufferView&&r.loadBufferView(t)});break;case"buffer":i=this.loadBuffer(t);break;case"material":i=this._invokeOne(function(r){return r.loadMaterial&&r.loadMaterial(t)});break;case"texture":i=this._invokeOne(function(r){return r.loadTexture&&r.loadTexture(t)});break;case"skin":i=this.loadSkin(t);break;case"animation":i=this._invokeOne(function(r){return r.loadAnimation&&r.loadAnimation(t)});break;case"camera":i=this.loadCamera(t);break;default:if(i=this._invokeOne(function(r){return r!=this&&r.getDependency&&r.getDependency(e,t)}),!i)throw new Error("Unknown type: "+e);break}this.cache.add(n,i)}return i}getDependencies(e){let t=this.cache.get(e);if(!t){let n=this,i=this.json[e+(e==="mesh"?"es":"s")]||[];t=Promise.all(i.map(function(r,a){return n.getDependency(e,a)})),this.cache.add(e,t)}return t}loadBuffer(e){let t=this.json.buffers[e],n=this.fileLoader;if(t.type&&t.type!=="arraybuffer")throw new Error("THREE.GLTFLoader: "+t.type+" buffer type is not supported.");if(t.uri===void 0&&e===0)return Promise.resolve(this.extensions[at.KHR_BINARY_GLTF].body);let i=this.options;return new Promise(function(r,a){n.load(wi.resolveURL(t.uri,i.path),r,void 0,function(){a(new Error('THREE.GLTFLoader: Failed to load buffer "'+t.uri+'".'))})})}loadBufferView(e){let t=this.json.bufferViews[e];return this.getDependency("buffer",t.buffer).then(function(n){let i=t.byteLength||0,r=t.byteOffset||0;return n.slice(r,r+i)})}loadAccessor(e){let t=this,n=this.json,i=this.json.accessors[e];if(i.bufferView===void 0&&i.sparse===void 0){let a=Ch[i.type],o=br[i.componentType],c=i.normalized===!0,l=new o(i.count*a);return Promise.resolve(new Bt(l,a,c))}let r=[];return i.bufferView!==void 0?r.push(this.getDependency("bufferView",i.bufferView)):r.push(null),i.sparse!==void 0&&(r.push(this.getDependency("bufferView",i.sparse.indices.bufferView)),r.push(this.getDependency("bufferView",i.sparse.values.bufferView))),Promise.all(r).then(function(a){let o=a[0],c=Ch[i.type],l=br[i.componentType],h=l.BYTES_PER_ELEMENT,u=h*c,d=i.byteOffset||0,f=i.bufferView!==void 0?n.bufferViews[i.bufferView].byteStride:void 0,g=i.normalized===!0,v,m;if(f&&f!==u){let p=Math.floor(d/f),S="InterleavedBuffer:"+i.bufferView+":"+i.componentType+":"+p+":"+i.count,w=t.cache.get(S);w||(v=new l(o,p*f,i.count*f/h),w=new hs(v,f/h),t.cache.add(S,w)),m=new Hi(w,c,d%f/h,g)}else o===null?v=new l(i.count*c):v=new l(o,d,i.count*c),m=new Bt(v,c,g);if(i.sparse!==void 0){let p=Ch.SCALAR,S=br[i.sparse.indices.componentType],w=i.sparse.indices.byteOffset||0,y=i.sparse.values.byteOffset||0,b=new S(a[1],w,i.sparse.count*p),T=new l(a[2],y,i.sparse.count*c);o!==null&&(m=new Bt(m.array.slice(),m.itemSize,m.normalized)),m.normalized=!1;for(let A=0,x=b.length;A<x;A++){let E=b[A];if(m.setX(E,T[A*c]),c>=2&&m.setY(E,T[A*c+1]),c>=3&&m.setZ(E,T[A*c+2]),c>=4&&m.setW(E,T[A*c+3]),c>=5)throw new Error("THREE.GLTFLoader: Unsupported itemSize in sparse BufferAttribute.")}m.normalized=g}return m})}loadTexture(e){let t=this.json,n=this.options,r=t.textures[e].source,a=t.images[r],o=this.textureLoader;if(a.uri){let c=n.manager.getHandler(a.uri);c!==null&&(o=c)}return this.loadTextureImage(e,r,o)}loadTextureImage(e,t,n){let i=this,r=this.json,a=r.textures[e],o=r.images[t],c=(o.uri||o.bufferView)+":"+a.sampler;if(this.textureCache[c])return this.textureCache[c];let l=this.loadImageSource(t,n).then(function(h){h.flipY=!1,h.name=a.name||o.name||"",h.name===""&&typeof o.uri=="string"&&o.uri.startsWith("data:image/")===!1&&(h.name=o.uri);let d=(r.samplers||{})[a.sampler]||{};return h.magFilter=pf[d.magFilter]||Ht,h.minFilter=pf[d.minFilter]||Xn,h.wrapS=mf[d.wrapS]||zi,h.wrapT=mf[d.wrapT]||zi,h.generateMipmaps=!h.isCompressedTexture&&h.minFilter!==zt&&h.minFilter!==Ht,i.associations.set(h,{textures:e}),h}).catch(function(){return null});return this.textureCache[c]=l,l}loadImageSource(e,t){let n=this,i=this.json,r=this.options;if(this.sourceCache[e]!==void 0)return this.sourceCache[e].then(u=>u.clone());let a=i.images[e],o=self.URL||self.webkitURL,c=a.uri||"",l=!1;if(a.bufferView!==void 0)c=n.getDependency("bufferView",a.bufferView).then(function(u){l=!0;let d=new Blob([u],{type:a.mimeType});return c=o.createObjectURL(d),c});else if(a.uri===void 0)throw new Error("THREE.GLTFLoader: Image "+e+" is missing URI and bufferView");let h=Promise.resolve(c).then(function(u){return new Promise(function(d,f){let g=d;t.isImageBitmapLoader===!0&&(g=function(v){let m=new Yt(v);m.needsUpdate=!0,d(m)}),t.load(wi.resolveURL(u,r.path),g,void 0,f)})}).then(function(u){return l===!0&&o.revokeObjectURL(c),ai(u,a),u.userData.mimeType=a.mimeType||Yx(a.uri),u}).catch(function(u){throw console.error("THREE.GLTFLoader: Couldn't load texture",c),u});return this.sourceCache[e]=h,h}assignTexture(e,t,n,i){let r=this;return this.getDependency("texture",n.index).then(function(a){if(!a)return null;if(n.texCoord!==void 0&&n.texCoord>0&&(a=a.clone(),a.channel=n.texCoord),r.extensions[at.KHR_TEXTURE_TRANSFORM]){let o=n.extensions!==void 0?n.extensions[at.KHR_TEXTURE_TRANSFORM]:void 0;if(o){let c=r.associations.get(a);a=r.extensions[at.KHR_TEXTURE_TRANSFORM].extendTexture(a,o),r.associations.set(a,c)}}return i!==void 0&&(a.colorSpace=i),e[t]=a,a})}assignFinalMaterial(e){let t=e.geometry,n=e.material,i=t.attributes.tangent===void 0,r=t.attributes.color!==void 0,a=t.attributes.normal===void 0;if(e.isPoints){let o="PointsMaterial:"+n.uuid,c=this.cache.get(o);c||(c=new ki,hn.prototype.copy.call(c,n),c.color.copy(n.color),c.map=n.map,c.sizeAttenuation=!1,this.cache.add(o,c)),n=c}else if(e.isLine){let o="LineBasicMaterial:"+n.uuid,c=this.cache.get(o);c||(c=new vi,hn.prototype.copy.call(c,n),c.color.copy(n.color),c.map=n.map,this.cache.add(o,c)),n=c}if(i||r||a){let o="ClonedMaterial:"+n.uuid+":";i&&(o+="derivative-tangents:"),r&&(o+="vertex-colors:"),a&&(o+="flat-shading:");let c=this.cache.get(o);c||(c=n.clone(),r&&(c.vertexColors=!0),a&&(c.flatShading=!0),i&&(c.normalScale&&(c.normalScale.y*=-1),c.clearcoatNormalScale&&(c.clearcoatNormalScale.y*=-1)),this.cache.add(o,c),this.associations.set(c,this.associations.get(n))),n=c}e.material=n}getMaterialType(){return kt}loadMaterial(e){let t=this,n=this.json,i=this.extensions,r=n.materials[e],a,o={},c=r.extensions||{},l=[];if(c[at.KHR_MATERIALS_UNLIT]){let u=i[at.KHR_MATERIALS_UNLIT];a=u.getMaterialType(),l.push(u.extendParams(o,r,t))}else{let u=r.pbrMetallicRoughness||{};if(o.color=new ze(1,1,1),o.opacity=1,Array.isArray(u.baseColorFactor)){let d=u.baseColorFactor;o.color.setRGB(d[0],d[1],d[2],cn),o.opacity=d[3]}u.baseColorTexture!==void 0&&l.push(t.assignTexture(o,"map",u.baseColorTexture,Ot)),o.metalness=u.metallicFactor!==void 0?u.metallicFactor:1,o.roughness=u.roughnessFactor!==void 0?u.roughnessFactor:1,u.metallicRoughnessTexture!==void 0&&(l.push(t.assignTexture(o,"metalnessMap",u.metallicRoughnessTexture)),l.push(t.assignTexture(o,"roughnessMap",u.metallicRoughnessTexture))),a=this._invokeOne(function(d){return d.getMaterialType&&d.getMaterialType(e)}),l.push(Promise.all(this._invokeAll(function(d){return d.extendMaterialParams&&d.extendMaterialParams(e,o)})))}r.doubleSided===!0&&(o.side=tn);let h=r.alphaMode||Ih.OPAQUE;if(h===Ih.BLEND?(o.transparent=!0,o.depthWrite=!1):(o.transparent=!1,h===Ih.MASK&&(o.alphaTest=r.alphaCutoff!==void 0?r.alphaCutoff:.5)),r.normalTexture!==void 0&&a!==en&&(l.push(t.assignTexture(o,"normalMap",r.normalTexture)),o.normalScale=new ve(1,1),r.normalTexture.scale!==void 0)){let u=r.normalTexture.scale;o.normalScale.set(u,u)}if(r.occlusionTexture!==void 0&&a!==en&&(l.push(t.assignTexture(o,"aoMap",r.occlusionTexture)),r.occlusionTexture.strength!==void 0&&(o.aoMapIntensity=r.occlusionTexture.strength)),r.emissiveFactor!==void 0&&a!==en){let u=r.emissiveFactor;o.emissive=new ze().setRGB(u[0],u[1],u[2],cn)}return r.emissiveTexture!==void 0&&a!==en&&l.push(t.assignTexture(o,"emissiveMap",r.emissiveTexture,Ot)),Promise.all(l).then(function(){let u=new a(o);return r.name&&(u.name=r.name),ai(u,r),t.associations.set(u,{materials:e}),r.extensions&&Ts(i,u,r),u})}createUniqueName(e){let t=Tt.sanitizeNodeName(e||"");return t in this.nodeNamesUsed?t+"_"+ ++this.nodeNamesUsed[t]:(this.nodeNamesUsed[t]=0,t)}loadGeometries(e){let t=this,n=this.extensions,i=this.primitiveCache;function r(o){return n[at.KHR_DRACO_MESH_COMPRESSION].decodePrimitive(o,t).then(function(c){return gf(c,o,t)})}let a=[];for(let o=0,c=e.length;o<c;o++){let l=e[o],h=qx(l),u=i[h];if(u)a.push(u.promise);else{let d;l.extensions&&l.extensions[at.KHR_DRACO_MESH_COMPRESSION]?d=r(l):d=gf(new Et,l,t),l.mode===Ln.TRIANGLE_STRIP?d=d.then(f=>Rh(f,wa)):l.mode===Ln.TRIANGLE_FAN&&(d=d.then(f=>Rh(f,xr))),i[h]={primitive:l,promise:d},a.push(d)}}return Promise.all(a)}loadMesh(e){let t=this,n=this.json,i=this.extensions,r=n.meshes[e],a=r.primitives,o=[];for(let c=0,l=a.length;c<l;c++){let h=a[c].material===void 0?Gx(this.cache):this.getDependency("material",a[c].material);o.push(h)}return o.push(t.loadGeometries(a)),Promise.all(o).then(async function(c){let l=c.slice(0,c.length-1),h=c[c.length-1],u=[];for(let f=0,g=h.length;f<g;f++){let v=h[f],m=a[f],p,S=l[f];if(m.mode===Ln.TRIANGLES||m.mode===Ln.TRIANGLE_STRIP||m.mode===Ln.TRIANGLE_FAN||m.mode===void 0){let w=r.isSkinnedMesh===!0,y=v.hasAttribute("skinIndex")&&v.hasAttribute("skinWeight");w&&y===!1&&console.warn("THREE.GLTFLoader: Missing skinIndex or skinWeight attributes. Skinning disabled."),p=w&&y?new jr(v,S):new Ge(v,S),p.isSkinnedMesh===!0&&p.normalizeSkinWeights()}else if(m.mode===Ln.LINES)p=new ta(v,S);else if(m.mode===Ln.LINE_STRIP)p=new Qn(v,S);else if(m.mode===Ln.LINE_LOOP)p=new na(v,S);else if(m.mode===Ln.POINTS)p=new ds(v,S);else throw new Error("THREE.GLTFLoader: Primitive mode unsupported: "+m.mode);Object.keys(p.geometry.morphAttributes).length>0&&Xx(p,r),p.name=t.createUniqueName(r.name||"mesh_"+e),ai(p,r),m.extensions&&Ts(i,p,m),t.assignFinalMaterial(p),u.push(p)}for(let f=0,g=u.length;f<g;f++)t.associations.set(u[f],{meshes:e,primitives:f});if(u.length===1)return r.extensions&&Ts(i,u[0],r),u[0];let d=new Xt;r.extensions&&Ts(i,d,r),t.associations.set(d,{meshes:e});for(let f=0,g=u.length;f<g;f++)d.add(u[f]);return d})}loadCamera(e){let t,n=this.json.cameras[e],i=n[n.type];if(!i){console.warn("THREE.GLTFLoader: Missing camera parameters.");return}return n.type==="perspective"?t=new Wt(Pn.radToDeg(i.yfov),i.aspectRatio||1,i.znear||1,i.zfar||2e6):n.type==="orthographic"&&(t=new Xi(-i.xmag,i.xmag,i.ymag,-i.ymag,i.znear,i.zfar)),n.name&&(t.name=this.createUniqueName(n.name)),ai(t,n),Promise.resolve(t)}loadSkin(e){let t=this.json.skins[e],n=[];for(let i=0,r=t.joints.length;i<r;i++)n.push(this._loadNodeShallow(t.joints[i]));return t.inverseBindMatrices!==void 0?n.push(this.getDependency("accessor",t.inverseBindMatrices)):n.push(null),Promise.all(n).then(function(i){let r=i.pop(),a=i,o=[],c=[];for(let l=0,h=a.length;l<h;l++){let u=a[l];if(u){o.push(u);let d=new Ze;r!==null&&d.fromArray(r.array,l*16),c.push(d)}else console.warn('THREE.GLTFLoader: Joint "%s" could not be found.',t.joints[l])}return new Qr(o,c)})}loadAnimation(e){let t=this.json,n=this,i=t.animations[e],r=i.name?i.name:"animation_"+e,a=[],o=[],c=[],l=[],h=[];for(let u=0,d=i.channels.length;u<d;u++){let f=i.channels[u],g=i.samplers[f.sampler],v=f.target,m=v.node,p=i.parameters!==void 0?i.parameters[g.input]:g.input,S=i.parameters!==void 0?i.parameters[g.output]:g.output;v.node!==void 0&&(a.push(this.getDependency("node",m)),o.push(this.getDependency("accessor",p)),c.push(this.getDependency("accessor",S)),l.push(g),h.push(v))}return Promise.all([Promise.all(a),Promise.all(o),Promise.all(c),Promise.all(l),Promise.all(h)]).then(function(u){let d=u[0],f=u[1],g=u[2],v=u[3],m=u[4],p=[];for(let w=0,y=d.length;w<y;w++){let b=d[w],T=f[w],A=g[w],x=v[w],E=m[w];if(b===void 0)continue;b.updateMatrix&&b.updateMatrix();let I=n._createAnimationTracks(b,T,A,x,E);if(I)for(let U=0;U<I.length;U++)p.push(I[U])}let S=new Ei(r,void 0,p);return ai(S,i),S})}createNodeMesh(e){let t=this.json,n=this,i=t.nodes[e];return i.mesh===void 0?null:n.getDependency("mesh",i.mesh).then(function(r){let a=n._getNodeRef(n.meshCache,i.mesh,r);return i.weights!==void 0&&a.traverse(function(o){if(o.isMesh)for(let c=0,l=i.weights.length;c<l;c++)o.morphTargetInfluences[c]=i.weights[c]}),a})}loadNode(e){let t=this.json,n=this,i=t.nodes[e],r=n._loadNodeShallow(e),a=[],o=i.children||[];for(let l=0,h=o.length;l<h;l++)a.push(n.getDependency("node",o[l]));let c=i.skin===void 0?Promise.resolve(null):n.getDependency("skin",i.skin);return Promise.all([r,Promise.all(a),c]).then(function(l){let h=l[0],u=l[1],d=l[2];d!==null&&h.traverse(function(f){f.isSkinnedMesh&&f.bind(d,Zx)});for(let f=0,g=u.length;f<g;f++)h.add(u[f]);if(h.userData.pivot!==void 0&&u.length>0){let f=h.userData.pivot,g=u[0];h.pivot=new C().fromArray(f),h.position.x-=f[0],h.position.y-=f[1],h.position.z-=f[2],g.position.set(0,0,0),delete h.userData.pivot}return h})}_loadNodeShallow(e){let t=this.json,n=this.extensions,i=this;if(this.nodeCache[e]!==void 0)return this.nodeCache[e];let r=t.nodes[e],a=r.name?i.createUniqueName(r.name):"",o=[],c=i._invokeOne(function(l){return l.createNodeMesh&&l.createNodeMesh(e)});return c&&o.push(c),r.camera!==void 0&&o.push(i.getDependency("camera",r.camera).then(function(l){return i._getNodeRef(i.cameraCache,r.camera,l)})),i._invokeAll(function(l){return l.createNodeAttachment&&l.createNodeAttachment(e)}).forEach(function(l){o.push(l)}),this.nodeCache[e]=Promise.all(o).then(function(l){let h;if(r.isBone===!0?h=new ir:l.length>1?h=new Xt:l.length===1?h=l[0]:h=new wt,h!==l[0])for(let u=0,d=l.length;u<d;u++)h.add(l[u]);if(r.name&&(h.userData.name=r.name,h.name=a),ai(h,r),r.extensions&&Ts(n,h,r),r.matrix!==void 0){let u=new Ze;u.fromArray(r.matrix),h.applyMatrix4(u)}else r.translation!==void 0&&h.position.fromArray(r.translation),r.rotation!==void 0&&h.quaternion.fromArray(r.rotation),r.scale!==void 0&&h.scale.fromArray(r.scale);if(!i.associations.has(h))i.associations.set(h,{});else if(r.mesh!==void 0&&i.meshCache.refs[r.mesh]>1){let u=i.associations.get(h);i.associations.set(h,{...u})}return i.associations.get(h).nodes=e,h}),this.nodeCache[e]}loadScene(e){let t=this.extensions,n=this.json.scenes[e],i=this,r=new Xt;n.name&&(r.name=i.createUniqueName(n.name)),ai(r,n),n.extensions&&Ts(t,r,n);let a=n.nodes||[],o=[];for(let c=0,l=a.length;c<l;c++)o.push(i.getDependency("node",a[c]));return Promise.all(o).then(function(c){for(let h=0,u=c.length;h<u;h++){let d=c[h];d.parent!==null?r.add(Vc(d)):r.add(d)}let l=h=>{let u=new Map;for(let[d,f]of i.associations)(d instanceof hn||d instanceof Yt)&&u.set(d,f);return h.traverse(d=>{let f=i.associations.get(d);f!=null&&u.set(d,f)}),u};return i.associations=l(r),r})}_createAnimationTracks(e,t,n,i,r){let a=[],o=e.name?e.name:e.uuid,c=[];function l(f){f.morphTargetInfluences&&c.push(f.name?f.name:f.uuid)}Ji[r.path]===Ji.weights?(l(e),e.isGroup&&e.children.forEach(l)):c.push(o);let h;switch(Ji[r.path]){case Ji.weights:h=Si;break;case Ji.rotation:h=bi;break;case Ji.translation:case Ji.scale:h=Wi;break;default:n.itemSize===1?h=Si:h=Wi;break}let u=i.interpolation!==void 0?Vx[i.interpolation]:cs,d=this._getArrayFromAccessor(n);for(let f=0,g=c.length;f<g;f++){let v=new h(c[f]+"."+Ji[r.path],t.array,d,u);i.interpolation==="CUBICSPLINE"&&this._createCubicSplineTrackInterpolant(v),a.push(v)}return a}_getArrayFromAccessor(e){let t=e.array;if(e.normalized){let n=tu(t.constructor),i=new Float32Array(t.length);for(let r=0,a=t.length;r<a;r++)i[r]=t[r]*n;t=i}return t}_createCubicSplineTrackInterpolant(e){e.createInterpolant=function(n){let i=this instanceof bi?Qh:Xc;return new i(this.times,this.values,this.getValueSize()/3,n)},e.createInterpolant.isInterpolantFactoryMethodGLTFCubicSpline=!0}};function Kx(s,e,t){let n=e.attributes,i=new ln;if(n.POSITION!==void 0){let o=t.json.accessors[n.POSITION],c=o.min,l=o.max;if(c!==void 0&&l!==void 0){if(i.set(new C(c[0],c[1],c[2]),new C(l[0],l[1],l[2])),o.normalized){let h=tu(br[o.componentType]);i.min.multiplyScalar(h),i.max.multiplyScalar(h)}}else{console.warn("THREE.GLTFLoader: Missing min/max properties for accessor POSITION.");return}}else return;let r=e.targets;if(r!==void 0){let o=new C,c=new C;for(let l=0,h=r.length;l<h;l++){let u=r[l];if(u.POSITION!==void 0){let d=t.json.accessors[u.POSITION],f=d.min,g=d.max;if(f!==void 0&&g!==void 0){if(c.setX(Math.max(Math.abs(f[0]),Math.abs(g[0]))),c.setY(Math.max(Math.abs(f[1]),Math.abs(g[1]))),c.setZ(Math.max(Math.abs(f[2]),Math.abs(g[2]))),d.normalized){let v=tu(br[d.componentType]);c.multiplyScalar(v)}o.max(c)}else console.warn("THREE.GLTFLoader: Missing min/max properties for accessor POSITION.")}}i.expandByVector(o)}s.boundingBox=i;let a=new _n;i.getCenter(a.center),a.radius=i.min.distanceTo(i.max)/2,s.boundingSphere=a}function gf(s,e,t){let n=e.attributes,i=[];function r(a,o){return t.getDependency("accessor",a).then(function(c){s.setAttribute(o,c)})}for(let a in n){let o=eu[a]||a.toLowerCase();o in s.attributes||i.push(r(n[a],o))}if(e.indices!==void 0&&!s.index){let a=t.getDependency("accessor",e.indices).then(function(o){s.setIndex(o)});i.push(a)}return it.workingColorSpace!==cn&&"COLOR_0"in n&&console.warn(`THREE.GLTFLoader: Converting vertex colors from "srgb-linear" to "${it.workingColorSpace}" not supported.`),ai(s,e),Kx(s,e,t),Promise.all(i).then(function(){return e.targets!==void 0?Wx(s,e.targets,t):s})}var Mn=document.querySelector(".hero"),nt=document.querySelector(".hero__visual"),Yc=document.querySelector(".galaxy-canvas"),Kc=document.querySelector(".galaxy-focus-canvas"),xf=document.querySelector("[data-visitor-light]"),yf=document.querySelector("[data-story-kicker]"),vf=document.querySelector("[data-story-copy]"),Mf=document.querySelector("[data-world-name]"),Sf=document.querySelector("[data-choice-count]"),bf=document.querySelector("[data-story-instruction]"),Tf=document.querySelector("[data-story-action]"),Zc=[...document.querySelectorAll("[data-project-option]")],dn=document.querySelector("[data-project-link]"),Ef=dn?.querySelector("[data-project-number]"),wf=dn?.querySelector("[data-project-name]"),Af=dn?.querySelector("[data-project-english]"),Rf=dn?.querySelector("[data-project-feature]"),Cf=dn?.querySelector("[data-project-feature-copy]"),If=dn?.querySelector("[data-project-cta]");if(!Mn||!nt||!Yc||!Kc)throw new Error("\u9996\u5C4F\u53D9\u4E8B\u573A\u666F\u7F3A\u5C11\u5FC5\u8981\u8282\u70B9");var Pf=[9416345,8298419,8628884,11770489],Zn=Object.fromEntries(Zc.map((s,e)=>[s.dataset.projectOption,{number:s.dataset.projectNumber,name:s.dataset.projectName,englishName:s.dataset.projectEnglish,feature:s.dataset.projectFeature,featureCopy:s.dataset.projectFeatureCopy,url:s.dataset.projectUrl,label:s.dataset.projectLabel,external:s.dataset.projectExternal==="true",kicker:`\u771F\u5B9E\u9879\u76EE \xB7 ${s.dataset.projectName}`,copy:s.dataset.projectFeatureCopy,color:Pf[e%Pf.length]}])),$i=window.matchMedia("(prefers-reduced-motion: reduce)"),Tr=window.matchMedia("(max-width: 980px)"),Df=s=>()=>{s|=0,s=s+1831565813|0;let e=Math.imul(s^s>>>15,1|s);return e=e+Math.imul(e^e>>>7,61|e)^e,((e^e>>>14)>>>0)/4294967296},Uf=()=>{let s=Yc.getContext("2d");if(!s)return;let e=Mn.getBoundingClientRect(),t=Math.min(window.devicePixelRatio||1,1.5),n=Math.max(1,Math.round(e.width)),i=Math.max(1,Math.round(e.height));Yc.width=Math.round(n*t),Yc.height=Math.round(i*t),s.setTransform(t,0,0,t,0,0),s.clearRect(0,0,n,i);let r=s.createLinearGradient(0,0,n,i);r.addColorStop(0,"rgba(2, 5, 8, 0)"),r.addColorStop(.5,"rgba(8, 17, 23, .18)"),r.addColorStop(1,"rgba(21, 34, 39, .34)"),s.fillStyle=r,s.fillRect(0,0,n,i);let a=s.createRadialGradient(n*.8,i*.44,0,n*.8,i*.44,n*.46);a.addColorStop(0,"rgba(147, 161, 155, .1)"),a.addColorStop(.28,"rgba(68, 85, 87, .065)"),a.addColorStop(1,"rgba(3, 7, 10, 0)"),s.fillStyle=a,s.fillRect(0,0,n,i);let o=Df(11092026),c=Math.min(280,Math.floor(n*i/5200));for(let l=0;l<c;l+=1){let h=n*(.38+o()*.62),u=o()*i,d=.25+o()*.7;s.beginPath(),s.arc(h,u,d,0,Math.PI*2),s.fillStyle=`rgba(183, 198, 193, ${.025+o()*.09})`,s.fill()}},Jx=(s,e=256)=>{let t=document.createElement("canvas");t.width=e,t.height=e;let n=t.getContext("2d"),i=n.createRadialGradient(e/2,e/2,0,e/2,e/2,e/2);for(let[a,o]of s)i.addColorStop(a,o);n.fillStyle=i,n.fillRect(0,0,e,e);let r=new sa(t);return r.colorSpace=Ot,r},$x=({texture:s,opacity:e,scale:t,position:n})=>{let i=new nr({map:s,opacity:e,transparent:!0,depthWrite:!1,depthTest:!1,blending:Gn}),r=new $r(i);return r.scale.set(t[0],t[1],1),r.position.set(n[0],n[1],n[2]),r.renderOrder=4,r},jx=(s,e=!0,t=!1)=>(s.traverse(n=>{n.isMesh&&(n.castShadow=e,n.receiveShadow=t)}),s),ji=(s,e,t,n,i=.82)=>{let r=new C(...s),a=new C(...e),o=a.clone().sub(r),c=new Ge(new Vn(t*i,t,o.length(),7,1,!1),n);return c.position.copy(r).add(a).multiplyScalar(.5),c.quaternion.setFromUnitVectors(new C(0,1,0),o.normalize()),c.castShadow=!0,c},Lf=({distant:s=!1,accent:e=!1}={})=>{let t=new Xt,n=new kt({color:s?1120283:1053719,roughness:.96}),i=new kt({color:658703,roughness:.92}),r=new kt({color:s?1646884:9074792,roughness:1}),a=new kt({color:e?7022893:1383455,emissive:e?2229511:0,emissiveIntensity:e?.18:0,roughness:.9}),o=new Ge(new aa(.13,.27,4,8),a);o.position.set(-.01,.46,0),o.scale.set(1,1,.68),o.rotation.z=-.08,t.add(o);let c=new Ge(new Vn(.043,.05,.09,7),r);c.position.set(.025,.68,0),c.rotation.z=-.08,t.add(c);let l=new Xt;l.position.set(.015,.77,0);let h=new Ge(new or(.115,2),r);h.scale.set(.92,1.05,.9),l.add(h);let u=new Ge(new ms(.12,12,7,0,Math.PI*2,0,Math.PI*.62),n);u.position.set(-.018,.028,-.004),u.scale.set(1.02,.88,1),l.add(u),t.add(l),t.add(ji([-.11,.57,0],[-.17,.39,.035],.048,a),ji([-.17,.39,.035],[-.11,.24,.055],.039,r),ji([.1,.56,0],[.16,.39,-.035],.047,a),ji([.16,.39,-.035],[.23,.28,.025],.038,r),ji([-.07,.29,.025],[-.11,.08,.035],.057,i),ji([-.11,.08,.035],[-.16,-.18,.08],.049,i),ji([.065,.29,-.025],[.12,.07,-.015],.057,i),ji([.12,.07,-.015],[.21,-.17,.035],.049,i));let d=new Ge(new pt(.15,.055,.11),i);d.position.set(-.2,-.205,.115),d.rotation.y=-.1;let f=d.clone();return f.position.set(.255,-.195,.07),f.rotation.y=.16,t.add(d,f),t.userData={headPivot:l,torso:o,jacket:a},t.scale.setScalar(s?.48:.92),jx(t,!s,!1),t},qc=(s,e,t,n)=>{let i=s.clone().sub(e),r=new Ge(new ar(t,i.length(),24,1,!0),n);return r.position.copy(s).add(e).multiplyScalar(.5),r.quaternion.setFromUnitVectors(new C(0,1,0),i.normalize()),r.renderOrder=2,r},Nf=(s,e,t)=>{let n=e.clone().sub(t);s.position.copy(e).add(t).multiplyScalar(.5),s.scale.y=n.length()/s.geometry.parameters.height,s.quaternion.setFromUnitVectors(new C(0,1,0),n.normalize())},Qx=s=>{let e=s.cloneNode();s.replaceWith(e);let t=e.getContext("2d"),n=()=>{let i=e.getBoundingClientRect(),r=Math.min(window.devicePixelRatio||1,1.5);e.width=Math.max(1,Math.round(i.width*r)),e.height=Math.max(1,Math.round(i.height*r)),t.setTransform(r,0,0,r,0,0),t.clearRect(0,0,i.width,i.height);let a=i.width,o=i.height,c=t.createLinearGradient(a*.78,o*.08,a*.55,o*.78);c.addColorStop(0,"rgba(211, 222, 211, .3)"),c.addColorStop(1,"rgba(131, 151, 145, 0)"),t.fillStyle=c,t.beginPath(),t.moveTo(a*.72,o*.02),t.lineTo(a*.88,o*.02),t.lineTo(a*.67,o*.84),t.lineTo(a*.42,o*.84),t.closePath(),t.fill(),t.fillStyle="rgba(10, 16, 19, .98)",t.fillRect(a*.03,0,a*.17,o*.84),t.fillRect(a*.9,0,a*.14,o),t.fillStyle="rgba(34, 44, 45, .9)",t.fillRect(a*.17,o*.58,a*.72,o*.055),t.fillStyle="rgba(15, 22, 25, .98)",t.beginPath(),t.moveTo(a*.19,o*.8),t.lineTo(a*.88,o*.75),t.lineTo(a,o),t.lineTo(0,o),t.closePath(),t.fill();for(let u=0;u<6;u+=1){let d=a*(.3+u*.09),f=o*.55;t.fillStyle="rgba(7, 11, 13, .9)",t.beginPath(),t.arc(d,f,3,0,Math.PI*2),t.fill(),t.fillRect(d-2.2,f+3,4.4,13)}let l=a*.58,h=o*.78;t.lineCap="round",t.strokeStyle="#0b0f11",t.lineWidth=Math.max(4,a*.008),t.beginPath(),t.moveTo(l-2,h-17),t.lineTo(l-7,h+7),t.moveTo(l+3,h-16),t.lineTo(l+11,h+7),t.stroke(),t.fillStyle="#6b292d",t.beginPath(),t.ellipse(l,h-31,9,15,-.12,0,Math.PI*2),t.fill(),t.fillStyle="#111719",t.beginPath(),t.arc(l+2,h-49,7.5,0,Math.PI*2),t.fill()};n(),window.addEventListener("resize",n,{passive:!0})};Uf();var Kn;try{Kn=new zc({canvas:Kc,alpha:!0,antialias:!0,powerPreference:"high-performance",premultipliedAlpha:!0})}catch(s){console.warn("Three.js \u521D\u59CB\u5316\u5931\u8D25\uFF0C\u5DF2\u5207\u6362\u5230 Canvas \u5907\u7528\u6E32\u67D3\u3002",s),Qx(Kc)}if(Kn){Kn.setClearColor(0,0),Kn.outputColorSpace=Ot,Kn.toneMapping=xa,Kn.toneMappingExposure=1.06,Kn.shadowMap.enabled=!0,Kn.shadowMap.type=xs;let s=new Zr;s.fog=new Yr(1120799,.09);let e=new Wt(38,1,.1,40);e.position.set(.2,1.05,6.7);let t=new Xt;s.add(t);let n=new kt({color:1779499,roughness:1,metalness:.02}),i=new kt({color:659732,roughness:.98}),r=new kt({color:4739664,roughness:.92}),a=new kt({color:857111,roughness:.82,metalness:.18}),o=new kt({color:6253928,emissive:2634031,emissiveIntensity:.26,roughness:.94}),c=new kt({color:2239793,roughness:.96,metalness:.03}),l=new fa(8624282,198152,.68),h=new qi(8887712,.88);h.position.set(-3.2,2.4,3.1);let u=new qi(9531754,.24);u.position.set(2.8,1.2,2.6),s.add(l,h,u);let d=new Ge(new pt(7.2,4.2,.22),n);d.position.set(.6,.45,-2.65),d.receiveShadow=!0,t.add(d);let f=new Ge(new pt(1.15,4.7,1.3),i);f.position.set(-2.72,.48,-.05);let g=new Ge(new pt(1.28,4.9,1.5),i);g.position.set(2.85,.42,-.14);let v=new Ge(new pt(5.2,.34,.62),i);v.position.set(.18,2.22,-.9),v.rotation.z=-.045,t.add(f,g,v);let m=new Ge(new Gi(4.38,1.46),o);m.position.set(.35,.27,-2.51),t.add(m);let p=new Ge(new pt(.055,1.54,.08),a);p.position.set(-1.82,.27,-2.42);let S=p.clone();S.position.x=.35;let w=p.clone();w.position.x=2.52;let y=new Ge(new pt(4.46,.055,.08),a);y.position.set(.35,1.01,-2.42);let b=y.clone();b.position.y=-.47,t.add(p,S,w,y,b);let T=new kt({color:2429717,emissive:8001816,emissiveIntensity:.08,roughness:.72}),A=[-1.36,.34,2.04].map(O=>{let V=new Ge(new pt(.18,.018,.035),T);return V.position.set(O,.9,-2.37),t.add(V),V}),x=new Ge(new pt(5.8,.12,.72),r);x.position.set(.05,-.36,-1.35),x.receiveShadow=!0,t.add(x);let E=new Ge(new pt(5.4,.025,.12),o);E.position.set(.2,-.285,-1.01),t.add(E);let I=new Ge(new pt(5.2,.035,.035),a);I.position.set(.14,.02,-.98),t.add(I);for(let O=0;O<8;O+=1){let V=new Ge(new pt(.025,.34,.025),a);V.position.set(-2.18+O*.66,-.13,-.98),t.add(V)}let U=new Ge(new Gi(7.2,4.8),c);U.rotation.x=-Math.PI/2,U.position.set(0,-1.04,.1),U.receiveShadow=!0,t.add(U);let B=new Ge(new pt(6.7,.28,.28),i);B.position.set(-.05,-1.08,2.25),t.add(B);let G=new Xt,D=new Ge(new pt(.78,.68,.58),i);D.position.set(-1.82,-.7,.72),D.rotation.y=.06,D.castShadow=!0,D.receiveShadow=!0;let X=new Ge(new pt(.012,.48,.6),a);X.position.set(-1.81,-.7,.72);let $=new Ge(new lr(.24,.025,6,16,Math.PI*1.35),a);$.position.set(-2.18,-.38,.51),$.rotation.set(Math.PI/2,.22,-.18),G.add(D,X,$),t.add(G);let K=new Ge(new pt(.52,.38,.92),i);K.position.set(1.82,-.84,.78),K.rotation.y=-.14,K.castShadow=!0,K.receiveShadow=!0,t.add(K);let se=new C(1.5,2.16,1.18),W=new C(.72,-.88,.22),ne=W.clone(),ie=new Xt;ie.position.set(1.5,2.17,1.08);let Oe=new Ge(new pt(.055,.48,.055),a);Oe.position.y=.2;let Le=new Ge(new pt(.42,.19,.26),i);Le.position.set(-.15,-.06,0);let vt=new kt({color:2107433,emissive:5904662,emissiveIntensity:.36,roughness:.52}),rt=new Ge(new Vn(.065,.075,.075,12),vt);rt.position.set(-.38,-.06,0),rt.rotation.z=Math.PI/2,ie.add(Oe,Le,rt),ie.rotation.z=.34,t.add(ie);let ot=new en({color:12043709,transparent:!0,opacity:.052,side:tn,depthWrite:!1,blending:Gn}),J=ot.clone();J.opacity=.022;let te=qc(se,W,.8,ot),Te=qc(se,W,1.22,J);t.add(Te,te);let Be=new _s(13226953,18,9,Math.PI*.13,.78,1.2);Be.position.copy(se),Be.castShadow=!0,Be.shadow.mapSize.set(1024,1024),Be.shadow.camera.near=.2,Be.shadow.camera.far=10,Be.shadow.bias=-8e-4;let Me=new wt;Me.position.copy(W),t.add(Be,Me),Be.target=Me;let $e=Jx([[0,"rgba(215,226,217,.72)"],[.12,"rgba(169,188,181,.28)"],[.46,"rgba(92,119,116,.08)"],[1,"rgba(0,0,0,0)"]]),At=$x({texture:$e,opacity:.18,scale:[.72,.42],position:[W.x,W.y+.025,W.z]});t.add(At);let Ke=({color:O,emissive:V=O,opacity:q=.72,wireframe:oe=!1})=>{let ce=new kt({color:O,emissive:V,emissiveIntensity:.28,roughness:.78,metalness:.08,transparent:!0,opacity:0,depthWrite:!1,wireframe:oe});return ce.userData.baseOpacity=q,ce},ut=O=>{let V=new Xt,q=Zn[O];V.userData.mode=O,V.userData.materials=[];let oe=(lt,ke,He,De=[0,0,0])=>{let le=new Ge(lt,ke);return le.position.set(...He),le.rotation.set(...De),le.castShadow=!1,V.add(le),V.userData.materials.includes(ke)||V.userData.materials.push(ke),le},ce=(lt,ke=.48)=>{let He=new vi({color:q.color,transparent:!0,opacity:0,depthWrite:!1});He.userData.baseOpacity=ke;let De=new Qn(new Et().setFromPoints(lt.map(le=>new C(...le))),He);return De.renderOrder=3,V.add(De),V.userData.materials.push(He),De},Lt=new ze(q.color).multiplyScalar(.72),Dt=Ke({color:Lt,emissive:q.color,opacity:.84}),It=Ke({color:2568757,emissive:q.color,opacity:.48}),_t=Ke({color:q.color,emissive:q.color,opacity:.34,wireframe:!0}),Re=Ke({color:13359313,emissive:q.color,opacity:.92}),qe=Ke({color:1383712,emissive:q.color,opacity:.28});if(oe(new Vn(.48,.56,.055,8),It,[0,.025,0]),oe(new ps(.43,.455,48),_t,[0,.057,0],[-Math.PI/2,0,0]),O==="research-workbench"){let lt=[-.08,0,.08].map((De,le)=>oe(new pt(.67,.46,.022),le===2?Dt:qe,[-.12+le*.055,.45+le*.035,De],[.08-le*.04,-.24+le*.1,-.03+le*.025]));[.56,.47,.35].forEach((De,le)=>{oe(new pt(De,.018,.012),Re,[-.09,.57-le*.085,.105])});let ke=[oe(new ms(.047,12,8),Re,[-.32,.57,.16]),oe(new ms(.047,12,8),Re,[.05,.4,.16])],He=oe(new cr(.12,1),_t,[.48,.58,.08],[.2,0,.2]);ke.forEach(De=>ce([[De.position.x,De.position.y,De.position.z],[.26,.58,.12],[He.position.x,He.position.y,He.position.z]],.5)),V.userData.animate=(De,le,Ve)=>{He.rotation.y=De*.55,lt[2].position.y=.52+Math.sin(De*.9)*.012*Ve,ke.forEach((Qe,ft)=>Qe.scale.setScalar(1+Math.sin(De*2.2+ft*2.1)*.14*Ve))}}else if(O==="algorithm-lab"){oe(new pt(.52,.54,.42),_t,[.05,.42,0]),oe(new pt(.39,.055,.31),qe,[.05,.17,0]),ce([[-.68,.42,.1],[-.22,.42,.1],[.33,.42,.1],[.68,.42,.1]],.56);let lt=Array.from({length:3},(De,le)=>oe(new pt(.09,.09,.09),le===2?Re:Dt,[-.64+le*.18,.42,.1],[.2,.2,0])),ke=oe(new lr(.12,.026,8,24,Math.PI*1.55),Re,[.62,.42,.1],[0,0,-.72]),He=oe(new Vn(.09,.12,.22,6),Dt,[.05,.42,-.22]);V.userData.animate=(De,le,Ve)=>{lt.forEach((Qe,ft)=>{Qe.position.x=-.64+(De*(.22+ft*.018)+ft*.34)%1.28,Qe.rotation.x=De*.9+ft,Qe.rotation.y=De*.62+ft}),He.rotation.y=De*.4,ke.scale.setScalar(1+Math.sin(De*2.4)*.08*Ve)}}else if(O==="write-here"){oe(new pt(.7,.54,.035),Dt,[0,.45,0],[.05,-.16,0]),[.48,.58,.38,.51].forEach((He,De)=>{oe(new pt(He,.018,.018),qe,[-.055,.59-De*.085,.04],[0,-.16,0])});let lt=[-.2,.02,.23].map((He,De)=>{let le=oe(new pt(.018,.13,.025),De===1?Re:_t,[He,.51-De*.08,.085]);return oe(new ar(.038,.07,5),De===1?Re:_t,[He+.025,.59-De*.08,.085],[0,0,-.7]),le}),ke=[-.42,0,.42].map((He,De)=>oe(new or(.065,1),De===1?Re:_t,[He,.82+De%2*.05,-.02]));ke.forEach((He,De)=>{De<ke.length-1&&ce([[He.position.x,He.position.y,-.02],[ke[De+1].position.x,ke[De+1].position.y,-.02]],.44)}),V.userData.animate=(He,De,le)=>{lt.forEach((Ve,Qe)=>{Ve.position.y=.43+(Math.sin(He*(.78+Qe*.07)+Qe*1.6)+1)*.11}),ke.forEach((Ve,Qe)=>Ve.scale.setScalar(1+Math.sin(He*1.8+Qe*1.5)*.1*le))}}else{let lt=oe(new Vn(.14,.18,.34,6),Dt,[0,.39,0],[.08,0,.08]);oe(new pt(.24,.11,.2),Re,[0,.58,0]);let ke=[[-.5,.68,.02],[.46,.72,-.04],[-.42,.27,.08],[.48,.29,.06]].map((He,De)=>{let le=oe(De%2?new cr(.09,0):new pt(.18,.12,.14),De===1?Re:_t,He,[.12,De*.28,.08]);return le.userData.baseY=He[1],ce([[0,.47,0],He],.46),le});V.userData.animate=(He,De,le)=>{lt.rotation.y=He*.46,ke.forEach((Ve,Qe)=>{Ve.rotation.y=He*(Qe%2?-.62:.62)+Qe,Ve.position.y=Ve.userData.baseY+Math.sin(He*1.2+Qe)*.014*le})}}return V},xt=new Xt;xt.position.set(0,-1.015,0);let et=[[-.92,.08,.22],[-.3,.02,-.06],[.38,.04,-.02],[1.02,.08,.2]],Rt=Object.fromEntries(Object.keys(Zn).map((O,V)=>{let q=ut(O),[oe,ce,Lt]=et[V]||[0,0,0];return q.position.set(oe,ce,Lt),q.userData.baseY=ce,q.rotation.y=(V-1.5)*-.08,q.scale.setScalar(.9),xt.add(q),[O,q]}));t.add(xt);let Ut=new C(.12,-1.012,.42),qt=[new C(-1.72,-1.012,-.12),new C(.18,-1.012,-.98),new C(1.78,-1.012,-.02)],Pt=[8166264,7314344,11571564],Ft=qt.map((O,V)=>{let q=Ut.clone().lerp(O,.5);q.x+=(V-1)*.2,q.z+=V===1?.12:-.06;let oe=new fs(Ut,q,O),ce=new en({color:Pt[V],transparent:!0,opacity:0,depthWrite:!1,blending:Gn});ce.userData.baseOpacity=.32;let Lt=new Ge(new la(oe,42,.018,6,!1),ce);return Lt.renderOrder=3,t.add(Lt),{path:Lt,material:ce,target:O}}),F=new en({color:10202793,transparent:!0,opacity:.018,side:tn,depthWrite:!1,blending:Gn}),Jt=qc(new C(-1.72,2.04,-1.82),new C(-.88,-.32,-1.36),.38,F),mt=F.clone();mt.opacity=.012;let R=qc(new C(.18,2.08,-1.92),new C(.82,-.32,-1.34),.3,mt);t.add(Jt,R);let _=Array.from({length:3},(O,V)=>{let q=new en({color:11452343,transparent:!0,opacity:0,side:tn,depthWrite:!1,blending:Gn}),oe=new Ge(new ps(.18,.19,56),q);return oe.rotation.x=-Math.PI/2,oe.position.set(W.x,-1.014+V*.001,W.z),oe.visible=!1,oe.renderOrder=3,t.add(oe),oe}),L=new Xt;L.position.set(-.46,-1.025,.52),L.rotation.y=-.28,t.add(L);let k=Lf({accent:!0});k.position.y=.19,L.add(k);let Z=Array.from({length:8},(O,V)=>{let q=new en({color:V%2?9216922:10517104,transparent:!0,opacity:0,side:tn,depthWrite:!1,blending:Gn}),oe=new Ge(new ps(.018,.028,20),q);return oe.rotation.x=-Math.PI/2,oe.scale.set(.62,1,1.28),oe.position.y=-1.012+V*2e-4,oe.visible=!1,oe.userData.bornAt=-10,t.add(oe),oe}),ae={actions:{},currentAction:null,loaded:!1,mixer:null,model:null},ue=(O,V)=>V.map(q=>O.find(oe=>oe.name.toLowerCase()===q)).find(Boolean),j=O=>{let V=/(walk|run|sprint)/i.test(O.name),q=O.tracks.filter(oe=>!(/pelvis\.position$/i.test(oe.name)||V&&/hand_[lr]\.quaternion$/i.test(oe.name)));return new Ei(O.name,O.duration,q)},ee=(O,V=.2)=>{let q=ae.actions[O];!q||q===ae.currentAction||(q.reset().fadeIn(V).play(),ae.currentAction?.fadeOut(V),ae.currentAction=q,nt.dataset.action=O)},fe={idle:"idle",alert:"alert",evade:"run",hide:"hide",return:"walk",observe:"alert",resolve:"walk",depart:"walk",arrived:"idle"},Ie=[];new Gc().load("./assets/characters/red-sweater-boy-hero-v2.glb",O=>{let V=O.scene,q=new ln().setFromObject(V),ce=.325/Math.max(.01,q.max.y-q.min.y);V.scale.setScalar(ce),V.position.set(0,-q.min.y*ce,0),V.rotation.y=Math.PI,V.traverse(It=>{if(!It.isMesh)return;It.castShadow=!0,It.receiveShadow=!0,(Array.isArray(It.material)?It.material:[It.material]).filter(Boolean).forEach(Re=>{Re.roughness=Math.max(.72,Re.roughness??.72),Re.metalness=Math.min(.04,Re.metalness??0)})}),k.visible=!1,L.add(V),ae.model=V,ae.mixer=new dr(V),Object.entries({idle:["idle_loop"],alert:["interact","idle_torch_loop"],run:["sprint_loop","run_loop"],hide:["crouch_idle_loop"],walk:["walk_formal_loop","walk_loop"]}).forEach(([It,_t])=>{let Re=ue(O.animations,_t);if(!Re)return;let qe=j(Re);ae.actions[It]=ae.mixer.clipAction(qe)});let Dt=ue(O.animations,["walk_formal_loop","walk_loop"]);if(Dt){let It=j(Dt),_t=[2700086,2107692,3423293,2436657,3160122,1910313];he.forEach((Re,qe)=>{let lt=Vc(V);lt.scale.multiplyScalar(.92/Re.scale.x),lt.position.y-=.21,lt.traverse(Ve=>{if(!Ve.isMesh)return;let ft=(Array.isArray(Ve.material)?Ve.material:[Ve.material]).map($t=>{let bt=$t.clone();return bt.color?.lerp(new ze(_t[qe%_t.length]),.76),bt.emissive&&bt.emissive.set(329737),bt.emissiveIntensity=.08,bt.roughness=Math.max(.88,bt.roughness??.88),bt.metalness=0,bt});Ve.material=Array.isArray(Ve.material)?ft:ft[0],Ve.castShadow=!0,Ve.receiveShadow=!0}),Re.children.forEach(Ve=>{Ve.visible=!1}),Re.rotation.y=-Math.PI/2,Re.add(lt);let ke=new dr(lt),He=ke.clipAction(It),De=.78+qe%4*.08;He.play(),He.time=It.duration*(qe*.173%1),He.timeScale=De;let le={action:He,baseTimeScale:De,mixer:ke};Re.userData.npcRuntime=le,Ie.push(le)}),nt.dataset.npcs="skeletal-walk",nt.dataset.npcCount=String(Ie.length)}ae.loaded=!0,ee(fe[Ee.mode],0),nt.dataset.model="ready",nt.dataset.motion="skeletal-locomotion"},void 0,()=>{nt.dataset.model="fallback",nt.dataset.npcs="procedural-fallback"});let he=[];for(let O=0;O<6;O+=1){let V=Lf({distant:!0});V.position.set(-2.25+O*.82,-.19,-.96-O%2*.05),V.rotation.y=-.22,V.userData.speed=.22+O%3*.035,he.push(V),t.add(V)}nt.dataset.npcs="procedural-loading";let Ne=new Qn(new Et().setFromPoints([new C(-2.3,1.68,-.35),new C(-1.1,1.57,-.52),new C(.2,1.6,-.65),new C(1.42,1.48,-.45),new C(2.35,1.53,-.3)]),new vi({color:1120540,transparent:!0,opacity:.9}));t.add(Ne);let Fe=Tr.matches?420:760,Xe=new Float32Array(Fe*3),P=new Float32Array(Fe*3),pe=new Float32Array(Fe),Q=Df(508173);for(let O=0;O<Fe;O+=1){let V=Math.pow(Q(),.88),q=V*(.1+Q()*.74),oe=Q()*Math.PI*2,ce=O*3;P[ce]=Pn.lerp(se.x,W.x,V)+Math.cos(oe)*q,P[ce+1]=Pn.lerp(se.y,W.y,V)+Math.sin(oe)*q*.64,P[ce+2]=Pn.lerp(se.z,W.z,V)+(Q()-.5)*q,Xe[ce]=P[ce],Xe[ce+1]=P[ce+1],Xe[ce+2]=P[ce+2],pe[O]=Q()}let de=new Et;de.setAttribute("position",new Bt(Xe,3));let ye=new ki({color:12635845,map:$e,size:.025,opacity:.42,transparent:!0,depthWrite:!1,blending:Gn,sizeAttenuation:!0}),re=new ds(de,ye);re.renderOrder=4,t.add(re);let Pe=new _a;Pe.connect(document);let Se=new ve,gt=new ve,ct=new C(-.46,-1.025,.52),fn=[new C(-1.48,-1.025,.62),new C(1.5,-1.025,.66)],Ee={mode:"idle",modeSince:0,lastThreatAt:-10,target:ct.clone(),threat:0},oi=[],Qt=Object.keys(Zn)[0],pn=!1,Es=1,Jc={alert:["\u5149\u7167\u9760\u8FD1\u4E86\u4ED6","\u5C0F\u4EBA\u7269\u4F1A\u672C\u80FD\u540E\u9000\uFF0C\u4F5C\u54C1\u5374\u5F00\u59CB\u663E\u73B0"],evade:["\u4ED6\u8DD1\u5411\u9634\u5F71","\u53D8\u5316\u8BA9\u4EBA\u4E0D\u5B89\uFF0C\u4E5F\u8BA9\u65B0\u7684\u53EF\u80FD\u88AB\u770B\u89C1"],hide:["\u4ED6\u6682\u65F6\u8EB2\u5F00","\u5149\u675F\u4ECD\u5728\u7B49\u5F85\u4F60\u53D1\u73B0\u4E0B\u4E00\u4E2A\u771F\u5B9E\u9879\u76EE"],return:["\u4ED6\u91CD\u65B0\u8D70\u56DE\u6765","\u6BCF\u6B21\u9002\u5E94\u53D8\u5316\uFF0C\u90FD\u4F1A\u7559\u4E0B\u771F\u5B9E\u7684\u4F5C\u54C1"],resolve:["\u4E09\u79CD\u53D8\u5316\u5DF2\u88AB\u7559\u4E0B","\u65E7\u9053\u8DEF\u5206\u5F00\uFF0C\u4EBA\u7FA4\u5F00\u59CB\u8D70\u5411\u4E0D\u540C\u65B9\u5411"],depart:["\u4ED6\u505A\u51FA\u4E86\u9009\u62E9","\u8FD9\u4E00\u6B21\uFF0C\u4ED6\u4E3B\u52A8\u8D70\u8FDB\u5149\u91CC"],arrived:["\u62E5\u62B1\u53D8\u5316","\u6CA1\u6709\u73B0\u6210\u5730\u56FE\uFF0C\u4E5F\u53EF\u4EE5\u4EB2\u624B\u8D70\u51FA\u4E00\u6761\u8DEF"]},ws=O=>{let V=Jc[O];if(!V){let ce=Zn[Qt];V=[ce.kicker,`\u5149\u675F\u6B63\u5728\u6F14\u793A\uFF1A${ce.feature}`]}let[q,oe]=V;yf&&(yf.textContent=q),vf&&(vf.textContent=oe)},Pa=()=>{let O=Zn[Qt];O&&(Ef&&(Ef.textContent=O.number),wf&&(wf.textContent=O.name),Af&&(Af.textContent=O.englishName),Rf&&(Rf.textContent=O.feature),Cf&&(Cf.textContent=O.featureCopy),If&&(If.textContent=O.external?"\u70B9\u51FB\u8BBF\u95EE\u7EBF\u4E0A\u9879\u76EE \u2197":"\u67E5\u770B\u9875\u9762\u5185\u9879\u76EE\u8BE6\u60C5 \u2193"),dn&&(dn.href=O.url,dn.setAttribute("aria-label",O.external?`${O.label}\uFF08\u65B0\u7A97\u53E3\u6253\u5F00\uFF09`:O.label),O.external?(dn.target="_blank",dn.rel="noreferrer"):(dn.removeAttribute("target"),dn.removeAttribute("rel"))),Zc.forEach(V=>{V.setAttribute("aria-pressed",String(V.dataset.projectOption===Qt))}))},An=()=>{let O=Object.keys(Zn).indexOf(Qt),V=Zn[Qt];Sf&&(Sf.textContent=`\u771F\u5B9E\u9879\u76EE ${String(O+1).padStart(2,"0")} / ${String(Zc.length).padStart(2,"0")}`),Mf&&(Mf.textContent=`${V.name} \xB7 ${V.englishName}`),bf&&(bf.textContent="\u2460 \u79FB\u52A8\u5149\u675F\uFF0C\u5207\u6362\u771F\u5B9E\u9879\u76EE"),Tf&&(Tf.textContent=V.external?"\u2461 \u70B9\u51FB\u9879\u76EE\u5361\u7247\uFF0C\u8FDB\u5165\u4F5C\u54C1":"\u2461 \u79C1\u6709\u9879\u76EE\u53EF\u67E5\u770B\u9875\u9762\u5185\u8BE6\u60C5"),nt.dataset.project=Qt,Pa()},Ri=O=>{!Zn[O]||Qt===O||(Qt=O,nt.dataset.project=O,An(),!pn&&!["alert","evade","hide","return"].includes(Ee.mode)&&ws(Ee.mode))},As=O=>{let V=Object.keys(Zn),q=Math.min(V.length-1,Math.max(0,Math.floor((Pn.clamp(O,-.5,.499)+.5)*V.length)));return V[q]};nt.dataset.story=Ee.mode,nt.dataset.scan="idle",nt.dataset.scene="project-diorama",nt.dataset.project=Qt,nt.dataset.queue="repetitive",nt.dataset.paths="single",ws(Ee.mode),An();let ci=0,Nn=0,Er=0,Ci=0,Rs=0,Qi=!1,Ii=0,Pi=1,Cs=!0,li=0,wr=-10,M=W.clone(),N=0,Y=-10,H=0,z=(O,V)=>{Ee.mode!==O&&(Ee.mode=O,Ee.modeSince=V,nt.dataset.story=O,nt.dataset.queue=O==="alert"||O==="evade"?"watching":pn?"dispersing":"repetitive",ws(O),ee(fe[O]))},ge=()=>{wr=Ii,M.copy(W),nt.dataset.scan="active",Mn.classList.remove("is-pulsing"),nt.offsetWidth,Mn.classList.add("is-pulsing"),window.clearTimeout(N),N=window.setTimeout(()=>{Mn.classList.remove("is-pulsing"),nt.dataset.scan="idle"},860)},be=()=>fn.reduce((O,V)=>{let q=Math.hypot(V.x-W.x,V.z-W.z),oe=Math.hypot(O.x-W.x,O.z-W.z);return q>oe?V:O},fn[0]).clone(),_e=()=>{pn=!0,Es=Qt==="nature"?0:Qt==="future"?2:1,nt.dataset.paths="diverging",nt.dataset.queue="dispersing",he.forEach((O,V)=>{let q=qt[V%qt.length];O.userData.branchTarget=q.clone().setY(-.19),O.userData.branchTarget.x+=(V>2?.13:-.08)*(V%2?1:-1),O.userData.branchTarget.z+=V>2?.12:-.03}),Ee.target.copy(Ut).setY(ct.y),z("resolve",Ii),An()},Ae=()=>{if(pn||oi.length>=3)return;let O=ut(Qt);O.position.set(Pn.clamp(W.x,-1.82,1.82),-1.014,Pn.clamp(W.z,-.48,.92)),O.rotation.y=(oi.length-1)*.22,O.scale.setScalar(.02),O.userData.retainedAt=Ii,O.userData.targetScale=.56+oi.length*.035,oi.push(O),t.add(O),An(),oi.length===3?_e():(Ee.target.copy(L.position),z("observe",Ii))},Ce=(O,V,q)=>{if(V<=0)return;let oe=Math.hypot(L.position.x-W.x,L.position.z-W.z),ce=!pn&&oi.length===0&&q>.18&&oe<.94;if(Ee.threat+=((ce?1:0)-Ee.threat)*Math.min(1,V*7.5),ce&&(Ee.lastThreatAt=O,(Ee.mode==="idle"||Ee.mode==="return"||Ee.mode==="hide")&&z("alert",O)),Ee.mode==="alert"&&O-Ee.modeSince>.3&&(Ee.target.copy(be()),z("evade",O)),["evade","return","resolve","depart"].includes(Ee.mode)){let _t=Ee.target.clone().sub(L.position),Re=Math.hypot(_t.x,_t.z),qe=Ee.mode==="evade"?2.45:Ee.mode==="depart"?.82:.62;if(Re>.035){let lt=Math.min(Re,qe*V);if(L.position.x+=_t.x/Re*lt,L.position.z+=_t.z/Re*lt,Ee.mode==="evade"&&O-Y>.085){let He=Z[H%Z.length];He.position.x=L.position.x+(H%2?.018:-.018),He.position.z=L.position.z+.025,He.userData.bornAt=O,He.visible=!0,Y=O,H+=1}let ke=Math.sign(_t.x||1);L.rotation.y+=((ke>0?-.8:.8)-L.rotation.y)*Math.min(1,V*7)}else Ee.mode==="evade"?z("hide",O):Ee.mode==="resolve"?(Ee.target.copy(qt[Es]).setY(ct.y),z("depart",O)):Ee.mode==="depart"?z("arrived",O):(L.rotation.y+=(-.28-L.rotation.y)*Math.min(1,V*5),z("idle",O))}if(Ee.mode==="hide"&&O-Ee.lastThreatAt>2.1&&(Ee.target.copy(ct),z("return",O)),Ee.mode==="observe"&&O-Ee.modeSince>1.45&&z("idle",O),Ee.mode==="idle"||Ee.mode==="observe"||Ee.mode==="arrived"){L.position.y=ct.y+Math.sin(O*1.2)*.005;let _t=Ee.mode==="arrived"?-.72:Ee.mode==="observe"?-.5:-.28;L.rotation.y+=(_t-L.rotation.y)*Math.min(1,V*3)}let Lt=Ee.mode==="hide"?Pi*.82:Ee.mode==="alert"||Ee.mode==="observe"?Pi*.92:Pi,Dt=Math.sign(Ee.target.x-L.position.x||1),It=Ee.mode==="evade"?Dt*-.14:Ee.mode==="alert"?.055:0;if(L.scale.y+=(Lt-L.scale.y)*Math.min(1,V*7),L.scale.x+=(Pi-L.scale.x)*Math.min(1,V*7),L.scale.z+=(Pi-L.scale.z)*Math.min(1,V*7),L.rotation.z+=(It-L.rotation.z)*Math.min(1,V*6),!ae.loaded){let _t=Ee.mode==="alert"||Ee.mode==="hide"||Ee.mode==="observe"?.16:0;k.scale.y+=(.92-_t-k.scale.y)*Math.min(1,V*8),k.userData.headPivot.rotation.y+=((Ee.mode==="alert"||Ee.mode==="observe"?-.52:0)-k.userData.headPivot.rotation.y)*Math.min(1,V*7)}ae.mixer?.update(V*(Ee.mode==="evade"?1.7:1))},Je=(O={})=>{let V=Array.isArray(O.items)?O.items:[],q=V.map(ce=>`${ce.nickname||""}:${ce.content||""}`).join("|"),oe=2166136261;for(let ce=0;ce<q.length;ce+=1)oe^=q.charCodeAt(ce),oe=Math.imul(oe,16777619);Er=q?(oe>>>0)%2001/1e3-1:0,Ci=O.fresh?1:Math.min(.32,V.length*.018),Rs=O.fresh?Rs+V.length:V.length,xf&&(xf.textContent=`VISITOR TRACE \xB7 ${String(Rs).padStart(2,"0")}`)};window.addEventListener("portfolio:visitor-light",O=>Je(O.detail)),globalThis.PORTFOLIO_VISITOR_LIGHT&&Je(globalThis.PORTFOLIO_VISITOR_LIGHT);let je=()=>{Uf(),Pi=1;let O=Kc.getBoundingClientRect(),V=Math.min(window.devicePixelRatio||1,Tr.matches?1.2:1.5);Kn.setPixelRatio(V),Kn.setSize(Math.max(1,O.width),Math.max(1,O.height),!1),e.aspect=Math.max(.1,O.width/Math.max(1,O.height)),e.fov=Tr.matches?45:38,e.position.z=Tr.matches?7.15:6.7,e.updateProjectionMatrix(),Tr.matches?(t.position.set(.2,-.03,0),t.scale.setScalar(.92)):(t.position.set(.34,-.02,0),t.scale.setScalar(1.04))},we=O=>{Pe.update(O);let V=Pe.getElapsed(),q=Math.min(.05,Math.max(.001,V-Ii||.016));Ii=V;let oe=$i.matches?0:1;Se.lerp(gt,.045),ci+=(Nn-ci)*.065,Ci*=Math.pow(.985,q*60);let ce=Math.max(ci,Ci);e.position.x=.2+Se.x*.22,e.position.y=1.05+Se.y*.14,e.lookAt(Se.x*.08,-.08+Se.y*.025,0),ci>.14&&!pn&&Ri(As(Se.x));let Lt=Object.keys(Zn).indexOf(Qt),Dt=et[Lt]||et[0],It=Dt[0]+Er*.12+Math.sin(V*.16)*.08*oe,_t=Dt[2]+Math.cos(V*.13)*.06*oe;ne.set(Pn.lerp(It,Se.x*3.2,ci),-.985,Pn.lerp(_t,.42+Se.y*2.1,ci)),W.lerp(ne,.055),Me.position.copy(W),At.position.copy(W),At.position.y+=.025,Nf(te,se,W),Nf(Te,se,W),ot.opacity=.042+ce*.026,J.opacity=.017+ce*.011,Be.intensity=15+ce*4.5,At.material.opacity=.15+ce*.14,At.scale.set(.68+ce*.2,.38+ce*.1,1);let Re=new ze(Zn[Qt].color);Be.color.lerp(Re,Math.min(1,q*2.6)),ot.color.lerp(Re,Math.min(1,q*2.2)),J.color.lerp(Re,Math.min(1,q*2.2)),Object.entries(Rt).forEach(([le,Ve],Qe)=>{let ft=le===Qt?1:0,$t=ft?.88+ce*.12:.035;Ve.userData.materials.forEach(mn=>{let Li=mn.userData.baseOpacity*$t;mn.opacity+=(Li-mn.opacity)*Math.min(1,q*7)});let bt=ft?1.16+ce*.1:.78;Ve.scale.lerp(new C(bt,bt,bt),Math.min(1,q*5)),Ve.position.y=Ve.userData.baseY+Math.sin(V*.72+Qe*.85)*.012*oe*ft,Ve.userData.animate?.(V,q*oe,ft,ce)}),oi.forEach((le,Ve)=>{let Qe=Math.max(0,V-le.userData.retainedAt),ft=Math.min(1,Qe*3.6),$t=le.userData.targetScale*(.86+ft*.14);le.scale.lerp(new C($t,$t,$t),Math.min(1,q*9)),le.userData.materials.forEach(bt=>{let mn=bt.userData.baseOpacity*(.48+ft*.34);bt.opacity+=(mn-bt.opacity)*Math.min(1,q*7)}),le.rotation.y+=(Ve%2?-.045:.045)*q*oe,le.userData.animate?.(V,q*oe,1,ce)}),Ft.forEach((le,Ve)=>{let Qe=.86+Math.sin(V*1.4+Ve*1.7)*.14,ft=pn?le.material.userData.baseOpacity*Qe:0;le.material.opacity+=(ft-le.material.opacity)*Math.min(1,q*2.8)}),E.scale.x+=((pn?.24:1)-E.scale.x)*Math.min(1,q*1.8),Ce(V,q*oe,ce);let qe=Ee.mode==="alert"||Ee.mode==="evade"?1:0,lt=Ee.mode==="hide"?1:0,ke=pn&&!qe?1:0,He=.5+Math.sin(V*9.5)*.5;Be.intensity+=qe*2.4-lt*2.8,At.material.opacity*=1-lt*.46,T.emissiveIntensity=.05+qe*(.55+He*.8),A.forEach((le,Ve)=>{let Qe=qe?1+Math.sin(V*8.5+Ve*1.7)*.16:1;le.scale.x+=(Qe-le.scale.x)*Math.min(1,q*10)}),m.material.emissiveIntensity=.24+qe*.09-lt*.07,F.opacity=.016+Math.sin(V*.42)*.004,mt.opacity=.01+Math.sin(V*.36+1.8)*.003,s.fog.density=.09+lt*.012+qe*.004,u.intensity=.22+qe*.22-lt*.08,k.userData.torso.rotation.z=-.08+Ee.threat*.07,k.userData.jacket.emissiveIntensity=.16+Ee.threat*.18,ie.rotation.z=.34+Se.x*ce*.15,vt.emissiveIntensity=.24+ce*.34+qe*.74-lt*.14,_.forEach((le,Ve)=>{let Qe=V-wr-Ve*.1,ft=Qe>=0&&Qe<1.08;if(le.visible=ft,!ft)return;let $t=Qe/1.08,bt=.72+$t*5.2;le.position.x=M.x,le.position.z=M.z,le.scale.setScalar(bt),le.material.opacity=(1-$t)*(.2-Ve*.035)}),Z.forEach(le=>{let Ve=V-le.userData.bornAt,Qe=Ve>=0&&Ve<.9;if(le.visible=Qe,!Qe)return;let ft=Ve/.9;le.material.opacity=(1-ft)*.28,le.scale.set(.62+ft*.2,1,1.28+ft*.34)}),he.forEach((le,Ve)=>{let Qe=0;if(pn&&le.userData.branchTarget){let bt=le.userData.branchTarget.clone().sub(le.position),mn=Math.hypot(bt.x,bt.z);if(mn>.04){Qe=.2+Ve%3*.035;let Li=Math.min(mn,q*Qe);le.position.x+=bt.x/mn*Li,le.position.z+=bt.z/mn*Li,le.rotation.y+=((bt.x>0?-Math.PI/2:Math.PI/2)-le.rotation.y)*Math.min(1,q*4)}le.position.y+=(-.19-le.position.y)*Math.min(1,q*.72)}else oe&&(Qe=le.userData.speed*(1-ce*.72)*(1-qe*.86),le.position.x+=Qe*q,le.position.x>2.35&&(le.position.x=-2.35));let ft=le.userData.npcRuntime;if(ft){let $t=Qe/Math.max(.001,le.userData.speed);ft.action.timeScale=ft.baseTimeScale*Math.max(.08,$t),ft.mixer.update(q*oe)}else pn||(le.position.y=-.19+Math.abs(Math.sin(V*1.9+Ve*.8))*.008*oe);if(!ft){let $t=(qe+ke*.42)*Math.sign(L.position.x-le.position.x)*.56;le.userData.headPivot.rotation.y+=($t-le.userData.headPivot.rotation.y)*Math.min(1,q*4.5),le.userData.torso.rotation.z+=((qe||ke?-.03:-.08)-le.userData.torso.rotation.z)*Math.min(1,q*3.8)}});let De=de.getAttribute("position");for(let le=0;le<Fe;le+=1){let Ve=le*3,Qe=pe[le],ft=P[Ve]+Math.sin(V*(.18+Qe*.22)+Qe*12)*.025*oe,$t=P[Ve+1]+Math.sin(V*(.12+Qe*.18)+Qe*8)*.035*oe,bt=ft-W.x,mn=$t-W.y,Li=ce*Math.exp(-(bt*bt+mn*mn)*1.2);De.array[Ve]=ft-mn*Li*.1,De.array[Ve+1]=$t+bt*Li*.1,De.array[Ve+2]=P[Ve+2]+Li*.08}De.needsUpdate=!0,Kn.render(s,e),Cs&&!$i.matches&&(li=requestAnimationFrame(we))},dt=()=>{cancelAnimationFrame(li),li=0,we()};Zc.forEach((O,V)=>{O.addEventListener("click",q=>{q.stopPropagation(),Ri(O.dataset.projectOption),gt.set(-.375+V*.25,.06),Nn=1,Mn.classList.add("is-searching"),ge(),dt()})}),dn?.addEventListener("pointermove",O=>O.stopPropagation()),dn?.addEventListener("click",O=>O.stopPropagation()),Mn.addEventListener("pointermove",O=>{if($i.matches)return;let V=Mn.getBoundingClientRect(),q=(O.clientX-V.left)/V.width-.5,oe=.5-(O.clientY-V.top)/V.height;nt.style.setProperty("--visual-x",`${q*10}px`),nt.style.setProperty("--visual-y",`${-oe*8}px`)},{passive:!0}),Mn.addEventListener("pointerleave",()=>{gt.set(0,0),nt.style.setProperty("--visual-x","0px"),nt.style.setProperty("--visual-y","0px")}),nt.addEventListener("pointerenter",O=>{$i.matches||O.pointerType==="touch"||(Nn=1,Mn.classList.add("is-searching"))},{passive:!0}),nt.addEventListener("pointermove",O=>{if(O.target.closest(".signal-field__projects, .signal-field__project-card")||$i.matches||O.pointerType==="touch"&&!Qi)return;let V=nt.getBoundingClientRect();gt.set((O.clientX-V.left)/V.width-.5,.5-(O.clientY-V.top)/V.height),Ri(As(gt.x)),Nn=1,Mn.classList.add("is-searching"),nt.style.setProperty("--scan-x",`${O.clientX-V.left}px`),nt.style.setProperty("--scan-y",`${O.clientY-V.top}px`)},{passive:!0}),nt.addEventListener("pointerdown",O=>{$i.matches||O.pointerType==="touch"&&(Qi=!0,nt.setPointerCapture(O.pointerId),Nn=1,Mn.classList.add("is-searching"))}),nt.addEventListener("click",O=>{if(O.target.closest(".signal-field__projects, .signal-field__project-card")||$i.matches)return;let V=nt.getBoundingClientRect();Ri(As((O.clientX-V.left)/V.width-.5)),ge()});let Nt=O=>{O?.pointerType==="touch"&&(Qi=!1),Nn=0,gt.set(0,0),Mn.classList.remove("is-searching")};nt.addEventListener("pointerup",O=>{O.pointerType==="touch"&&Nt(O)}),nt.addEventListener("pointercancel",Nt),nt.addEventListener("pointerleave",O=>{Qi||Nt(O)}),new IntersectionObserver(([O])=>{Cs=O.isIntersecting,Cs&&li===0&&dt(),!Cs&&li!==0&&(cancelAnimationFrame(li),li=0)},{threshold:.02}).observe(Mn),$i.addEventListener("change",dt),Tr.addEventListener("change",je),window.addEventListener("resize",je,{passive:!0}),je(),dt()}
